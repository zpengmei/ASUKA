// Auto-split from cueri_cuda_kernels_wave1_generated.cu (part 9/12: fpgs..fpgs)
  ...
  for (int ip = 0; ip < nPairAB; ++ip) {
    ...
    for (int jp = 0; jp < nPairCD; ++jp) {
      ...
      for (int u = 0; u < NROOTS; ++u) {
        ...
        tile[0] += sc * (Gx[19] * xij + Gx[24]) * (Gy[0]) * (Gz[0]);
        tile[1] += sc * (Gx[18] * xij + Gx[23]) * (Gy[1]) * (Gz[0]);
        tile[2] += sc * (Gx[18] * xij + Gx[23]) * (Gy[0]) * (Gz[1]);
        tile[3] += sc * (Gx[17] * xij + Gx[22]) * (Gy[2]) * (Gz[0]);
        tile[4] += sc * (Gx[17] * xij + Gx[22]) * (Gy[1]) * (Gz[1]);
        tile[5] += sc * (Gx[17] * xij + Gx[22]) * (Gy[0]) * (Gz[2]);
        tile[6] += sc * (Gx[16] * xij + Gx[21]) * (Gy[3]) * (Gz[0]);
        tile[7] += sc * (Gx[16] * xij + Gx[21]) * (Gy[2]) * (Gz[1]);
        tile[8] += sc * (Gx[16] * xij + Gx[21]) * (Gy[1]) * (Gz[2]);
        tile[9] += sc * (Gx[16] * xij + Gx[21]) * (Gy[0]) * (Gz[3]);
        tile[10] += sc * (Gx[15] * xij + Gx[20]) * (Gy[4]) * (Gz[0]);
        tile[11] += sc * (Gx[15] * xij + Gx[20]) * (Gy[3]) * (Gz[1]);
        tile[12] += sc * (Gx[15] * xij + Gx[20]) * (Gy[2]) * (Gz[2]);
        tile[13] += sc * (Gx[15] * xij + Gx[20]) * (Gy[1]) * (Gz[3]);
        tile[14] += sc * (Gx[15] * xij + Gx[20]) * (Gy[0]) * (Gz[4]);
        tile[15] += sc * (Gx[19]) * (Gy[0] * yij + Gy[5]) * (Gz[0]);
        tile[16] += sc * (Gx[18]) * (Gy[1] * yij + Gy[6]) * (Gz[0]);
        tile[17] += sc * (Gx[18]) * (Gy[0] * yij + Gy[5]) * (Gz[1]);
        tile[18] += sc * (Gx[17]) * (Gy[2] * yij + Gy[7]) * (Gz[0]);
        tile[19] += sc * (Gx[17]) * (Gy[1] * yij + Gy[6]) * (Gz[1]);
        tile[20] += sc * (Gx[17]) * (Gy[0] * yij + Gy[5]) * (Gz[2]);
        tile[21] += sc * (Gx[16]) * (Gy[3] * yij + Gy[8]) * (Gz[0]);
        tile[22] += sc * (Gx[16]) * (Gy[2] * yij + Gy[7]) * (Gz[1]);
        tile[23] += sc * (Gx[16]) * (Gy[1] * yij + Gy[6]) * (Gz[2]);
        tile[24] += sc * (Gx[16]) * (Gy[0] * yij + Gy[5]) * (Gz[3]);
        tile[25] += sc * (Gx[15]) * (Gy[4] * yij + Gy[9]) * (Gz[0]);
        tile[26] += sc * (Gx[15]) * (Gy[3] * yij + Gy[8]) * (Gz[1]);
        tile[27] += sc * (Gx[15]) * (Gy[2] * yij + Gy[7]) * (Gz[2]);
        tile[28] += sc * (Gx[15]) * (Gy[1] * yij + Gy[6]) * (Gz[3]);
        tile[29] += sc * (Gx[15]) * (Gy[0] * yij + Gy[5]) * (Gz[4]);
        tile[30] += sc * (Gx[19]) * (Gy[0]) * (Gz[0] * zij + Gz[5]);
        tile[31] += sc * (Gx[18]) * (Gy[1]) * (Gz[0] * zij + Gz[5]);
        tile[32] += sc * (Gx[18]) * (Gy[0]) * (Gz[1] * zij + Gz[6]);
        tile[33] += sc * (Gx[17]) * (Gy[2]) * (Gz[0] * zij + Gz[5]);
        tile[34] += sc * (Gx[17]) * (Gy[1]) * (Gz[1] * zij + Gz[6]);
        tile[35] += sc * (Gx[17]) * (Gy[0]) * (Gz[2] * zij + Gz[7]);
        tile[36] += sc * (Gx[16]) * (Gy[3]) * (Gz[0] * zij + Gz[5]);
        tile[37] += sc * (Gx[16]) * (Gy[2]) * (Gz[1] * zij + Gz[6]);
        tile[38] += sc * (Gx[16]) * (Gy[1]) * (Gz[2] * zij + Gz[7]);
        tile[39] += sc * (Gx[16]) * (Gy[0]) * (Gz[3] * zij + Gz[8]);
        tile[40] += sc * (Gx[15]) * (Gy[4]) * (Gz[0] * zij + Gz[5]);
        tile[41] += sc * (Gx[15]) * (Gy[3]) * (Gz[1] * zij + Gz[6]);
        tile[42] += sc * (Gx[15]) * (Gy[2]) * (Gz[2] * zij + Gz[7]);
        tile[43] += sc * (Gx[15]) * (Gy[1]) * (Gz[3] * zij + Gz[8]);
        tile[44] += sc * (Gx[15]) * (Gy[0]) * (Gz[4] * zij + Gz[9]);
        tile[45] += sc * (Gx[14] * xij + Gx[19]) * (Gy[5]) * (Gz[0]);
        tile[46] += sc * (Gx[13] * xij + Gx[18]) * (Gy[6]) * (Gz[0]);
        tile[47] += sc * (Gx[13] * xij + Gx[18]) * (Gy[5]) * (Gz[1]);
        tile[48] += sc * (Gx[12] * xij + Gx[17]) * (Gy[7]) * (Gz[0]);
        tile[49] += sc * (Gx[12] * xij + Gx[17]) * (Gy[6]) * (Gz[1]);
        tile[50] += sc * (Gx[12] * xij + Gx[17]) * (Gy[5]) * (Gz[2]);
        tile[51] += sc * (Gx[11] * xij + Gx[16]) * (Gy[8]) * (Gz[0]);
        tile[52] += sc * (Gx[11] * xij + Gx[16]) * (Gy[7]) * (Gz[1]);
        tile[53] += sc * (Gx[11] * xij + Gx[16]) * (Gy[6]) * (Gz[2]);
        tile[54] += sc * (Gx[11] * xij + Gx[16]) * (Gy[5]) * (Gz[3]);
        tile[55] += sc * (Gx[10] * xij + Gx[15]) * (Gy[9]) * (Gz[0]);
        tile[56] += sc * (Gx[10] * xij + Gx[15]) * (Gy[8]) * (Gz[1]);
        tile[57] += sc * (Gx[10] * xij + Gx[15]) * (Gy[7]) * (Gz[2]);
        tile[58] += sc * (Gx[10] * xij + Gx[15]) * (Gy[6]) * (Gz[3]);
        tile[59] += sc * (Gx[10] * xij + Gx[15]) * (Gy[5]) * (Gz[4]);
        tile[60] += sc * (Gx[14]) * (Gy[5] * yij + Gy[10]) * (Gz[0]);
        tile[61] += sc * (Gx[13]) * (Gy[6] * yij + Gy[11]) * (Gz[0]);
        tile[62] += sc * (Gx[13]) * (Gy[5] * yij + Gy[10]) * (Gz[1]);
        tile[63] += sc * (Gx[12]) * (Gy[7] * yij + Gy[12]) * (Gz[0]);
        tile[64] += sc * (Gx[12]) * (Gy[6] * yij + Gy[11]) * (Gz[1]);
        tile[65] += sc * (Gx[12]) * (Gy[5] * yij + Gy[10]) * (Gz[2]);
        tile[66] += sc * (Gx[11]) * (Gy[8] * yij + Gy[13]) * (Gz[0]);
        tile[67] += sc * (Gx[11]) * (Gy[7] * yij + Gy[12]) * (Gz[1]);
        tile[68] += sc * (Gx[11]) * (Gy[6] * yij + Gy[11]) * (Gz[2]);
        tile[69] += sc * (Gx[11]) * (Gy[5] * yij + Gy[10]) * (Gz[3]);
        tile[70] += sc * (Gx[10]) * (Gy[9] * yij + Gy[14]) * (Gz[0]);
        tile[71] += sc * (Gx[10]) * (Gy[8] * yij + Gy[13]) * (Gz[1]);
        tile[72] += sc * (Gx[10]) * (Gy[7] * yij + Gy[12]) * (Gz[2]);
        tile[73] += sc * (Gx[10]) * (Gy[6] * yij + Gy[11]) * (Gz[3]);
        tile[74] += sc * (Gx[10]) * (Gy[5] * yij + Gy[10]) * (Gz[4]);
        tile[75] += sc * (Gx[14]) * (Gy[5]) * (Gz[0] * zij + Gz[5]);
        tile[76] += sc * (Gx[13]) * (Gy[6]) * (Gz[0] * zij + Gz[5]);
        tile[77] += sc * (Gx[13]) * (Gy[5]) * (Gz[1] * zij + Gz[6]);
        tile[78] += sc * (Gx[12]) * (Gy[7]) * (Gz[0] * zij + Gz[5]);
        tile[79] += sc * (Gx[12]) * (Gy[6]) * (Gz[1] * zij + Gz[6]);
        tile[80] += sc * (Gx[12]) * (Gy[5]) * (Gz[2] * zij + Gz[7]);
        tile[81] += sc * (Gx[11]) * (Gy[8]) * (Gz[0] * zij + Gz[5]);
        tile[82] += sc * (Gx[11]) * (Gy[7]) * (Gz[1] * zij + Gz[6]);
        tile[83] += sc * (Gx[11]) * (Gy[6]) * (Gz[2] * zij + Gz[7]);
        tile[84] += sc * (Gx[11]) * (Gy[5]) * (Gz[3] * zij + Gz[8]);
        tile[85] += sc * (Gx[10]) * (Gy[9]) * (Gz[0] * zij + Gz[5]);
        tile[86] += sc * (Gx[10]) * (Gy[8]) * (Gz[1] * zij + Gz[6]);
        tile[87] += sc * (Gx[10]) * (Gy[7]) * (Gz[2] * zij + Gz[7]);
        tile[88] += sc * (Gx[10]) * (Gy[6]) * (Gz[3] * zij + Gz[8]);
        tile[89] += sc * (Gx[10]) * (Gy[5]) * (Gz[4] * zij + Gz[9]);
        tile[90] += sc * (Gx[14] * xij + Gx[19]) * (Gy[0]) * (Gz[5]);
        tile[91] += sc * (Gx[13] * xij + Gx[18]) * (Gy[1]) * (Gz[5]);
        tile[92] += sc * (Gx[13] * xij + Gx[18]) * (Gy[0]) * (Gz[6]);
        tile[93] += sc * (Gx[12] * xij + Gx[17]) * (Gy[2]) * (Gz[5]);
        tile[94] += sc * (Gx[12] * xij + Gx[17]) * (Gy[1]) * (Gz[6]);
        tile[95] += sc * (Gx[12] * xij + Gx[17]) * (Gy[0]) * (Gz[7]);
        tile[96] += sc * (Gx[11] * xij + Gx[16]) * (Gy[3]) * (Gz[5]);
        tile[97] += sc * (Gx[11] * xij + Gx[16]) * (Gy[2]) * (Gz[6]);
        tile[98] += sc * (Gx[11] * xij + Gx[16]) * (Gy[1]) * (Gz[7]);
        tile[99] += sc * (Gx[11] * xij + Gx[16]) * (Gy[0]) * (Gz[8]);
        tile[100] += sc * (Gx[10] * xij + Gx[15]) * (Gy[4]) * (Gz[5]);
        tile[101] += sc * (Gx[10] * xij + Gx[15]) * (Gy[3]) * (Gz[6]);
        tile[102] += sc * (Gx[10] * xij + Gx[15]) * (Gy[2]) * (Gz[7]);
        tile[103] += sc * (Gx[10] * xij + Gx[15]) * (Gy[1]) * (Gz[8]);
        tile[104] += sc * (Gx[10] * xij + Gx[15]) * (Gy[0]) * (Gz[9]);
        tile[105] += sc * (Gx[14]) * (Gy[0] * yij + Gy[5]) * (Gz[5]);
        tile[106] += sc * (Gx[13]) * (Gy[1] * yij + Gy[6]) * (Gz[5]);
        tile[107] += sc * (Gx[13]) * (Gy[0] * yij + Gy[5]) * (Gz[6]);
        tile[108] += sc * (Gx[12]) * (Gy[2] * yij + Gy[7]) * (Gz[5]);
        tile[109] += sc * (Gx[12]) * (Gy[1] * yij + Gy[6]) * (Gz[6]);
        tile[110] += sc * (Gx[12]) * (Gy[0] * yij + Gy[5]) * (Gz[7]);
        tile[111] += sc * (Gx[11]) * (Gy[3] * yij + Gy[8]) * (Gz[5]);
        tile[112] += sc * (Gx[11]) * (Gy[2] * yij + Gy[7]) * (Gz[6]);
        tile[113] += sc * (Gx[11]) * (Gy[1] * yij + Gy[6]) * (Gz[7]);
        tile[114] += sc * (Gx[11]) * (Gy[0] * yij + Gy[5]) * (Gz[8]);
        tile[115] += sc * (Gx[10]) * (Gy[4] * yij + Gy[9]) * (Gz[5]);
        tile[116] += sc * (Gx[10]) * (Gy[3] * yij + Gy[8]) * (Gz[6]);
        tile[117] += sc * (Gx[10]) * (Gy[2] * yij + Gy[7]) * (Gz[7]);
        tile[118] += sc * (Gx[10]) * (Gy[1] * yij + Gy[6]) * (Gz[8]);
        tile[119] += sc * (Gx[10]) * (Gy[0] * yij + Gy[5]) * (Gz[9]);
        tile[120] += sc * (Gx[14]) * (Gy[0]) * (Gz[5] * zij + Gz[10]);
        tile[121] += sc * (Gx[13]) * (Gy[1]) * (Gz[5] * zij + Gz[10]);
        tile[122] += sc * (Gx[13]) * (Gy[0]) * (Gz[6] * zij + Gz[11]);
        tile[123] += sc * (Gx[12]) * (Gy[2]) * (Gz[5] * zij + Gz[10]);
        tile[124] += sc * (Gx[12]) * (Gy[1]) * (Gz[6] * zij + Gz[11]);
        tile[125] += sc * (Gx[12]) * (Gy[0]) * (Gz[7] * zij + Gz[12]);
        tile[126] += sc * (Gx[11]) * (Gy[3]) * (Gz[5] * zij + Gz[10]);
        tile[127] += sc * (Gx[11]) * (Gy[2]) * (Gz[6] * zij + Gz[11]);
        tile[128] += sc * (Gx[11]) * (Gy[1]) * (Gz[7] * zij + Gz[12]);
        tile[129] += sc * (Gx[11]) * (Gy[0]) * (Gz[8] * zij + Gz[13]);
        tile[130] += sc * (Gx[10]) * (Gy[4]) * (Gz[5] * zij + Gz[10]);
        tile[131] += sc * (Gx[10]) * (Gy[3]) * (Gz[6] * zij + Gz[11]);
        tile[132] += sc * (Gx[10]) * (Gy[2]) * (Gz[7] * zij + Gz[12]);
        tile[133] += sc * (Gx[10]) * (Gy[1]) * (Gz[8] * zij + Gz[13]);
        tile[134] += sc * (Gx[10]) * (Gy[0]) * (Gz[9] * zij + Gz[14]);
        tile[135] += sc * (Gx[9] * xij + Gx[14]) * (Gy[10]) * (Gz[0]);
        tile[136] += sc * (Gx[8] * xij + Gx[13]) * (Gy[11]) * (Gz[0]);
        tile[137] += sc * (Gx[8] * xij + Gx[13]) * (Gy[10]) * (Gz[1]);
        tile[138] += sc * (Gx[7] * xij + Gx[12]) * (Gy[12]) * (Gz[0]);
        tile[139] += sc * (Gx[7] * xij + Gx[12]) * (Gy[11]) * (Gz[1]);
        tile[140] += sc * (Gx[7] * xij + Gx[12]) * (Gy[10]) * (Gz[2]);
        tile[141] += sc * (Gx[6] * xij + Gx[11]) * (Gy[13]) * (Gz[0]);
        tile[142] += sc * (Gx[6] * xij + Gx[11]) * (Gy[12]) * (Gz[1]);
        tile[143] += sc * (Gx[6] * xij + Gx[11]) * (Gy[11]) * (Gz[2]);
        tile[144] += sc * (Gx[6] * xij + Gx[11]) * (Gy[10]) * (Gz[3]);
        tile[145] += sc * (Gx[5] * xij + Gx[10]) * (Gy[14]) * (Gz[0]);
        tile[146] += sc * (Gx[5] * xij + Gx[10]) * (Gy[13]) * (Gz[1]);
        tile[147] += sc * (Gx[5] * xij + Gx[10]) * (Gy[12]) * (Gz[2]);
        tile[148] += sc * (Gx[5] * xij + Gx[10]) * (Gy[11]) * (Gz[3]);
        tile[149] += sc * (Gx[5] * xij + Gx[10]) * (Gy[10]) * (Gz[4]);
        tile[150] += sc * (Gx[9]) * (Gy[10] * yij + Gy[15]) * (Gz[0]);
        tile[151] += sc * (Gx[8]) * (Gy[11] * yij + Gy[16]) * (Gz[0]);
        tile[152] += sc * (Gx[8]) * (Gy[10] * yij + Gy[15]) * (Gz[1]);
        tile[153] += sc * (Gx[7]) * (Gy[12] * yij + Gy[17]) * (Gz[0]);
        tile[154] += sc * (Gx[7]) * (Gy[11] * yij + Gy[16]) * (Gz[1]);
        tile[155] += sc * (Gx[7]) * (Gy[10] * yij + Gy[15]) * (Gz[2]);
        tile[156] += sc * (Gx[6]) * (Gy[13] * yij + Gy[18]) * (Gz[0]);
        tile[157] += sc * (Gx[6]) * (Gy[12] * yij + Gy[17]) * (Gz[1]);
        tile[158] += sc * (Gx[6]) * (Gy[11] * yij + Gy[16]) * (Gz[2]);
        tile[159] += sc * (Gx[6]) * (Gy[10] * yij + Gy[15]) * (Gz[3]);
        tile[160] += sc * (Gx[5]) * (Gy[14] * yij + Gy[19]) * (Gz[0]);
        tile[161] += sc * (Gx[5]) * (Gy[13] * yij + Gy[18]) * (Gz[1]);
        tile[162] += sc * (Gx[5]) * (Gy[12] * yij + Gy[17]) * (Gz[2]);
        tile[163] += sc * (Gx[5]) * (Gy[11] * yij + Gy[16]) * (Gz[3]);
        tile[164] += sc * (Gx[5]) * (Gy[10] * yij + Gy[15]) * (Gz[4]);
        tile[165] += sc * (Gx[9]) * (Gy[10]) * (Gz[0] * zij + Gz[5]);
        tile[166] += sc * (Gx[8]) * (Gy[11]) * (Gz[0] * zij + Gz[5]);
        tile[167] += sc * (Gx[8]) * (Gy[10]) * (Gz[1] * zij + Gz[6]);
        tile[168] += sc * (Gx[7]) * (Gy[12]) * (Gz[0] * zij + Gz[5]);
        tile[169] += sc * (Gx[7]) * (Gy[11]) * (Gz[1] * zij + Gz[6]);
        tile[170] += sc * (Gx[7]) * (Gy[10]) * (Gz[2] * zij + Gz[7]);
        tile[171] += sc * (Gx[6]) * (Gy[13]) * (Gz[0] * zij + Gz[5]);
        tile[172] += sc * (Gx[6]) * (Gy[12]) * (Gz[1] * zij + Gz[6]);
        tile[173] += sc * (Gx[6]) * (Gy[11]) * (Gz[2] * zij + Gz[7]);
        tile[174] += sc * (Gx[6]) * (Gy[10]) * (Gz[3] * zij + Gz[8]);
        tile[175] += sc * (Gx[5]) * (Gy[14]) * (Gz[0] * zij + Gz[5]);
        tile[176] += sc * (Gx[5]) * (Gy[13]) * (Gz[1] * zij + Gz[6]);
        tile[177] += sc * (Gx[5]) * (Gy[12]) * (Gz[2] * zij + Gz[7]);
        tile[178] += sc * (Gx[5]) * (Gy[11]) * (Gz[3] * zij + Gz[8]);
        tile[179] += sc * (Gx[5]) * (Gy[10]) * (Gz[4] * zij + Gz[9]);
        tile[180] += sc * (Gx[9] * xij + Gx[14]) * (Gy[5]) * (Gz[5]);
        tile[181] += sc * (Gx[8] * xij + Gx[13]) * (Gy[6]) * (Gz[5]);
        tile[182] += sc * (Gx[8] * xij + Gx[13]) * (Gy[5]) * (Gz[6]);
        tile[183] += sc * (Gx[7] * xij + Gx[12]) * (Gy[7]) * (Gz[5]);
        tile[184] += sc * (Gx[7] * xij + Gx[12]) * (Gy[6]) * (Gz[6]);
        tile[185] += sc * (Gx[7] * xij + Gx[12]) * (Gy[5]) * (Gz[7]);
        tile[186] += sc * (Gx[6] * xij + Gx[11]) * (Gy[8]) * (Gz[5]);
        tile[187] += sc * (Gx[6] * xij + Gx[11]) * (Gy[7]) * (Gz[6]);
        tile[188] += sc * (Gx[6] * xij + Gx[11]) * (Gy[6]) * (Gz[7]);
        tile[189] += sc * (Gx[6] * xij + Gx[11]) * (Gy[5]) * (Gz[8]);
        tile[190] += sc * (Gx[5] * xij + Gx[10]) * (Gy[9]) * (Gz[5]);
        tile[191] += sc * (Gx[5] * xij + Gx[10]) * (Gy[8]) * (Gz[6]);
        tile[192] += sc * (Gx[5] * xij + Gx[10]) * (Gy[7]) * (Gz[7]);
        tile[193] += sc * (Gx[5] * xij + Gx[10]) * (Gy[6]) * (Gz[8]);
        tile[194] += sc * (Gx[5] * xij + Gx[10]) * (Gy[5]) * (Gz[9]);
        tile[195] += sc * (Gx[9]) * (Gy[5] * yij + Gy[10]) * (Gz[5]);
        tile[196] += sc * (Gx[8]) * (Gy[6] * yij + Gy[11]) * (Gz[5]);
        tile[197] += sc * (Gx[8]) * (Gy[5] * yij + Gy[10]) * (Gz[6]);
        tile[198] += sc * (Gx[7]) * (Gy[7] * yij + Gy[12]) * (Gz[5]);
        tile[199] += sc * (Gx[7]) * (Gy[6] * yij + Gy[11]) * (Gz[6]);
        tile[200] += sc * (Gx[7]) * (Gy[5] * yij + Gy[10]) * (Gz[7]);
        tile[201] += sc * (Gx[6]) * (Gy[8] * yij + Gy[13]) * (Gz[5]);
        tile[202] += sc * (Gx[6]) * (Gy[7] * yij + Gy[12]) * (Gz[6]);
        tile[203] += sc * (Gx[6]) * (Gy[6] * yij + Gy[11]) * (Gz[7]);
        tile[204] += sc * (Gx[6]) * (Gy[5] * yij + Gy[10]) * (Gz[8]);
        tile[205] += sc * (Gx[5]) * (Gy[9] * yij + Gy[14]) * (Gz[5]);
        tile[206] += sc * (Gx[5]) * (Gy[8] * yij + Gy[13]) * (Gz[6]);
        tile[207] += sc * (Gx[5]) * (Gy[7] * yij + Gy[12]) * (Gz[7]);
        tile[208] += sc * (Gx[5]) * (Gy[6] * yij + Gy[11]) * (Gz[8]);
        tile[209] += sc * (Gx[5]) * (Gy[5] * yij + Gy[10]) * (Gz[9]);
        tile[210] += sc * (Gx[9]) * (Gy[5]) * (Gz[5] * zij + Gz[10]);
        tile[211] += sc * (Gx[8]) * (Gy[6]) * (Gz[5] * zij + Gz[10]);
        tile[212] += sc * (Gx[8]) * (Gy[5]) * (Gz[6] * zij + Gz[11]);
        tile[213] += sc * (Gx[7]) * (Gy[7]) * (Gz[5] * zij + Gz[10]);
        tile[214] += sc * (Gx[7]) * (Gy[6]) * (Gz[6] * zij + Gz[11]);
        tile[215] += sc * (Gx[7]) * (Gy[5]) * (Gz[7] * zij + Gz[12]);
        tile[216] += sc * (Gx[6]) * (Gy[8]) * (Gz[5] * zij + Gz[10]);
        tile[217] += sc * (Gx[6]) * (Gy[7]) * (Gz[6] * zij + Gz[11]);
        tile[218] += sc * (Gx[6]) * (Gy[6]) * (Gz[7] * zij + Gz[12]);
        tile[219] += sc * (Gx[6]) * (Gy[5]) * (Gz[8] * zij + Gz[13]);
        tile[220] += sc * (Gx[5]) * (Gy[9]) * (Gz[5] * zij + Gz[10]);
        tile[221] += sc * (Gx[5]) * (Gy[8]) * (Gz[6] * zij + Gz[11]);
        tile[222] += sc * (Gx[5]) * (Gy[7]) * (Gz[7] * zij + Gz[12]);
        tile[223] += sc * (Gx[5]) * (Gy[6]) * (Gz[8] * zij + Gz[13]);
        tile[224] += sc * (Gx[5]) * (Gy[5]) * (Gz[9] * zij + Gz[14]);
        tile[225] += sc * (Gx[9] * xij + Gx[14]) * (Gy[0]) * (Gz[10]);
        tile[226] += sc * (Gx[8] * xij + Gx[13]) * (Gy[1]) * (Gz[10]);
        tile[227] += sc * (Gx[8] * xij + Gx[13]) * (Gy[0]) * (Gz[11]);
        tile[228] += sc * (Gx[7] * xij + Gx[12]) * (Gy[2]) * (Gz[10]);
        tile[229] += sc * (Gx[7] * xij + Gx[12]) * (Gy[1]) * (Gz[11]);
        tile[230] += sc * (Gx[7] * xij + Gx[12]) * (Gy[0]) * (Gz[12]);
        tile[231] += sc * (Gx[6] * xij + Gx[11]) * (Gy[3]) * (Gz[10]);
        tile[232] += sc * (Gx[6] * xij + Gx[11]) * (Gy[2]) * (Gz[11]);
        tile[233] += sc * (Gx[6] * xij + Gx[11]) * (Gy[1]) * (Gz[12]);
        tile[234] += sc * (Gx[6] * xij + Gx[11]) * (Gy[0]) * (Gz[13]);
        tile[235] += sc * (Gx[5] * xij + Gx[10]) * (Gy[4]) * (Gz[10]);
        tile[236] += sc * (Gx[5] * xij + Gx[10]) * (Gy[3]) * (Gz[11]);
        tile[237] += sc * (Gx[5] * xij + Gx[10]) * (Gy[2]) * (Gz[12]);
        tile[238] += sc * (Gx[5] * xij + Gx[10]) * (Gy[1]) * (Gz[13]);
        tile[239] += sc * (Gx[5] * xij + Gx[10]) * (Gy[0]) * (Gz[14]);
        tile[240] += sc * (Gx[9]) * (Gy[0] * yij + Gy[5]) * (Gz[10]);
        tile[241] += sc * (Gx[8]) * (Gy[1] * yij + Gy[6]) * (Gz[10]);
        tile[242] += sc * (Gx[8]) * (Gy[0] * yij + Gy[5]) * (Gz[11]);
        tile[243] += sc * (Gx[7]) * (Gy[2] * yij + Gy[7]) * (Gz[10]);
        tile[244] += sc * (Gx[7]) * (Gy[1] * yij + Gy[6]) * (Gz[11]);
        tile[245] += sc * (Gx[7]) * (Gy[0] * yij + Gy[5]) * (Gz[12]);
        tile[246] += sc * (Gx[6]) * (Gy[3] * yij + Gy[8]) * (Gz[10]);
        tile[247] += sc * (Gx[6]) * (Gy[2] * yij + Gy[7]) * (Gz[11]);
        tile[248] += sc * (Gx[6]) * (Gy[1] * yij + Gy[6]) * (Gz[12]);
        tile[249] += sc * (Gx[6]) * (Gy[0] * yij + Gy[5]) * (Gz[13]);
        tile[250] += sc * (Gx[5]) * (Gy[4] * yij + Gy[9]) * (Gz[10]);
        tile[251] += sc * (Gx[5]) * (Gy[3] * yij + Gy[8]) * (Gz[11]);
        tile[252] += sc * (Gx[5]) * (Gy[2] * yij + Gy[7]) * (Gz[12]);
        tile[253] += sc * (Gx[5]) * (Gy[1] * yij + Gy[6]) * (Gz[13]);
        tile[254] += sc * (Gx[5]) * (Gy[0] * yij + Gy[5]) * (Gz[14]);
        tile[255] += sc * (Gx[9]) * (Gy[0]) * (Gz[10] * zij + Gz[15]);
        tile[256] += sc * (Gx[8]) * (Gy[1]) * (Gz[10] * zij + Gz[15]);
        tile[257] += sc * (Gx[8]) * (Gy[0]) * (Gz[11] * zij + Gz[16]);
        tile[258] += sc * (Gx[7]) * (Gy[2]) * (Gz[10] * zij + Gz[15]);
        tile[259] += sc * (Gx[7]) * (Gy[1]) * (Gz[11] * zij + Gz[16]);
        tile[260] += sc * (Gx[7]) * (Gy[0]) * (Gz[12] * zij + Gz[17]);
        tile[261] += sc * (Gx[6]) * (Gy[3]) * (Gz[10] * zij + Gz[15]);
        tile[262] += sc * (Gx[6]) * (Gy[2]) * (Gz[11] * zij + Gz[16]);
        tile[263] += sc * (Gx[6]) * (Gy[1]) * (Gz[12] * zij + Gz[17]);
        tile[264] += sc * (Gx[6]) * (Gy[0]) * (Gz[13] * zij + Gz[18]);
        tile[265] += sc * (Gx[5]) * (Gy[4]) * (Gz[10] * zij + Gz[15]);
        tile[266] += sc * (Gx[5]) * (Gy[3]) * (Gz[11] * zij + Gz[16]);
        tile[267] += sc * (Gx[5]) * (Gy[2]) * (Gz[12] * zij + Gz[17]);
        tile[268] += sc * (Gx[5]) * (Gy[1]) * (Gz[13] * zij + Gz[18]);
        tile[269] += sc * (Gx[5]) * (Gy[0]) * (Gz[14] * zij + Gz[19]);
        tile[270] += sc * (Gx[4] * xij + Gx[9]) * (Gy[15]) * (Gz[0]);
        tile[271] += sc * (Gx[3] * xij + Gx[8]) * (Gy[16]) * (Gz[0]);
        tile[272] += sc * (Gx[3] * xij + Gx[8]) * (Gy[15]) * (Gz[1]);
        tile[273] += sc * (Gx[2] * xij + Gx[7]) * (Gy[17]) * (Gz[0]);
        tile[274] += sc * (Gx[2] * xij + Gx[7]) * (Gy[16]) * (Gz[1]);
        tile[275] += sc * (Gx[2] * xij + Gx[7]) * (Gy[15]) * (Gz[2]);
        tile[276] += sc * (Gx[1] * xij + Gx[6]) * (Gy[18]) * (Gz[0]);
        tile[277] += sc * (Gx[1] * xij + Gx[6]) * (Gy[17]) * (Gz[1]);
        tile[278] += sc * (Gx[1] * xij + Gx[6]) * (Gy[16]) * (Gz[2]);
        tile[279] += sc * (Gx[1] * xij + Gx[6]) * (Gy[15]) * (Gz[3]);
        tile[280] += sc * (Gx[0] * xij + Gx[5]) * (Gy[19]) * (Gz[0]);
        tile[281] += sc * (Gx[0] * xij + Gx[5]) * (Gy[18]) * (Gz[1]);
        tile[282] += sc * (Gx[0] * xij + Gx[5]) * (Gy[17]) * (Gz[2]);
        tile[283] += sc * (Gx[0] * xij + Gx[5]) * (Gy[16]) * (Gz[3]);
        tile[284] += sc * (Gx[0] * xij + Gx[5]) * (Gy[15]) * (Gz[4]);
        tile[285] += sc * (Gx[4]) * (Gy[15] * yij + Gy[20]) * (Gz[0]);
        tile[286] += sc * (Gx[3]) * (Gy[16] * yij + Gy[21]) * (Gz[0]);
        tile[287] += sc * (Gx[3]) * (Gy[15] * yij + Gy[20]) * (Gz[1]);
        tile[288] += sc * (Gx[2]) * (Gy[17] * yij + Gy[22]) * (Gz[0]);
        tile[289] += sc * (Gx[2]) * (Gy[16] * yij + Gy[21]) * (Gz[1]);
        tile[290] += sc * (Gx[2]) * (Gy[15] * yij + Gy[20]) * (Gz[2]);
        tile[291] += sc * (Gx[1]) * (Gy[18] * yij + Gy[23]) * (Gz[0]);
        tile[292] += sc * (Gx[1]) * (Gy[17] * yij + Gy[22]) * (Gz[1]);
        tile[293] += sc * (Gx[1]) * (Gy[16] * yij + Gy[21]) * (Gz[2]);
        tile[294] += sc * (Gx[1]) * (Gy[15] * yij + Gy[20]) * (Gz[3]);
        tile[295] += sc * (Gx[0]) * (Gy[19] * yij + Gy[24]) * (Gz[0]);
        tile[296] += sc * (Gx[0]) * (Gy[18] * yij + Gy[23]) * (Gz[1]);
        tile[297] += sc * (Gx[0]) * (Gy[17] * yij + Gy[22]) * (Gz[2]);
        tile[298] += sc * (Gx[0]) * (Gy[16] * yij + Gy[21]) * (Gz[3]);
        tile[299] += sc * (Gx[0]) * (Gy[15] * yij + Gy[20]) * (Gz[4]);
        tile[300] += sc * (Gx[4]) * (Gy[15]) * (Gz[0] * zij + Gz[5]);
        tile[301] += sc * (Gx[3]) * (Gy[16]) * (Gz[0] * zij + Gz[5]);
        tile[302] += sc * (Gx[3]) * (Gy[15]) * (Gz[1] * zij + Gz[6]);
        tile[303] += sc * (Gx[2]) * (Gy[17]) * (Gz[0] * zij + Gz[5]);
        tile[304] += sc * (Gx[2]) * (Gy[16]) * (Gz[1] * zij + Gz[6]);
        tile[305] += sc * (Gx[2]) * (Gy[15]) * (Gz[2] * zij + Gz[7]);
        tile[306] += sc * (Gx[1]) * (Gy[18]) * (Gz[0] * zij + Gz[5]);
        tile[307] += sc * (Gx[1]) * (Gy[17]) * (Gz[1] * zij + Gz[6]);
        tile[308] += sc * (Gx[1]) * (Gy[16]) * (Gz[2] * zij + Gz[7]);
        tile[309] += sc * (Gx[1]) * (Gy[15]) * (Gz[3] * zij + Gz[8]);
        tile[310] += sc * (Gx[0]) * (Gy[19]) * (Gz[0] * zij + Gz[5]);
        tile[311] += sc * (Gx[0]) * (Gy[18]) * (Gz[1] * zij + Gz[6]);
        tile[312] += sc * (Gx[0]) * (Gy[17]) * (Gz[2] * zij + Gz[7]);
        tile[313] += sc * (Gx[0]) * (Gy[16]) * (Gz[3] * zij + Gz[8]);
        tile[314] += sc * (Gx[0]) * (Gy[15]) * (Gz[4] * zij + Gz[9]);
        tile[315] += sc * (Gx[4] * xij + Gx[9]) * (Gy[10]) * (Gz[5]);
        tile[316] += sc * (Gx[3] * xij + Gx[8]) * (Gy[11]) * (Gz[5]);
        tile[317] += sc * (Gx[3] * xij + Gx[8]) * (Gy[10]) * (Gz[6]);
        tile[318] += sc * (Gx[2] * xij + Gx[7]) * (Gy[12]) * (Gz[5]);
        tile[319] += sc * (Gx[2] * xij + Gx[7]) * (Gy[11]) * (Gz[6]);
        tile[320] += sc * (Gx[2] * xij + Gx[7]) * (Gy[10]) * (Gz[7]);
        tile[321] += sc * (Gx[1] * xij + Gx[6]) * (Gy[13]) * (Gz[5]);
        tile[322] += sc * (Gx[1] * xij + Gx[6]) * (Gy[12]) * (Gz[6]);
        tile[323] += sc * (Gx[1] * xij + Gx[6]) * (Gy[11]) * (Gz[7]);
        tile[324] += sc * (Gx[1] * xij + Gx[6]) * (Gy[10]) * (Gz[8]);
        tile[325] += sc * (Gx[0] * xij + Gx[5]) * (Gy[14]) * (Gz[5]);
        tile[326] += sc * (Gx[0] * xij + Gx[5]) * (Gy[13]) * (Gz[6]);
        tile[327] += sc * (Gx[0] * xij + Gx[5]) * (Gy[12]) * (Gz[7]);
        tile[328] += sc * (Gx[0] * xij + Gx[5]) * (Gy[11]) * (Gz[8]);
        tile[329] += sc * (Gx[0] * xij + Gx[5]) * (Gy[10]) * (Gz[9]);
        tile[330] += sc * (Gx[4]) * (Gy[10] * yij + Gy[15]) * (Gz[5]);
        tile[331] += sc * (Gx[3]) * (Gy[11] * yij + Gy[16]) * (Gz[5]);
        tile[332] += sc * (Gx[3]) * (Gy[10] * yij + Gy[15]) * (Gz[6]);
        tile[333] += sc * (Gx[2]) * (Gy[12] * yij + Gy[17]) * (Gz[5]);
        tile[334] += sc * (Gx[2]) * (Gy[11] * yij + Gy[16]) * (Gz[6]);
        tile[335] += sc * (Gx[2]) * (Gy[10] * yij + Gy[15]) * (Gz[7]);
        tile[336] += sc * (Gx[1]) * (Gy[13] * yij + Gy[18]) * (Gz[5]);
        tile[337] += sc * (Gx[1]) * (Gy[12] * yij + Gy[17]) * (Gz[6]);
        tile[338] += sc * (Gx[1]) * (Gy[11] * yij + Gy[16]) * (Gz[7]);
        tile[339] += sc * (Gx[1]) * (Gy[10] * yij + Gy[15]) * (Gz[8]);
        tile[340] += sc * (Gx[0]) * (Gy[14] * yij + Gy[19]) * (Gz[5]);
        tile[341] += sc * (Gx[0]) * (Gy[13] * yij + Gy[18]) * (Gz[6]);
        tile[342] += sc * (Gx[0]) * (Gy[12] * yij + Gy[17]) * (Gz[7]);
        tile[343] += sc * (Gx[0]) * (Gy[11] * yij + Gy[16]) * (Gz[8]);
        tile[344] += sc * (Gx[0]) * (Gy[10] * yij + Gy[15]) * (Gz[9]);
        tile[345] += sc * (Gx[4]) * (Gy[10]) * (Gz[5] * zij + Gz[10]);
        tile[346] += sc * (Gx[3]) * (Gy[11]) * (Gz[5] * zij + Gz[10]);
        tile[347] += sc * (Gx[3]) * (Gy[10]) * (Gz[6] * zij + Gz[11]);
        tile[348] += sc * (Gx[2]) * (Gy[12]) * (Gz[5] * zij + Gz[10]);
        tile[349] += sc * (Gx[2]) * (Gy[11]) * (Gz[6] * zij + Gz[11]);
        tile[350] += sc * (Gx[2]) * (Gy[10]) * (Gz[7] * zij + Gz[12]);
        tile[351] += sc * (Gx[1]) * (Gy[13]) * (Gz[5] * zij + Gz[10]);
        tile[352] += sc * (Gx[1]) * (Gy[12]) * (Gz[6] * zij + Gz[11]);
        tile[353] += sc * (Gx[1]) * (Gy[11]) * (Gz[7] * zij + Gz[12]);
        tile[354] += sc * (Gx[1]) * (Gy[10]) * (Gz[8] * zij + Gz[13]);
        tile[355] += sc * (Gx[0]) * (Gy[14]) * (Gz[5] * zij + Gz[10]);
        tile[356] += sc * (Gx[0]) * (Gy[13]) * (Gz[6] * zij + Gz[11]);
        tile[357] += sc * (Gx[0]) * (Gy[12]) * (Gz[7] * zij + Gz[12]);
        tile[358] += sc * (Gx[0]) * (Gy[11]) * (Gz[8] * zij + Gz[13]);
        tile[359] += sc * (Gx[0]) * (Gy[10]) * (Gz[9] * zij + Gz[14]);
        tile[360] += sc * (Gx[4] * xij + Gx[9]) * (Gy[5]) * (Gz[10]);
        tile[361] += sc * (Gx[3] * xij + Gx[8]) * (Gy[6]) * (Gz[10]);
        tile[362] += sc * (Gx[3] * xij + Gx[8]) * (Gy[5]) * (Gz[11]);
        tile[363] += sc * (Gx[2] * xij + Gx[7]) * (Gy[7]) * (Gz[10]);
        tile[364] += sc * (Gx[2] * xij + Gx[7]) * (Gy[6]) * (Gz[11]);
        tile[365] += sc * (Gx[2] * xij + Gx[7]) * (Gy[5]) * (Gz[12]);
        tile[366] += sc * (Gx[1] * xij + Gx[6]) * (Gy[8]) * (Gz[10]);
        tile[367] += sc * (Gx[1] * xij + Gx[6]) * (Gy[7]) * (Gz[11]);
        tile[368] += sc * (Gx[1] * xij + Gx[6]) * (Gy[6]) * (Gz[12]);
        tile[369] += sc * (Gx[1] * xij + Gx[6]) * (Gy[5]) * (Gz[13]);
        tile[370] += sc * (Gx[0] * xij + Gx[5]) * (Gy[9]) * (Gz[10]);
        tile[371] += sc * (Gx[0] * xij + Gx[5]) * (Gy[8]) * (Gz[11]);
        tile[372] += sc * (Gx[0] * xij + Gx[5]) * (Gy[7]) * (Gz[12]);
        tile[373] += sc * (Gx[0] * xij + Gx[5]) * (Gy[6]) * (Gz[13]);
        tile[374] += sc * (Gx[0] * xij + Gx[5]) * (Gy[5]) * (Gz[14]);
        tile[375] += sc * (Gx[4]) * (Gy[5] * yij + Gy[10]) * (Gz[10]);
        tile[376] += sc * (Gx[3]) * (Gy[6] * yij + Gy[11]) * (Gz[10]);
        tile[377] += sc * (Gx[3]) * (Gy[5] * yij + Gy[10]) * (Gz[11]);
        tile[378] += sc * (Gx[2]) * (Gy[7] * yij + Gy[12]) * (Gz[10]);
        tile[379] += sc * (Gx[2]) * (Gy[6] * yij + Gy[11]) * (Gz[11]);
        tile[380] += sc * (Gx[2]) * (Gy[5] * yij + Gy[10]) * (Gz[12]);
        tile[381] += sc * (Gx[1]) * (Gy[8] * yij + Gy[13]) * (Gz[10]);
        tile[382] += sc * (Gx[1]) * (Gy[7] * yij + Gy[12]) * (Gz[11]);
        tile[383] += sc * (Gx[1]) * (Gy[6] * yij + Gy[11]) * (Gz[12]);
        tile[384] += sc * (Gx[1]) * (Gy[5] * yij + Gy[10]) * (Gz[13]);
        tile[385] += sc * (Gx[0]) * (Gy[9] * yij + Gy[14]) * (Gz[10]);
        tile[386] += sc * (Gx[0]) * (Gy[8] * yij + Gy[13]) * (Gz[11]);
        tile[387] += sc * (Gx[0]) * (Gy[7] * yij + Gy[12]) * (Gz[12]);
        tile[388] += sc * (Gx[0]) * (Gy[6] * yij + Gy[11]) * (Gz[13]);
        tile[389] += sc * (Gx[0]) * (Gy[5] * yij + Gy[10]) * (Gz[14]);
        tile[390] += sc * (Gx[4]) * (Gy[5]) * (Gz[10] * zij + Gz[15]);
        tile[391] += sc * (Gx[3]) * (Gy[6]) * (Gz[10] * zij + Gz[15]);
        tile[392] += sc * (Gx[3]) * (Gy[5]) * (Gz[11] * zij + Gz[16]);
        tile[393] += sc * (Gx[2]) * (Gy[7]) * (Gz[10] * zij + Gz[15]);
        tile[394] += sc * (Gx[2]) * (Gy[6]) * (Gz[11] * zij + Gz[16]);
        tile[395] += sc * (Gx[2]) * (Gy[5]) * (Gz[12] * zij + Gz[17]);
        tile[396] += sc * (Gx[1]) * (Gy[8]) * (Gz[10] * zij + Gz[15]);
        tile[397] += sc * (Gx[1]) * (Gy[7]) * (Gz[11] * zij + Gz[16]);
        tile[398] += sc * (Gx[1]) * (Gy[6]) * (Gz[12] * zij + Gz[17]);
        tile[399] += sc * (Gx[1]) * (Gy[5]) * (Gz[13] * zij + Gz[18]);
        tile[400] += sc * (Gx[0]) * (Gy[9]) * (Gz[10] * zij + Gz[15]);
        tile[401] += sc * (Gx[0]) * (Gy[8]) * (Gz[11] * zij + Gz[16]);
        tile[402] += sc * (Gx[0]) * (Gy[7]) * (Gz[12] * zij + Gz[17]);
        tile[403] += sc * (Gx[0]) * (Gy[6]) * (Gz[13] * zij + Gz[18]);
        tile[404] += sc * (Gx[0]) * (Gy[5]) * (Gz[14] * zij + Gz[19]);
        tile[405] += sc * (Gx[4] * xij + Gx[9]) * (Gy[0]) * (Gz[15]);
        tile[406] += sc * (Gx[3] * xij + Gx[8]) * (Gy[1]) * (Gz[15]);
        tile[407] += sc * (Gx[3] * xij + Gx[8]) * (Gy[0]) * (Gz[16]);
        tile[408] += sc * (Gx[2] * xij + Gx[7]) * (Gy[2]) * (Gz[15]);
        tile[409] += sc * (Gx[2] * xij + Gx[7]) * (Gy[1]) * (Gz[16]);
        tile[410] += sc * (Gx[2] * xij + Gx[7]) * (Gy[0]) * (Gz[17]);
        tile[411] += sc * (Gx[1] * xij + Gx[6]) * (Gy[3]) * (Gz[15]);
        tile[412] += sc * (Gx[1] * xij + Gx[6]) * (Gy[2]) * (Gz[16]);
        tile[413] += sc * (Gx[1] * xij + Gx[6]) * (Gy[1]) * (Gz[17]);
        tile[414] += sc * (Gx[1] * xij + Gx[6]) * (Gy[0]) * (Gz[18]);
        tile[415] += sc * (Gx[0] * xij + Gx[5]) * (Gy[4]) * (Gz[15]);
        tile[416] += sc * (Gx[0] * xij + Gx[5]) * (Gy[3]) * (Gz[16]);
        tile[417] += sc * (Gx[0] * xij + Gx[5]) * (Gy[2]) * (Gz[17]);
        tile[418] += sc * (Gx[0] * xij + Gx[5]) * (Gy[1]) * (Gz[18]);
        tile[419] += sc * (Gx[0] * xij + Gx[5]) * (Gy[0]) * (Gz[19]);
        tile[420] += sc * (Gx[4]) * (Gy[0] * yij + Gy[5]) * (Gz[15]);
        tile[421] += sc * (Gx[3]) * (Gy[1] * yij + Gy[6]) * (Gz[15]);
        tile[422] += sc * (Gx[3]) * (Gy[0] * yij + Gy[5]) * (Gz[16]);
        tile[423] += sc * (Gx[2]) * (Gy[2] * yij + Gy[7]) * (Gz[15]);
        tile[424] += sc * (Gx[2]) * (Gy[1] * yij + Gy[6]) * (Gz[16]);
        tile[425] += sc * (Gx[2]) * (Gy[0] * yij + Gy[5]) * (Gz[17]);
        tile[426] += sc * (Gx[1]) * (Gy[3] * yij + Gy[8]) * (Gz[15]);
        tile[427] += sc * (Gx[1]) * (Gy[2] * yij + Gy[7]) * (Gz[16]);
        tile[428] += sc * (Gx[1]) * (Gy[1] * yij + Gy[6]) * (Gz[17]);
        tile[429] += sc * (Gx[1]) * (Gy[0] * yij + Gy[5]) * (Gz[18]);
        tile[430] += sc * (Gx[0]) * (Gy[4] * yij + Gy[9]) * (Gz[15]);
        tile[431] += sc * (Gx[0]) * (Gy[3] * yij + Gy[8]) * (Gz[16]);
        tile[432] += sc * (Gx[0]) * (Gy[2] * yij + Gy[7]) * (Gz[17]);
        tile[433] += sc * (Gx[0]) * (Gy[1] * yij + Gy[6]) * (Gz[18]);
        tile[434] += sc * (Gx[0]) * (Gy[0] * yij + Gy[5]) * (Gz[19]);
        tile[435] += sc * (Gx[4]) * (Gy[0]) * (Gz[15] * zij + Gz[20]);
        tile[436] += sc * (Gx[3]) * (Gy[1]) * (Gz[15] * zij + Gz[20]);
        tile[437] += sc * (Gx[3]) * (Gy[0]) * (Gz[16] * zij + Gz[21]);
        tile[438] += sc * (Gx[2]) * (Gy[2]) * (Gz[15] * zij + Gz[20]);
        tile[439] += sc * (Gx[2]) * (Gy[1]) * (Gz[16] * zij + Gz[21]);
        tile[440] += sc * (Gx[2]) * (Gy[0]) * (Gz[17] * zij + Gz[22]);
        tile[441] += sc * (Gx[1]) * (Gy[3]) * (Gz[15] * zij + Gz[20]);
        tile[442] += sc * (Gx[1]) * (Gy[2]) * (Gz[16] * zij + Gz[21]);
        tile[443] += sc * (Gx[1]) * (Gy[1]) * (Gz[17] * zij + Gz[22]);
        tile[444] += sc * (Gx[1]) * (Gy[0]) * (Gz[18] * zij + Gz[23]);
        tile[445] += sc * (Gx[0]) * (Gy[4]) * (Gz[15] * zij + Gz[20]);
        tile[446] += sc * (Gx[0]) * (Gy[3]) * (Gz[16] * zij + Gz[21]);
        tile[447] += sc * (Gx[0]) * (Gy[2]) * (Gz[17] * zij + Gz[22]);
        tile[448] += sc * (Gx[0]) * (Gy[1]) * (Gz[18] * zij + Gz[23]);
        tile[449] += sc * (Gx[0]) * (Gy[0]) * (Gz[19] * zij + Gz[24]);
      }
    }
  }
