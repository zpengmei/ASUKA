  ...
  for (int ip = 0; ip < nPairAB; ++ip) {
    ...
    for (int jp = 0; jp < nPairCD; ++jp) {
      ...
      for (int u = 0; u < NROOTS; ++u) {
        ...
        tile[0] += sc * (Gx[5]) * (Gy[0]) * (Gz[0]);
        tile[1] += sc * (Gx[4]) * (Gy[1]) * (Gz[0]);
        tile[2] += sc * (Gx[4]) * (Gy[0]) * (Gz[1]);
        tile[3] += sc * (Gx[3]) * (Gy[2]) * (Gz[0]);
        tile[4] += sc * (Gx[3]) * (Gy[1]) * (Gz[1]);
        tile[5] += sc * (Gx[3]) * (Gy[0]) * (Gz[2]);
        tile[6] += sc * (Gx[2]) * (Gy[3]) * (Gz[0]);
        tile[7] += sc * (Gx[1]) * (Gy[4]) * (Gz[0]);
        tile[8] += sc * (Gx[1]) * (Gy[3]) * (Gz[1]);
        tile[9] += sc * (Gx[0]) * (Gy[5]) * (Gz[0]);
        tile[10] += sc * (Gx[0]) * (Gy[4]) * (Gz[1]);
        tile[11] += sc * (Gx[0]) * (Gy[3]) * (Gz[2]);
        tile[12] += sc * (Gx[2]) * (Gy[0]) * (Gz[3]);
        tile[13] += sc * (Gx[1]) * (Gy[1]) * (Gz[3]);
        tile[14] += sc * (Gx[1]) * (Gy[0]) * (Gz[4]);
        tile[15] += sc * (Gx[0]) * (Gy[2]) * (Gz[3]);
        tile[16] += sc * (Gx[0]) * (Gy[1]) * (Gz[4]);
        tile[17] += sc * (Gx[0]) * (Gy[0]) * (Gz[5]);
      }
    }
  }
  ...
  for (int ip = 0; ip < nPairAB; ++ip) {
    ...
    for (int jp = 0; jp < nPairCD; ++jp) {
      ...
      for (int u = 0; u < NROOTS; ++u) {
        ...
        compute_G_stride_fixed<kFlatStride, kNMax, kMMax>(Gz, Cz_, Cpz_, B0, B1, B1p);
        const double sc = base * w;
        tile[0] += sc * (Gx[5] * xij + Gx[8]) * (Gy[0]) * (Gz[0]);
        tile[1] += sc * (Gx[4] * xij + Gx[7]) * (Gy[1]) * (Gz[0]);
        tile[2] += sc * (Gx[4] * xij + Gx[7]) * (Gy[0]) * (Gz[1]);
        tile[3] += sc * (Gx[3] * xij + Gx[6]) * (Gy[2]) * (Gz[0]);
        tile[4] += sc * (Gx[3] * xij + Gx[6]) * (Gy[1]) * (Gz[1]);
        tile[5] += sc * (Gx[3] * xij + Gx[6]) * (Gy[0]) * (Gz[2]);
        tile[6] += sc * (Gx[5]) * (Gy[0] * yij + Gy[3]) * (Gz[0]);
        tile[7] += sc * (Gx[4]) * (Gy[1] * yij + Gy[4]) * (Gz[0]);
        tile[8] += sc * (Gx[4]) * (Gy[0] * yij + Gy[3]) * (Gz[1]);
        tile[9] += sc * (Gx[3]) * (Gy[2] * yij + Gy[5]) * (Gz[0]);
        tile[10] += sc * (Gx[3]) * (Gy[1] * yij + Gy[4]) * (Gz[1]);
        tile[11] += sc * (Gx[3]) * (Gy[0] * yij + Gy[3]) * (Gz[2]);
        tile[12] += sc * (Gx[5]) * (Gy[0]) * (Gz[0] * zij + Gz[3]);
        tile[13] += sc * (Gx[4]) * (Gy[1]) * (Gz[0] * zij + Gz[3]);
        tile[14] += sc * (Gx[4]) * (Gy[0]) * (Gz[1] * zij + Gz[4]);
        tile[15] += sc * (Gx[3]) * (Gy[2]) * (Gz[0] * zij + Gz[3]);
        tile[16] += sc * (Gx[3]) * (Gy[1]) * (Gz[1] * zij + Gz[4]);
        tile[17] += sc * (Gx[3]) * (Gy[0]) * (Gz[2] * zij + Gz[5]);
        tile[18] += sc * (Gx[2] * xij + Gx[5]) * (Gy[3]) * (Gz[0]);
        tile[19] += sc * (Gx[1] * xij + Gx[4]) * (Gy[4]) * (Gz[0]);
        tile[20] += sc * (Gx[1] * xij + Gx[4]) * (Gy[3]) * (Gz[1]);
        tile[21] += sc * (Gx[0] * xij + Gx[3]) * (Gy[5]) * (Gz[0]);
        tile[22] += sc * (Gx[0] * xij + Gx[3]) * (Gy[4]) * (Gz[1]);
        tile[23] += sc * (Gx[0] * xij + Gx[3]) * (Gy[3]) * (Gz[2]);
        tile[24] += sc * (Gx[2]) * (Gy[3] * yij + Gy[6]) * (Gz[0]);
        tile[25] += sc * (Gx[1]) * (Gy[4] * yij + Gy[7]) * (Gz[0]);
        tile[26] += sc * (Gx[1]) * (Gy[3] * yij + Gy[6]) * (Gz[1]);
        tile[27] += sc * (Gx[0]) * (Gy[5] * yij + Gy[8]) * (Gz[0]);
        tile[28] += sc * (Gx[0]) * (Gy[4] * yij + Gy[7]) * (Gz[1]);
        tile[29] += sc * (Gx[0]) * (Gy[3] * yij + Gy[6]) * (Gz[2]);
        tile[30] += sc * (Gx[2]) * (Gy[3]) * (Gz[0] * zij + Gz[3]);
        tile[31] += sc * (Gx[1]) * (Gy[4]) * (Gz[0] * zij + Gz[3]);
        tile[32] += sc * (Gx[1]) * (Gy[3]) * (Gz[1] * zij + Gz[4]);
        tile[33] += sc * (Gx[0]) * (Gy[5]) * (Gz[0] * zij + Gz[3]);
        tile[34] += sc * (Gx[0]) * (Gy[4]) * (Gz[1] * zij + Gz[4]);
        tile[35] += sc * (Gx[0]) * (Gy[3]) * (Gz[2] * zij + Gz[5]);
        tile[36] += sc * (Gx[2] * xij + Gx[5]) * (Gy[0]) * (Gz[3]);
        tile[37] += sc * (Gx[1] * xij + Gx[4]) * (Gy[1]) * (Gz[3]);
        tile[38] += sc * (Gx[1] * xij + Gx[4]) * (Gy[0]) * (Gz[4]);
        tile[39] += sc * (Gx[0] * xij + Gx[3]) * (Gy[2]) * (Gz[3]);
        tile[40] += sc * (Gx[0] * xij + Gx[3]) * (Gy[1]) * (Gz[4]);
        tile[41] += sc * (Gx[0] * xij + Gx[3]) * (Gy[0]) * (Gz[5]);
        tile[42] += sc * (Gx[2]) * (Gy[0] * yij + Gy[3]) * (Gz[3]);
        tile[43] += sc * (Gx[1]) * (Gy[1] * yij + Gy[4]) * (Gz[3]);
        tile[44] += sc * (Gx[1]) * (Gy[0] * yij + Gy[3]) * (Gz[4]);
        tile[45] += sc * (Gx[0]) * (Gy[2] * yij + Gy[5]) * (Gz[3]);
        tile[46] += sc * (Gx[0]) * (Gy[1] * yij + Gy[4]) * (Gz[4]);
        tile[47] += sc * (Gx[0]) * (Gy[0] * yij + Gy[3]) * (Gz[5]);
        tile[48] += sc * (Gx[2]) * (Gy[0]) * (Gz[3] * zij + Gz[6]);
        tile[49] += sc * (Gx[1]) * (Gy[1]) * (Gz[3] * zij + Gz[6]);
        tile[50] += sc * (Gx[1]) * (Gy[0]) * (Gz[4] * zij + Gz[7]);
        tile[51] += sc * (Gx[0]) * (Gy[2]) * (Gz[3] * zij + Gz[6]);
        tile[52] += sc * (Gx[0]) * (Gy[1]) * (Gz[4] * zij + Gz[7]);
        tile[53] += sc * (Gx[0]) * (Gy[0]) * (Gz[5] * zij + Gz[8]);
      }
    }
  }
  ...
  for (int ip = 0; ip < nPairAB; ++ip) {
    ...
    for (int jp = 0; jp < nPairCD; ++jp) {
      ...
      for (int u = 0; u < NROOTS; ++u) {
        ...
        compute_G_stride_fixed<kFlatStride, kNMax, kMMax>(Gz, Cz_, Cpz_, B0, B1, B1p);
        const double sc = base * w;
        tile[0] += sc * (Gx[8]) * (Gy[0]) * (Gz[0]);
        tile[1] += sc * (Gx[7]) * (Gy[1]) * (Gz[0]);
        tile[2] += sc * (Gx[7]) * (Gy[0]) * (Gz[1]);
        tile[3] += sc * (Gx[6]) * (Gy[2]) * (Gz[0]);
        tile[4] += sc * (Gx[6]) * (Gy[1]) * (Gz[1]);
        tile[5] += sc * (Gx[6]) * (Gy[0]) * (Gz[2]);
        tile[6] += sc * (Gx[5]) * (Gy[3]) * (Gz[0]);
        tile[7] += sc * (Gx[4]) * (Gy[4]) * (Gz[0]);
        tile[8] += sc * (Gx[4]) * (Gy[3]) * (Gz[1]);
        tile[9] += sc * (Gx[3]) * (Gy[5]) * (Gz[0]);
        tile[10] += sc * (Gx[3]) * (Gy[4]) * (Gz[1]);
        tile[11] += sc * (Gx[3]) * (Gy[3]) * (Gz[2]);
        tile[12] += sc * (Gx[5]) * (Gy[0]) * (Gz[3]);
        tile[13] += sc * (Gx[4]) * (Gy[1]) * (Gz[3]);
        tile[14] += sc * (Gx[4]) * (Gy[0]) * (Gz[4]);
        tile[15] += sc * (Gx[3]) * (Gy[2]) * (Gz[3]);
        tile[16] += sc * (Gx[3]) * (Gy[1]) * (Gz[4]);
        tile[17] += sc * (Gx[3]) * (Gy[0]) * (Gz[5]);
        tile[18] += sc * (Gx[2]) * (Gy[6]) * (Gz[0]);
        tile[19] += sc * (Gx[1]) * (Gy[7]) * (Gz[0]);
        tile[20] += sc * (Gx[1]) * (Gy[6]) * (Gz[1]);
        tile[21] += sc * (Gx[0]) * (Gy[8]) * (Gz[0]);
        tile[22] += sc * (Gx[0]) * (Gy[7]) * (Gz[1]);
        tile[23] += sc * (Gx[0]) * (Gy[6]) * (Gz[2]);
        tile[24] += sc * (Gx[2]) * (Gy[3]) * (Gz[3]);
        tile[25] += sc * (Gx[1]) * (Gy[4]) * (Gz[3]);
        tile[26] += sc * (Gx[1]) * (Gy[3]) * (Gz[4]);
        tile[27] += sc * (Gx[0]) * (Gy[5]) * (Gz[3]);
        tile[28] += sc * (Gx[0]) * (Gy[4]) * (Gz[4]);
        tile[29] += sc * (Gx[0]) * (Gy[3]) * (Gz[5]);
        tile[30] += sc * (Gx[2]) * (Gy[0]) * (Gz[6]);
        tile[31] += sc * (Gx[1]) * (Gy[1]) * (Gz[6]);
        tile[32] += sc * (Gx[1]) * (Gy[0]) * (Gz[7]);
        tile[33] += sc * (Gx[0]) * (Gy[2]) * (Gz[6]);
        tile[34] += sc * (Gx[0]) * (Gy[1]) * (Gz[7]);
        tile[35] += sc * (Gx[0]) * (Gy[0]) * (Gz[8]);
      }
    }
  }
  ...
  for (int ip = 0; ip < nPairAB; ++ip) {
    ...
    for (int jp = 0; jp < nPairCD; ++jp) {
      ...
      for (int u = 0; u < NROOTS; ++u) {
        ...
        compute_G_stride_fixed<kFlatStride, kNMax, kMMax>(Gz, Cz_, Cpz_, B0, B1, B1p);
        const double sc = base * w;
        tile[0] += sc * (Gx[10] * xkl + Gx[11]) * (Gy[0]) * (Gz[0]);
        tile[1] += sc * (Gx[10]) * (Gy[0] * ykl + Gy[1]) * (Gz[0]);
        tile[2] += sc * (Gx[10]) * (Gy[0]) * (Gz[0] * zkl + Gz[1]);
        tile[3] += sc * (Gx[9] * xkl + Gx[10]) * (Gy[1]) * (Gz[0]);
        tile[4] += sc * (Gx[9]) * (Gy[1] * ykl + Gy[2]) * (Gz[0]);
        tile[5] += sc * (Gx[9]) * (Gy[1]) * (Gz[0] * zkl + Gz[1]);
        tile[6] += sc * (Gx[9] * xkl + Gx[10]) * (Gy[0]) * (Gz[1]);
        tile[7] += sc * (Gx[9]) * (Gy[0] * ykl + Gy[1]) * (Gz[1]);
        tile[8] += sc * (Gx[9]) * (Gy[0]) * (Gz[1] * zkl + Gz[2]);
        tile[9] += sc * (Gx[8] * xkl + Gx[9]) * (Gy[2]) * (Gz[0]);
        tile[10] += sc * (Gx[8]) * (Gy[2] * ykl + Gy[3]) * (Gz[0]);
        tile[11] += sc * (Gx[8]) * (Gy[2]) * (Gz[0] * zkl + Gz[1]);
        tile[12] += sc * (Gx[8] * xkl + Gx[9]) * (Gy[1]) * (Gz[1]);
        tile[13] += sc * (Gx[8]) * (Gy[1] * ykl + Gy[2]) * (Gz[1]);
        tile[14] += sc * (Gx[8]) * (Gy[1]) * (Gz[1] * zkl + Gz[2]);
        tile[15] += sc * (Gx[8] * xkl + Gx[9]) * (Gy[0]) * (Gz[2]);
        tile[16] += sc * (Gx[8]) * (Gy[0] * ykl + Gy[1]) * (Gz[2]);
        tile[17] += sc * (Gx[8]) * (Gy[0]) * (Gz[2] * zkl + Gz[3]);
        tile[18] += sc * (Gx[6] * xkl + Gx[7]) * (Gy[4]) * (Gz[0]);
        tile[19] += sc * (Gx[6]) * (Gy[4] * ykl + Gy[5]) * (Gz[0]);
        tile[20] += sc * (Gx[6]) * (Gy[4]) * (Gz[0] * zkl + Gz[1]);
        tile[21] += sc * (Gx[5] * xkl + Gx[6]) * (Gy[5]) * (Gz[0]);
        tile[22] += sc * (Gx[5]) * (Gy[5] * ykl + Gy[6]) * (Gz[0]);
        tile[23] += sc * (Gx[5]) * (Gy[5]) * (Gz[0] * zkl + Gz[1]);
        tile[24] += sc * (Gx[5] * xkl + Gx[6]) * (Gy[4]) * (Gz[1]);
        tile[25] += sc * (Gx[5]) * (Gy[4] * ykl + Gy[5]) * (Gz[1]);
        tile[26] += sc * (Gx[5]) * (Gy[4]) * (Gz[1] * zkl + Gz[2]);
        tile[27] += sc * (Gx[4] * xkl + Gx[5]) * (Gy[6]) * (Gz[0]);
        tile[28] += sc * (Gx[4]) * (Gy[6] * ykl + Gy[7]) * (Gz[0]);
        tile[29] += sc * (Gx[4]) * (Gy[6]) * (Gz[0] * zkl + Gz[1]);
        tile[30] += sc * (Gx[4] * xkl + Gx[5]) * (Gy[5]) * (Gz[1]);
        tile[31] += sc * (Gx[4]) * (Gy[5] * ykl + Gy[6]) * (Gz[1]);
        tile[32] += sc * (Gx[4]) * (Gy[5]) * (Gz[1] * zkl + Gz[2]);
        tile[33] += sc * (Gx[4] * xkl + Gx[5]) * (Gy[4]) * (Gz[2]);
        tile[34] += sc * (Gx[4]) * (Gy[4] * ykl + Gy[5]) * (Gz[2]);
        tile[35] += sc * (Gx[4]) * (Gy[4]) * (Gz[2] * zkl + Gz[3]);
        tile[36] += sc * (Gx[6] * xkl + Gx[7]) * (Gy[0]) * (Gz[4]);
        tile[37] += sc * (Gx[6]) * (Gy[0] * ykl + Gy[1]) * (Gz[4]);
        tile[38] += sc * (Gx[6]) * (Gy[0]) * (Gz[4] * zkl + Gz[5]);
        tile[39] += sc * (Gx[5] * xkl + Gx[6]) * (Gy[1]) * (Gz[4]);
        tile[40] += sc * (Gx[5]) * (Gy[1] * ykl + Gy[2]) * (Gz[4]);
        tile[41] += sc * (Gx[5]) * (Gy[1]) * (Gz[4] * zkl + Gz[5]);
        tile[42] += sc * (Gx[5] * xkl + Gx[6]) * (Gy[0]) * (Gz[5]);
        tile[43] += sc * (Gx[5]) * (Gy[0] * ykl + Gy[1]) * (Gz[5]);
        tile[44] += sc * (Gx[5]) * (Gy[0]) * (Gz[5] * zkl + Gz[6]);
        tile[45] += sc * (Gx[4] * xkl + Gx[5]) * (Gy[2]) * (Gz[4]);
        tile[46] += sc * (Gx[4]) * (Gy[2] * ykl + Gy[3]) * (Gz[4]);
        tile[47] += sc * (Gx[4]) * (Gy[2]) * (Gz[4] * zkl + Gz[5]);
        tile[48] += sc * (Gx[4] * xkl + Gx[5]) * (Gy[1]) * (Gz[5]);
        tile[49] += sc * (Gx[4]) * (Gy[1] * ykl + Gy[2]) * (Gz[5]);
        tile[50] += sc * (Gx[4]) * (Gy[1]) * (Gz[5] * zkl + Gz[6]);
        tile[51] += sc * (Gx[4] * xkl + Gx[5]) * (Gy[0]) * (Gz[6]);
        tile[52] += sc * (Gx[4]) * (Gy[0] * ykl + Gy[1]) * (Gz[6]);
        tile[53] += sc * (Gx[4]) * (Gy[0]) * (Gz[6] * zkl + Gz[7]);
        tile[54] += sc * (Gx[2] * xkl + Gx[3]) * (Gy[8]) * (Gz[0]);
        tile[55] += sc * (Gx[2]) * (Gy[8] * ykl + Gy[9]) * (Gz[0]);
        tile[56] += sc * (Gx[2]) * (Gy[8]) * (Gz[0] * zkl + Gz[1]);
        tile[57] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[9]) * (Gz[0]);
        tile[58] += sc * (Gx[1]) * (Gy[9] * ykl + Gy[10]) * (Gz[0]);
        tile[59] += sc * (Gx[1]) * (Gy[9]) * (Gz[0] * zkl + Gz[1]);
        tile[60] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[8]) * (Gz[1]);
        tile[61] += sc * (Gx[1]) * (Gy[8] * ykl + Gy[9]) * (Gz[1]);
        tile[62] += sc * (Gx[1]) * (Gy[8]) * (Gz[1] * zkl + Gz[2]);
        tile[63] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[10]) * (Gz[0]);
        tile[64] += sc * (Gx[0]) * (Gy[10] * ykl + Gy[11]) * (Gz[0]);
        tile[65] += sc * (Gx[0]) * (Gy[10]) * (Gz[0] * zkl + Gz[1]);
        tile[66] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[9]) * (Gz[1]);
        tile[67] += sc * (Gx[0]) * (Gy[9] * ykl + Gy[10]) * (Gz[1]);
        tile[68] += sc * (Gx[0]) * (Gy[9]) * (Gz[1] * zkl + Gz[2]);
        tile[69] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[8]) * (Gz[2]);
        tile[70] += sc * (Gx[0]) * (Gy[8] * ykl + Gy[9]) * (Gz[2]);
        tile[71] += sc * (Gx[0]) * (Gy[8]) * (Gz[2] * zkl + Gz[3]);
        tile[72] += sc * (Gx[2] * xkl + Gx[3]) * (Gy[4]) * (Gz[4]);
        tile[73] += sc * (Gx[2]) * (Gy[4] * ykl + Gy[5]) * (Gz[4]);
        tile[74] += sc * (Gx[2]) * (Gy[4]) * (Gz[4] * zkl + Gz[5]);
        tile[75] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[5]) * (Gz[4]);
        tile[76] += sc * (Gx[1]) * (Gy[5] * ykl + Gy[6]) * (Gz[4]);
        tile[77] += sc * (Gx[1]) * (Gy[5]) * (Gz[4] * zkl + Gz[5]);
        tile[78] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[4]) * (Gz[5]);
        tile[79] += sc * (Gx[1]) * (Gy[4] * ykl + Gy[5]) * (Gz[5]);
        tile[80] += sc * (Gx[1]) * (Gy[4]) * (Gz[5] * zkl + Gz[6]);
        tile[81] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[6]) * (Gz[4]);
        tile[82] += sc * (Gx[0]) * (Gy[6] * ykl + Gy[7]) * (Gz[4]);
        tile[83] += sc * (Gx[0]) * (Gy[6]) * (Gz[4] * zkl + Gz[5]);
        tile[84] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[5]) * (Gz[5]);
        tile[85] += sc * (Gx[0]) * (Gy[5] * ykl + Gy[6]) * (Gz[5]);
        tile[86] += sc * (Gx[0]) * (Gy[5]) * (Gz[5] * zkl + Gz[6]);
        tile[87] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[4]) * (Gz[6]);
        tile[88] += sc * (Gx[0]) * (Gy[4] * ykl + Gy[5]) * (Gz[6]);
        tile[89] += sc * (Gx[0]) * (Gy[4]) * (Gz[6] * zkl + Gz[7]);
        tile[90] += sc * (Gx[2] * xkl + Gx[3]) * (Gy[0]) * (Gz[8]);
        tile[91] += sc * (Gx[2]) * (Gy[0] * ykl + Gy[1]) * (Gz[8]);
        tile[92] += sc * (Gx[2]) * (Gy[0]) * (Gz[8] * zkl + Gz[9]);
        tile[93] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[1]) * (Gz[8]);
        tile[94] += sc * (Gx[1]) * (Gy[1] * ykl + Gy[2]) * (Gz[8]);
        tile[95] += sc * (Gx[1]) * (Gy[1]) * (Gz[8] * zkl + Gz[9]);
        tile[96] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[0]) * (Gz[9]);
        tile[97] += sc * (Gx[1]) * (Gy[0] * ykl + Gy[1]) * (Gz[9]);
        tile[98] += sc * (Gx[1]) * (Gy[0]) * (Gz[9] * zkl + Gz[10]);
        tile[99] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[2]) * (Gz[8]);
        tile[100] += sc * (Gx[0]) * (Gy[2] * ykl + Gy[3]) * (Gz[8]);
        tile[101] += sc * (Gx[0]) * (Gy[2]) * (Gz[8] * zkl + Gz[9]);
        tile[102] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[1]) * (Gz[9]);
        tile[103] += sc * (Gx[0]) * (Gy[1] * ykl + Gy[2]) * (Gz[9]);
        tile[104] += sc * (Gx[0]) * (Gy[1]) * (Gz[9] * zkl + Gz[10]);
        tile[105] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[0]) * (Gz[10]);
        tile[106] += sc * (Gx[0]) * (Gy[0] * ykl + Gy[1]) * (Gz[10]);
        tile[107] += sc * (Gx[0]) * (Gy[0]) * (Gz[10] * zkl + Gz[11]);
      }
    }
  }
  ...
  for (int ip = 0; ip < nPairAB; ++ip) {
    ...
    for (int jp = 0; jp < nPairCD; ++jp) {
      ...
      for (int u = 0; u < NROOTS; ++u) {
        ...
        compute_G_stride_fixed<kFlatStride, kNMax, kMMax>(Gz, Cz_, Cpz_, B0, B1, B1p);
        const double sc = base * w;
        tile[0] += sc * (Gx[12] * xkl2 + 2.0 * (Gx[13] * xkl) + Gx[14]) * (Gy[0]) * (Gz[0]);
        tile[1] += sc * (Gx[12] * xkl + Gx[13]) * (Gy[0] * ykl + Gy[1]) * (Gz[0]);
        tile[2] += sc * (Gx[12] * xkl + Gx[13]) * (Gy[0]) * (Gz[0] * zkl + Gz[1]);
        tile[3] += sc * (Gx[12]) * (Gy[0] * ykl2 + 2.0 * (Gy[1] * ykl) + Gy[2]) * (Gz[0]);
        tile[4] += sc * (Gx[12]) * (Gy[0] * ykl + Gy[1]) * (Gz[0] * zkl + Gz[1]);
        tile[5] += sc * (Gx[12]) * (Gy[0]) * (Gz[0] * zkl2 + 2.0 * (Gz[1] * zkl) + Gz[2]);
        tile[6] += sc * (Gx[11] * xkl2 + 2.0 * (Gx[12] * xkl) + Gx[13]) * (Gy[1]) * (Gz[0]);
        tile[7] += sc * (Gx[11] * xkl + Gx[12]) * (Gy[1] * ykl + Gy[2]) * (Gz[0]);
        tile[8] += sc * (Gx[11] * xkl + Gx[12]) * (Gy[1]) * (Gz[0] * zkl + Gz[1]);
        tile[9] += sc * (Gx[11]) * (Gy[1] * ykl2 + 2.0 * (Gy[2] * ykl) + Gy[3]) * (Gz[0]);
        tile[10] += sc * (Gx[11]) * (Gy[1] * ykl + Gy[2]) * (Gz[0] * zkl + Gz[1]);
        tile[11] += sc * (Gx[11]) * (Gy[1]) * (Gz[0] * zkl2 + 2.0 * (Gz[1] * zkl) + Gz[2]);
        tile[12] += sc * (Gx[11] * xkl2 + 2.0 * (Gx[12] * xkl) + Gx[13]) * (Gy[0]) * (Gz[1]);
        tile[13] += sc * (Gx[11] * xkl + Gx[12]) * (Gy[0] * ykl + Gy[1]) * (Gz[1]);
        tile[14] += sc * (Gx[11] * xkl + Gx[12]) * (Gy[0]) * (Gz[1] * zkl + Gz[2]);
        tile[15] += sc * (Gx[11]) * (Gy[0] * ykl2 + 2.0 * (Gy[1] * ykl) + Gy[2]) * (Gz[1]);
        tile[16] += sc * (Gx[11]) * (Gy[0] * ykl + Gy[1]) * (Gz[1] * zkl + Gz[2]);
        tile[17] += sc * (Gx[11]) * (Gy[0]) * (Gz[1] * zkl2 + 2.0 * (Gz[2] * zkl) + Gz[3]);
        tile[18] += sc * (Gx[10] * xkl2 + 2.0 * (Gx[11] * xkl) + Gx[12]) * (Gy[2]) * (Gz[0]);
        tile[19] += sc * (Gx[10] * xkl + Gx[11]) * (Gy[2] * ykl + Gy[3]) * (Gz[0]);
        tile[20] += sc * (Gx[10] * xkl + Gx[11]) * (Gy[2]) * (Gz[0] * zkl + Gz[1]);
        tile[21] += sc * (Gx[10]) * (Gy[2] * ykl2 + 2.0 * (Gy[3] * ykl) + Gy[4]) * (Gz[0]);
        tile[22] += sc * (Gx[10]) * (Gy[2] * ykl + Gy[3]) * (Gz[0] * zkl + Gz[1]);
        tile[23] += sc * (Gx[10]) * (Gy[2]) * (Gz[0] * zkl2 + 2.0 * (Gz[1] * zkl) + Gz[2]);
        tile[24] += sc * (Gx[10] * xkl2 + 2.0 * (Gx[11] * xkl) + Gx[12]) * (Gy[1]) * (Gz[1]);
        tile[25] += sc * (Gx[10] * xkl + Gx[11]) * (Gy[1] * ykl + Gy[2]) * (Gz[1]);
        tile[26] += sc * (Gx[10] * xkl + Gx[11]) * (Gy[1]) * (Gz[1] * zkl + Gz[2]);
        tile[27] += sc * (Gx[10]) * (Gy[1] * ykl2 + 2.0 * (Gy[2] * ykl) + Gy[3]) * (Gz[1]);
        tile[28] += sc * (Gx[10]) * (Gy[1] * ykl + Gy[2]) * (Gz[1] * zkl + Gz[2]);
        tile[29] += sc * (Gx[10]) * (Gy[1]) * (Gz[1] * zkl2 + 2.0 * (Gz[2] * zkl) + Gz[3]);
        tile[30] += sc * (Gx[10] * xkl2 + 2.0 * (Gx[11] * xkl) + Gx[12]) * (Gy[0]) * (Gz[2]);
        tile[31] += sc * (Gx[10] * xkl + Gx[11]) * (Gy[0] * ykl + Gy[1]) * (Gz[2]);
        tile[32] += sc * (Gx[10] * xkl + Gx[11]) * (Gy[0]) * (Gz[2] * zkl + Gz[3]);
        tile[33] += sc * (Gx[10]) * (Gy[0] * ykl2 + 2.0 * (Gy[1] * ykl) + Gy[2]) * (Gz[2]);
        tile[34] += sc * (Gx[10]) * (Gy[0] * ykl + Gy[1]) * (Gz[2] * zkl + Gz[3]);
        tile[35] += sc * (Gx[10]) * (Gy[0]) * (Gz[2] * zkl2 + 2.0 * (Gz[3] * zkl) + Gz[4]);
        tile[36] += sc * (Gx[7] * xkl2 + 2.0 * (Gx[8] * xkl) + Gx[9]) * (Gy[5]) * (Gz[0]);
        tile[37] += sc * (Gx[7] * xkl + Gx[8]) * (Gy[5] * ykl + Gy[6]) * (Gz[0]);
        tile[38] += sc * (Gx[7] * xkl + Gx[8]) * (Gy[5]) * (Gz[0] * zkl + Gz[1]);
        tile[39] += sc * (Gx[7]) * (Gy[5] * ykl2 + 2.0 * (Gy[6] * ykl) + Gy[7]) * (Gz[0]);
        tile[40] += sc * (Gx[7]) * (Gy[5] * ykl + Gy[6]) * (Gz[0] * zkl + Gz[1]);
        tile[41] += sc * (Gx[7]) * (Gy[5]) * (Gz[0] * zkl2 + 2.0 * (Gz[1] * zkl) + Gz[2]);
        tile[42] += sc * (Gx[6] * xkl2 + 2.0 * (Gx[7] * xkl) + Gx[8]) * (Gy[6]) * (Gz[0]);
        tile[43] += sc * (Gx[6] * xkl + Gx[7]) * (Gy[6] * ykl + Gy[7]) * (Gz[0]);
        tile[44] += sc * (Gx[6] * xkl + Gx[7]) * (Gy[6]) * (Gz[0] * zkl + Gz[1]);
        tile[45] += sc * (Gx[6]) * (Gy[6] * ykl2 + 2.0 * (Gy[7] * ykl) + Gy[8]) * (Gz[0]);
        tile[46] += sc * (Gx[6]) * (Gy[6] * ykl + Gy[7]) * (Gz[0] * zkl + Gz[1]);
        tile[47] += sc * (Gx[6]) * (Gy[6]) * (Gz[0] * zkl2 + 2.0 * (Gz[1] * zkl) + Gz[2]);
        tile[48] += sc * (Gx[6] * xkl2 + 2.0 * (Gx[7] * xkl) + Gx[8]) * (Gy[5]) * (Gz[1]);
        tile[49] += sc * (Gx[6] * xkl + Gx[7]) * (Gy[5] * ykl + Gy[6]) * (Gz[1]);
        tile[50] += sc * (Gx[6] * xkl + Gx[7]) * (Gy[5]) * (Gz[1] * zkl + Gz[2]);
        tile[51] += sc * (Gx[6]) * (Gy[5] * ykl2 + 2.0 * (Gy[6] * ykl) + Gy[7]) * (Gz[1]);
        tile[52] += sc * (Gx[6]) * (Gy[5] * ykl + Gy[6]) * (Gz[1] * zkl + Gz[2]);
        tile[53] += sc * (Gx[6]) * (Gy[5]) * (Gz[1] * zkl2 + 2.0 * (Gz[2] * zkl) + Gz[3]);
        tile[54] += sc * (Gx[5] * xkl2 + 2.0 * (Gx[6] * xkl) + Gx[7]) * (Gy[7]) * (Gz[0]);
        tile[55] += sc * (Gx[5] * xkl + Gx[6]) * (Gy[7] * ykl + Gy[8]) * (Gz[0]);
        tile[56] += sc * (Gx[5] * xkl + Gx[6]) * (Gy[7]) * (Gz[0] * zkl + Gz[1]);
        tile[57] += sc * (Gx[5]) * (Gy[7] * ykl2 + 2.0 * (Gy[8] * ykl) + Gy[9]) * (Gz[0]);
        tile[58] += sc * (Gx[5]) * (Gy[7] * ykl + Gy[8]) * (Gz[0] * zkl + Gz[1]);
        tile[59] += sc * (Gx[5]) * (Gy[7]) * (Gz[0] * zkl2 + 2.0 * (Gz[1] * zkl) + Gz[2]);
        tile[60] += sc * (Gx[5] * xkl2 + 2.0 * (Gx[6] * xkl) + Gx[7]) * (Gy[6]) * (Gz[1]);
        tile[61] += sc * (Gx[5] * xkl + Gx[6]) * (Gy[6] * ykl + Gy[7]) * (Gz[1]);
        tile[62] += sc * (Gx[5] * xkl + Gx[6]) * (Gy[6]) * (Gz[1] * zkl + Gz[2]);
        tile[63] += sc * (Gx[5]) * (Gy[6] * ykl2 + 2.0 * (Gy[7] * ykl) + Gy[8]) * (Gz[1]);
        tile[64] += sc * (Gx[5]) * (Gy[6] * ykl + Gy[7]) * (Gz[1] * zkl + Gz[2]);
        tile[65] += sc * (Gx[5]) * (Gy[6]) * (Gz[1] * zkl2 + 2.0 * (Gz[2] * zkl) + Gz[3]);
        tile[66] += sc * (Gx[5] * xkl2 + 2.0 * (Gx[6] * xkl) + Gx[7]) * (Gy[5]) * (Gz[2]);
        tile[67] += sc * (Gx[5] * xkl + Gx[6]) * (Gy[5] * ykl + Gy[6]) * (Gz[2]);
        tile[68] += sc * (Gx[5] * xkl + Gx[6]) * (Gy[5]) * (Gz[2] * zkl + Gz[3]);
        tile[69] += sc * (Gx[5]) * (Gy[5] * ykl2 + 2.0 * (Gy[6] * ykl) + Gy[7]) * (Gz[2]);
        tile[70] += sc * (Gx[5]) * (Gy[5] * ykl + Gy[6]) * (Gz[2] * zkl + Gz[3]);
        tile[71] += sc * (Gx[5]) * (Gy[5]) * (Gz[2] * zkl2 + 2.0 * (Gz[3] * zkl) + Gz[4]);
        tile[72] += sc * (Gx[7] * xkl2 + 2.0 * (Gx[8] * xkl) + Gx[9]) * (Gy[0]) * (Gz[5]);
        tile[73] += sc * (Gx[7] * xkl + Gx[8]) * (Gy[0] * ykl + Gy[1]) * (Gz[5]);
        tile[74] += sc * (Gx[7] * xkl + Gx[8]) * (Gy[0]) * (Gz[5] * zkl + Gz[6]);
        tile[75] += sc * (Gx[7]) * (Gy[0] * ykl2 + 2.0 * (Gy[1] * ykl) + Gy[2]) * (Gz[5]);
        tile[76] += sc * (Gx[7]) * (Gy[0] * ykl + Gy[1]) * (Gz[5] * zkl + Gz[6]);
        tile[77] += sc * (Gx[7]) * (Gy[0]) * (Gz[5] * zkl2 + 2.0 * (Gz[6] * zkl) + Gz[7]);
        tile[78] += sc * (Gx[6] * xkl2 + 2.0 * (Gx[7] * xkl) + Gx[8]) * (Gy[1]) * (Gz[5]);
        tile[79] += sc * (Gx[6] * xkl + Gx[7]) * (Gy[1] * ykl + Gy[2]) * (Gz[5]);
        tile[80] += sc * (Gx[6] * xkl + Gx[7]) * (Gy[1]) * (Gz[5] * zkl + Gz[6]);
        tile[81] += sc * (Gx[6]) * (Gy[1] * ykl2 + 2.0 * (Gy[2] * ykl) + Gy[3]) * (Gz[5]);
        tile[82] += sc * (Gx[6]) * (Gy[1] * ykl + Gy[2]) * (Gz[5] * zkl + Gz[6]);
        tile[83] += sc * (Gx[6]) * (Gy[1]) * (Gz[5] * zkl2 + 2.0 * (Gz[6] * zkl) + Gz[7]);
        tile[84] += sc * (Gx[6] * xkl2 + 2.0 * (Gx[7] * xkl) + Gx[8]) * (Gy[0]) * (Gz[6]);
        tile[85] += sc * (Gx[6] * xkl + Gx[7]) * (Gy[0] * ykl + Gy[1]) * (Gz[6]);
        tile[86] += sc * (Gx[6] * xkl + Gx[7]) * (Gy[0]) * (Gz[6] * zkl + Gz[7]);
        tile[87] += sc * (Gx[6]) * (Gy[0] * ykl2 + 2.0 * (Gy[1] * ykl) + Gy[2]) * (Gz[6]);
        tile[88] += sc * (Gx[6]) * (Gy[0] * ykl + Gy[1]) * (Gz[6] * zkl + Gz[7]);
        tile[89] += sc * (Gx[6]) * (Gy[0]) * (Gz[6] * zkl2 + 2.0 * (Gz[7] * zkl) + Gz[8]);
        tile[90] += sc * (Gx[5] * xkl2 + 2.0 * (Gx[6] * xkl) + Gx[7]) * (Gy[2]) * (Gz[5]);
        tile[91] += sc * (Gx[5] * xkl + Gx[6]) * (Gy[2] * ykl + Gy[3]) * (Gz[5]);
        tile[92] += sc * (Gx[5] * xkl + Gx[6]) * (Gy[2]) * (Gz[5] * zkl + Gz[6]);
        tile[93] += sc * (Gx[5]) * (Gy[2] * ykl2 + 2.0 * (Gy[3] * ykl) + Gy[4]) * (Gz[5]);
        tile[94] += sc * (Gx[5]) * (Gy[2] * ykl + Gy[3]) * (Gz[5] * zkl + Gz[6]);
        tile[95] += sc * (Gx[5]) * (Gy[2]) * (Gz[5] * zkl2 + 2.0 * (Gz[6] * zkl) + Gz[7]);
        tile[96] += sc * (Gx[5] * xkl2 + 2.0 * (Gx[6] * xkl) + Gx[7]) * (Gy[1]) * (Gz[6]);
        tile[97] += sc * (Gx[5] * xkl + Gx[6]) * (Gy[1] * ykl + Gy[2]) * (Gz[6]);
        tile[98] += sc * (Gx[5] * xkl + Gx[6]) * (Gy[1]) * (Gz[6] * zkl + Gz[7]);
        tile[99] += sc * (Gx[5]) * (Gy[1] * ykl2 + 2.0 * (Gy[2] * ykl) + Gy[3]) * (Gz[6]);
        tile[100] += sc * (Gx[5]) * (Gy[1] * ykl + Gy[2]) * (Gz[6] * zkl + Gz[7]);
        tile[101] += sc * (Gx[5]) * (Gy[1]) * (Gz[6] * zkl2 + 2.0 * (Gz[7] * zkl) + Gz[8]);
        tile[102] += sc * (Gx[5] * xkl2 + 2.0 * (Gx[6] * xkl) + Gx[7]) * (Gy[0]) * (Gz[7]);
        tile[103] += sc * (Gx[5] * xkl + Gx[6]) * (Gy[0] * ykl + Gy[1]) * (Gz[7]);
        tile[104] += sc * (Gx[5] * xkl + Gx[6]) * (Gy[0]) * (Gz[7] * zkl + Gz[8]);
        tile[105] += sc * (Gx[5]) * (Gy[0] * ykl2 + 2.0 * (Gy[1] * ykl) + Gy[2]) * (Gz[7]);
        tile[106] += sc * (Gx[5]) * (Gy[0] * ykl + Gy[1]) * (Gz[7] * zkl + Gz[8]);
        tile[107] += sc * (Gx[5]) * (Gy[0]) * (Gz[7] * zkl2 + 2.0 * (Gz[8] * zkl) + Gz[9]);
        tile[108] += sc * (Gx[2] * xkl2 + 2.0 * (Gx[3] * xkl) + Gx[4]) * (Gy[10]) * (Gz[0]);
        tile[109] += sc * (Gx[2] * xkl + Gx[3]) * (Gy[10] * ykl + Gy[11]) * (Gz[0]);
        tile[110] += sc * (Gx[2] * xkl + Gx[3]) * (Gy[10]) * (Gz[0] * zkl + Gz[1]);
        tile[111] += sc * (Gx[2]) * (Gy[10] * ykl2 + 2.0 * (Gy[11] * ykl) + Gy[12]) * (Gz[0]);
        tile[112] += sc * (Gx[2]) * (Gy[10] * ykl + Gy[11]) * (Gz[0] * zkl + Gz[1]);
        tile[113] += sc * (Gx[2]) * (Gy[10]) * (Gz[0] * zkl2 + 2.0 * (Gz[1] * zkl) + Gz[2]);
        tile[114] += sc * (Gx[1] * xkl2 + 2.0 * (Gx[2] * xkl) + Gx[3]) * (Gy[11]) * (Gz[0]);
        tile[115] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[11] * ykl + Gy[12]) * (Gz[0]);
        tile[116] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[11]) * (Gz[0] * zkl + Gz[1]);
        tile[117] += sc * (Gx[1]) * (Gy[11] * ykl2 + 2.0 * (Gy[12] * ykl) + Gy[13]) * (Gz[0]);
        tile[118] += sc * (Gx[1]) * (Gy[11] * ykl + Gy[12]) * (Gz[0] * zkl + Gz[1]);
        tile[119] += sc * (Gx[1]) * (Gy[11]) * (Gz[0] * zkl2 + 2.0 * (Gz[1] * zkl) + Gz[2]);
        tile[120] += sc * (Gx[1] * xkl2 + 2.0 * (Gx[2] * xkl) + Gx[3]) * (Gy[10]) * (Gz[1]);
        tile[121] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[10] * ykl + Gy[11]) * (Gz[1]);
        tile[122] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[10]) * (Gz[1] * zkl + Gz[2]);
        tile[123] += sc * (Gx[1]) * (Gy[10] * ykl2 + 2.0 * (Gy[11] * ykl) + Gy[12]) * (Gz[1]);
        tile[124] += sc * (Gx[1]) * (Gy[10] * ykl + Gy[11]) * (Gz[1] * zkl + Gz[2]);
        tile[125] += sc * (Gx[1]) * (Gy[10]) * (Gz[1] * zkl2 + 2.0 * (Gz[2] * zkl) + Gz[3]);
        tile[126] += sc * (Gx[0] * xkl2 + 2.0 * (Gx[1] * xkl) + Gx[2]) * (Gy[12]) * (Gz[0]);
        tile[127] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[12] * ykl + Gy[13]) * (Gz[0]);
        tile[128] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[12]) * (Gz[0] * zkl + Gz[1]);
        tile[129] += sc * (Gx[0]) * (Gy[12] * ykl2 + 2.0 * (Gy[13] * ykl) + Gy[14]) * (Gz[0]);
        tile[130] += sc * (Gx[0]) * (Gy[12] * ykl + Gy[13]) * (Gz[0] * zkl + Gz[1]);
        tile[131] += sc * (Gx[0]) * (Gy[12]) * (Gz[0] * zkl2 + 2.0 * (Gz[1] * zkl) + Gz[2]);
        tile[132] += sc * (Gx[0] * xkl2 + 2.0 * (Gx[1] * xkl) + Gx[2]) * (Gy[11]) * (Gz[1]);
        tile[133] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[11] * ykl + Gy[12]) * (Gz[1]);
        tile[134] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[11]) * (Gz[1] * zkl + Gz[2]);
        tile[135] += sc * (Gx[0]) * (Gy[11] * ykl2 + 2.0 * (Gy[12] * ykl) + Gy[13]) * (Gz[1]);
        tile[136] += sc * (Gx[0]) * (Gy[11] * ykl + Gy[12]) * (Gz[1] * zkl + Gz[2]);
        tile[137] += sc * (Gx[0]) * (Gy[11]) * (Gz[1] * zkl2 + 2.0 * (Gz[2] * zkl) + Gz[3]);
        tile[138] += sc * (Gx[0] * xkl2 + 2.0 * (Gx[1] * xkl) + Gx[2]) * (Gy[10]) * (Gz[2]);
        tile[139] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[10] * ykl + Gy[11]) * (Gz[2]);
        tile[140] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[10]) * (Gz[2] * zkl + Gz[3]);
        tile[141] += sc * (Gx[0]) * (Gy[10] * ykl2 + 2.0 * (Gy[11] * ykl) + Gy[12]) * (Gz[2]);
        tile[142] += sc * (Gx[0]) * (Gy[10] * ykl + Gy[11]) * (Gz[2] * zkl + Gz[3]);
        tile[143] += sc * (Gx[0]) * (Gy[10]) * (Gz[2] * zkl2 + 2.0 * (Gz[3] * zkl) + Gz[4]);
        tile[144] += sc * (Gx[2] * xkl2 + 2.0 * (Gx[3] * xkl) + Gx[4]) * (Gy[5]) * (Gz[5]);
        tile[145] += sc * (Gx[2] * xkl + Gx[3]) * (Gy[5] * ykl + Gy[6]) * (Gz[5]);
        tile[146] += sc * (Gx[2] * xkl + Gx[3]) * (Gy[5]) * (Gz[5] * zkl + Gz[6]);
        tile[147] += sc * (Gx[2]) * (Gy[5] * ykl2 + 2.0 * (Gy[6] * ykl) + Gy[7]) * (Gz[5]);
        tile[148] += sc * (Gx[2]) * (Gy[5] * ykl + Gy[6]) * (Gz[5] * zkl + Gz[6]);
        tile[149] += sc * (Gx[2]) * (Gy[5]) * (Gz[5] * zkl2 + 2.0 * (Gz[6] * zkl) + Gz[7]);
        tile[150] += sc * (Gx[1] * xkl2 + 2.0 * (Gx[2] * xkl) + Gx[3]) * (Gy[6]) * (Gz[5]);
        tile[151] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[6] * ykl + Gy[7]) * (Gz[5]);
        tile[152] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[6]) * (Gz[5] * zkl + Gz[6]);
        tile[153] += sc * (Gx[1]) * (Gy[6] * ykl2 + 2.0 * (Gy[7] * ykl) + Gy[8]) * (Gz[5]);
        tile[154] += sc * (Gx[1]) * (Gy[6] * ykl + Gy[7]) * (Gz[5] * zkl + Gz[6]);
        tile[155] += sc * (Gx[1]) * (Gy[6]) * (Gz[5] * zkl2 + 2.0 * (Gz[6] * zkl) + Gz[7]);
        tile[156] += sc * (Gx[1] * xkl2 + 2.0 * (Gx[2] * xkl) + Gx[3]) * (Gy[5]) * (Gz[6]);
        tile[157] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[5] * ykl + Gy[6]) * (Gz[6]);
        tile[158] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[5]) * (Gz[6] * zkl + Gz[7]);
        tile[159] += sc * (Gx[1]) * (Gy[5] * ykl2 + 2.0 * (Gy[6] * ykl) + Gy[7]) * (Gz[6]);
        tile[160] += sc * (Gx[1]) * (Gy[5] * ykl + Gy[6]) * (Gz[6] * zkl + Gz[7]);
        tile[161] += sc * (Gx[1]) * (Gy[5]) * (Gz[6] * zkl2 + 2.0 * (Gz[7] * zkl) + Gz[8]);
        tile[162] += sc * (Gx[0] * xkl2 + 2.0 * (Gx[1] * xkl) + Gx[2]) * (Gy[7]) * (Gz[5]);
        tile[163] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[7] * ykl + Gy[8]) * (Gz[5]);
        tile[164] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[7]) * (Gz[5] * zkl + Gz[6]);
        tile[165] += sc * (Gx[0]) * (Gy[7] * ykl2 + 2.0 * (Gy[8] * ykl) + Gy[9]) * (Gz[5]);
        tile[166] += sc * (Gx[0]) * (Gy[7] * ykl + Gy[8]) * (Gz[5] * zkl + Gz[6]);
        tile[167] += sc * (Gx[0]) * (Gy[7]) * (Gz[5] * zkl2 + 2.0 * (Gz[6] * zkl) + Gz[7]);
        tile[168] += sc * (Gx[0] * xkl2 + 2.0 * (Gx[1] * xkl) + Gx[2]) * (Gy[6]) * (Gz[6]);
        tile[169] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[6] * ykl + Gy[7]) * (Gz[6]);
        tile[170] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[6]) * (Gz[6] * zkl + Gz[7]);
        tile[171] += sc * (Gx[0]) * (Gy[6] * ykl2 + 2.0 * (Gy[7] * ykl) + Gy[8]) * (Gz[6]);
        tile[172] += sc * (Gx[0]) * (Gy[6] * ykl + Gy[7]) * (Gz[6] * zkl + Gz[7]);
        tile[173] += sc * (Gx[0]) * (Gy[6]) * (Gz[6] * zkl2 + 2.0 * (Gz[7] * zkl) + Gz[8]);
        tile[174] += sc * (Gx[0] * xkl2 + 2.0 * (Gx[1] * xkl) + Gx[2]) * (Gy[5]) * (Gz[7]);
        tile[175] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[5] * ykl + Gy[6]) * (Gz[7]);
        tile[176] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[5]) * (Gz[7] * zkl + Gz[8]);
        tile[177] += sc * (Gx[0]) * (Gy[5] * ykl2 + 2.0 * (Gy[6] * ykl) + Gy[7]) * (Gz[7]);
        tile[178] += sc * (Gx[0]) * (Gy[5] * ykl + Gy[6]) * (Gz[7] * zkl + Gz[8]);
        tile[179] += sc * (Gx[0]) * (Gy[5]) * (Gz[7] * zkl2 + 2.0 * (Gz[8] * zkl) + Gz[9]);
        tile[180] += sc * (Gx[2] * xkl2 + 2.0 * (Gx[3] * xkl) + Gx[4]) * (Gy[0]) * (Gz[10]);
        tile[181] += sc * (Gx[2] * xkl + Gx[3]) * (Gy[0] * ykl + Gy[1]) * (Gz[10]);
        tile[182] += sc * (Gx[2] * xkl + Gx[3]) * (Gy[0]) * (Gz[10] * zkl + Gz[11]);
        tile[183] += sc * (Gx[2]) * (Gy[0] * ykl2 + 2.0 * (Gy[1] * ykl) + Gy[2]) * (Gz[10]);
        tile[184] += sc * (Gx[2]) * (Gy[0] * ykl + Gy[1]) * (Gz[10] * zkl + Gz[11]);
        tile[185] += sc * (Gx[2]) * (Gy[0]) * (Gz[10] * zkl2 + 2.0 * (Gz[11] * zkl) + Gz[12]);
        tile[186] += sc * (Gx[1] * xkl2 + 2.0 * (Gx[2] * xkl) + Gx[3]) * (Gy[1]) * (Gz[10]);
        tile[187] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[1] * ykl + Gy[2]) * (Gz[10]);
        tile[188] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[1]) * (Gz[10] * zkl + Gz[11]);
        tile[189] += sc * (Gx[1]) * (Gy[1] * ykl2 + 2.0 * (Gy[2] * ykl) + Gy[3]) * (Gz[10]);
        tile[190] += sc * (Gx[1]) * (Gy[1] * ykl + Gy[2]) * (Gz[10] * zkl + Gz[11]);
        tile[191] += sc * (Gx[1]) * (Gy[1]) * (Gz[10] * zkl2 + 2.0 * (Gz[11] * zkl) + Gz[12]);
        tile[192] += sc * (Gx[1] * xkl2 + 2.0 * (Gx[2] * xkl) + Gx[3]) * (Gy[0]) * (Gz[11]);
        tile[193] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[0] * ykl + Gy[1]) * (Gz[11]);
        tile[194] += sc * (Gx[1] * xkl + Gx[2]) * (Gy[0]) * (Gz[11] * zkl + Gz[12]);
        tile[195] += sc * (Gx[1]) * (Gy[0] * ykl2 + 2.0 * (Gy[1] * ykl) + Gy[2]) * (Gz[11]);
        tile[196] += sc * (Gx[1]) * (Gy[0] * ykl + Gy[1]) * (Gz[11] * zkl + Gz[12]);
        tile[197] += sc * (Gx[1]) * (Gy[0]) * (Gz[11] * zkl2 + 2.0 * (Gz[12] * zkl) + Gz[13]);
        tile[198] += sc * (Gx[0] * xkl2 + 2.0 * (Gx[1] * xkl) + Gx[2]) * (Gy[2]) * (Gz[10]);
        tile[199] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[2] * ykl + Gy[3]) * (Gz[10]);
        tile[200] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[2]) * (Gz[10] * zkl + Gz[11]);
        tile[201] += sc * (Gx[0]) * (Gy[2] * ykl2 + 2.0 * (Gy[3] * ykl) + Gy[4]) * (Gz[10]);
        tile[202] += sc * (Gx[0]) * (Gy[2] * ykl + Gy[3]) * (Gz[10] * zkl + Gz[11]);
        tile[203] += sc * (Gx[0]) * (Gy[2]) * (Gz[10] * zkl2 + 2.0 * (Gz[11] * zkl) + Gz[12]);
        tile[204] += sc * (Gx[0] * xkl2 + 2.0 * (Gx[1] * xkl) + Gx[2]) * (Gy[1]) * (Gz[11]);
        tile[205] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[1] * ykl + Gy[2]) * (Gz[11]);
        tile[206] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[1]) * (Gz[11] * zkl + Gz[12]);
        tile[207] += sc * (Gx[0]) * (Gy[1] * ykl2 + 2.0 * (Gy[2] * ykl) + Gy[3]) * (Gz[11]);
        tile[208] += sc * (Gx[0]) * (Gy[1] * ykl + Gy[2]) * (Gz[11] * zkl + Gz[12]);
        tile[209] += sc * (Gx[0]) * (Gy[1]) * (Gz[11] * zkl2 + 2.0 * (Gz[12] * zkl) + Gz[13]);
        tile[210] += sc * (Gx[0] * xkl2 + 2.0 * (Gx[1] * xkl) + Gx[2]) * (Gy[0]) * (Gz[12]);
        tile[211] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[0] * ykl + Gy[1]) * (Gz[12]);
        tile[212] += sc * (Gx[0] * xkl + Gx[1]) * (Gy[0]) * (Gz[12] * zkl + Gz[13]);
        tile[213] += sc * (Gx[0]) * (Gy[0] * ykl2 + 2.0 * (Gy[1] * ykl) + Gy[2]) * (Gz[12]);
        tile[214] += sc * (Gx[0]) * (Gy[0] * ykl + Gy[1]) * (Gz[12] * zkl + Gz[13]);
        tile[215] += sc * (Gx[0]) * (Gy[0]) * (Gz[12] * zkl2 + 2.0 * (Gz[13] * zkl) + Gz[14]);
      }
    }
  }
