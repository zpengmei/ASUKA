  ...
  for (int ip = 0; ip < nPairAB; ++ip) {
    ...
    for (int jp = 0; jp < nPairCD; ++jp) {
      ...
      for (int u = 0; u < NROOTS; ++u) {
        ...
        Ux[0] = Gx[14] * xij2 + 2.0 * (Gx[19] * xij) + Gx[24];
        Ux[1] = Gx[13] * xij2 + 2.0 * (Gx[18] * xij) + Gx[23];
        Ux[2] = Gx[12] * xij2 + 2.0 * (Gx[17] * xij) + Gx[22];
        Ux[3] = Gx[11] * xij2 + 2.0 * (Gx[16] * xij) + Gx[21];
        Ux[4] = Gx[10] * xij2 + 2.0 * (Gx[15] * xij) + Gx[20];
        Ux[5] = Gx[14] * xij + Gx[19];
        Ux[6] = Gx[13] * xij + Gx[18];
        Ux[7] = Gx[12] * xij + Gx[17];
        Ux[8] = Gx[11] * xij + Gx[16];
        Ux[9] = Gx[10] * xij + Gx[15];
        Ux[10] = Gx[14];
        Ux[11] = Gx[13];
        Ux[12] = Gx[12];
        Ux[13] = Gx[11];
        Ux[14] = Gx[10];
        Ux[15] = Gx[9] * xij2 + 2.0 * (Gx[14] * xij) + Gx[19];
        Ux[16] = Gx[8] * xij2 + 2.0 * (Gx[13] * xij) + Gx[18];
        Ux[17] = Gx[7] * xij2 + 2.0 * (Gx[12] * xij) + Gx[17];
        Ux[18] = Gx[6] * xij2 + 2.0 * (Gx[11] * xij) + Gx[16];
        Ux[19] = Gx[5] * xij2 + 2.0 * (Gx[10] * xij) + Gx[15];
        ...
        Ux[28] = Gx[6];
        Ux[29] = Gx[5];
        Ux[30] = Gx[4] * xij2 + 2.0 * (Gx[9] * xij) + Gx[14];
        Ux[31] = Gx[3] * xij2 + 2.0 * (Gx[8] * xij) + Gx[13];
        Ux[32] = Gx[2] * xij2 + 2.0 * (Gx[7] * xij) + Gx[12];
        Ux[33] = Gx[1] * xij2 + 2.0 * (Gx[6] * xij) + Gx[11];
        Ux[34] = Gx[0] * xij2 + 2.0 * (Gx[5] * xij) + Gx[10];
        Ux[35] = Gx[4] * xij + Gx[9];
        Ux[36] = Gx[3] * xij + Gx[8];
        Ux[37] = Gx[2] * xij + Gx[7];
        Ux[38] = Gx[1] * xij + Gx[6];
