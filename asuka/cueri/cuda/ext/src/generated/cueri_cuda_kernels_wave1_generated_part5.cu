// Auto-split from cueri_cuda_kernels_wave1_generated.cu (part 5/12: psfs..fpfs)
  ...
  for (int ip = 0; ip < nPairAB; ++ip) {
    ...
    for (int jp = 0; jp < nPairCD; ++jp) {
      ...
      for (int u = 0; u < NROOTS; ++u) {
        ...
        Uy[12] = Gy[4] * yij + Gy[8];
        Uy[13] = Gy[5] * yij + Gy[9];
        Uy[14] = Gy[6] * yij + Gy[10];
        Uy[15] = Gy[7] * yij + Gy[11];
        Uz[0] = Gz[0];
        Uz[1] = Gz[1];
        Uz[2] = Gz[2];
        Uz[3] = Gz[3];
        ...
        Uz[12] = Gz[4] * zij + Gz[8];
        Uz[13] = Gz[5] * zij + Gz[9];
        Uz[14] = Gz[6] * zij + Gz[10];
        Uz[15] = Gz[7] * zij + Gz[11];
        tile[0] += sc * Ux[0] * Uy[0] * Uz[0];
        tile[1] += sc * Ux[1] * Uy[1] * Uz[0];
        tile[2] += sc * Ux[1] * Uy[0] * Uz[1];
        tile[3] += sc * Ux[2] * Uy[2] * Uz[0];
        ...
        tile[40] += sc * Ux[12] * Uy[12] * Uz[0];
        tile[41] += sc * Ux[13] * Uy[13] * Uz[0];
        tile[42] += sc * Ux[13] * Uy[12] * Uz[1];
        tile[43] += sc * Ux[14] * Uy[14] * Uz[0];
        tile[44] += sc * Ux[14] * Uy[13] * Uz[1];
        tile[45] += sc * Ux[14] * Uy[12] * Uz[2];
        tile[46] += sc * Ux[15] * Uy[15] * Uz[0];
        tile[47] += sc * Ux[15] * Uy[14] * Uz[1];
        tile[48] += sc * Ux[15] * Uy[13] * Uz[2];
        tile[49] += sc * Ux[15] * Uy[12] * Uz[3];
        tile[50] += sc * Ux[12] * Uy[8] * Uz[4];
        tile[51] += sc * Ux[13] * Uy[9] * Uz[4];
        tile[52] += sc * Ux[13] * Uy[8] * Uz[5];
        tile[53] += sc * Ux[14] * Uy[10] * Uz[4];
        tile[54] += sc * Ux[14] * Uy[9] * Uz[5];
        tile[55] += sc * Ux[14] * Uy[8] * Uz[6];
        tile[56] += sc * Ux[15] * Uy[11] * Uz[4];
        tile[57] += sc * Ux[15] * Uy[10] * Uz[5];
        ...
        tile[64] += sc * Ux[10] * Uy[1] * Uz[9];
        tile[65] += sc * Ux[10] * Uy[0] * Uz[10];
        tile[66] += sc * Ux[11] * Uy[3] * Uz[8];
        tile[67] += sc * Ux[11] * Uy[2] * Uz[9];
        tile[68] += sc * Ux[11] * Uy[1] * Uz[10];
        tile[69] += sc * Ux[11] * Uy[0] * Uz[11];
        tile[70] += sc * Ux[12] * Uy[4] * Uz[8];
        tile[71] += sc * Ux[13] * Uy[5] * Uz[8];
        tile[72] += sc * Ux[13] * Uy[4] * Uz[9];
        tile[73] += sc * Ux[14] * Uy[6] * Uz[8];
        tile[74] += sc * Ux[14] * Uy[5] * Uz[9];
        tile[75] += sc * Ux[14] * Uy[4] * Uz[10];
        tile[76] += sc * Ux[15] * Uy[7] * Uz[8];
        tile[77] += sc * Ux[15] * Uy[6] * Uz[9];
        tile[78] += sc * Ux[15] * Uy[5] * Uz[10];
        tile[79] += sc * Ux[15] * Uy[4] * Uz[11];
        tile[80] += sc * Ux[12] * Uy[0] * Uz[12];
        tile[81] += sc * Ux[13] * Uy[1] * Uz[12];
        tile[82] += sc * Ux[13] * Uy[0] * Uz[13];
        tile[83] += sc * Ux[14] * Uy[2] * Uz[12];
        tile[84] += sc * Ux[14] * Uy[1] * Uz[13];
        tile[85] += sc * Ux[14] * Uy[0] * Uz[14];
        tile[86] += sc * Ux[15] * Uy[3] * Uz[12];
        tile[87] += sc * Ux[15] * Uy[2] * Uz[13];
  ...
  for (int ip = 0; ip < nPairAB; ++ip) {
    ...
    for (int jp = 0; jp < nPairCD; ++jp) {
      ...
      for (int u = 0; u < NROOTS; ++u) {
        ...
        Uy[18] = Gy[10];
        Uy[19] = Gy[11];
        Uy[20] = Gy[8] * yij + Gy[12];
        Uy[21] = Gy[9] * yij + Gy[13];
        Uy[22] = Gy[10] * yij + Gy[14];
        Uy[23] = Gy[11] * yij + Gy[15];
        Uz[0] = Gz[0];
        Uz[1] = Gz[1];
        Uz[2] = Gz[2];
        Uz[3] = Gz[3];
        ...
        Uz[18] = Gz[10];
        Uz[19] = Gz[11];
        Uz[20] = Gz[8] * zij + Gz[12];
        Uz[21] = Gz[9] * zij + Gz[13];
        Uz[22] = Gz[10] * zij + Gz[14];
        Uz[23] = Gz[11] * zij + Gz[15];
        tile[0] += sc * Ux[0] * Uy[0] * Uz[0];
        tile[1] += sc * Ux[1] * Uy[1] * Uz[0];
        tile[2] += sc * Ux[1] * Uy[0] * Uz[1];
        tile[3] += sc * Ux[2] * Uy[2] * Uz[0];
        ...
        tile[94] += sc * Ux[18] * Uy[17] * Uz[1];
        tile[95] += sc * Ux[18] * Uy[16] * Uz[2];
        tile[96] += sc * Ux[19] * Uy[19] * Uz[0];
        tile[97] += sc * Ux[19] * Uy[18] * Uz[1];
        tile[98] += sc * Ux[19] * Uy[17] * Uz[2];
        tile[99] += sc * Ux[19] * Uy[16] * Uz[3];
        tile[100] += sc * Ux[20] * Uy[20] * Uz[0];
        tile[101] += sc * Ux[21] * Uy[21] * Uz[0];
        tile[102] += sc * Ux[21] * Uy[20] * Uz[1];
        tile[103] += sc * Ux[22] * Uy[22] * Uz[0];
        tile[104] += sc * Ux[22] * Uy[21] * Uz[1];
        tile[105] += sc * Ux[22] * Uy[20] * Uz[2];
        tile[106] += sc * Ux[23] * Uy[23] * Uz[0];
        tile[107] += sc * Ux[23] * Uy[22] * Uz[1];
        tile[108] += sc * Ux[23] * Uy[21] * Uz[2];
        tile[109] += sc * Ux[23] * Uy[20] * Uz[3];
        tile[110] += sc * Ux[20] * Uy[16] * Uz[4];
        tile[111] += sc * Ux[21] * Uy[17] * Uz[4];
        tile[112] += sc * Ux[21] * Uy[16] * Uz[5];
        tile[113] += sc * Ux[22] * Uy[18] * Uz[4];
        tile[114] += sc * Ux[22] * Uy[17] * Uz[5];
        tile[115] += sc * Ux[22] * Uy[16] * Uz[6];
        tile[116] += sc * Ux[23] * Uy[19] * Uz[4];
        tile[117] += sc * Ux[23] * Uy[18] * Uz[5];
        ...
        tile[124] += sc * Ux[18] * Uy[9] * Uz[9];
        tile[125] += sc * Ux[18] * Uy[8] * Uz[10];
        tile[126] += sc * Ux[19] * Uy[11] * Uz[8];
        tile[127] += sc * Ux[19] * Uy[10] * Uz[9];
        tile[128] += sc * Ux[19] * Uy[9] * Uz[10];
        tile[129] += sc * Ux[19] * Uy[8] * Uz[11];
        tile[130] += sc * Ux[20] * Uy[12] * Uz[8];
        tile[131] += sc * Ux[21] * Uy[13] * Uz[8];
        tile[132] += sc * Ux[21] * Uy[12] * Uz[9];
        tile[133] += sc * Ux[22] * Uy[14] * Uz[8];
        tile[134] += sc * Ux[22] * Uy[13] * Uz[9];
        tile[135] += sc * Ux[22] * Uy[12] * Uz[10];
        tile[136] += sc * Ux[23] * Uy[15] * Uz[8];
        tile[137] += sc * Ux[23] * Uy[14] * Uz[9];
        tile[138] += sc * Ux[23] * Uy[13] * Uz[10];
        tile[139] += sc * Ux[23] * Uy[12] * Uz[11];
        tile[140] += sc * Ux[20] * Uy[8] * Uz[12];
        tile[141] += sc * Ux[21] * Uy[9] * Uz[12];
        tile[142] += sc * Ux[21] * Uy[8] * Uz[13];
        tile[143] += sc * Ux[22] * Uy[10] * Uz[12];
        tile[144] += sc * Ux[22] * Uy[9] * Uz[13];
        tile[145] += sc * Ux[22] * Uy[8] * Uz[14];
        tile[146] += sc * Ux[23] * Uy[11] * Uz[12];
        tile[147] += sc * Ux[23] * Uy[10] * Uz[13];
        ...
        tile[154] += sc * Ux[18] * Uy[1] * Uz[17];
        tile[155] += sc * Ux[18] * Uy[0] * Uz[18];
        tile[156] += sc * Ux[19] * Uy[3] * Uz[16];
        tile[157] += sc * Ux[19] * Uy[2] * Uz[17];
        tile[158] += sc * Ux[19] * Uy[1] * Uz[18];
        tile[159] += sc * Ux[19] * Uy[0] * Uz[19];
        tile[160] += sc * Ux[20] * Uy[4] * Uz[16];
        tile[161] += sc * Ux[21] * Uy[5] * Uz[16];
        tile[162] += sc * Ux[21] * Uy[4] * Uz[17];
        tile[163] += sc * Ux[22] * Uy[6] * Uz[16];
        tile[164] += sc * Ux[22] * Uy[5] * Uz[17];
        tile[165] += sc * Ux[22] * Uy[4] * Uz[18];
        tile[166] += sc * Ux[23] * Uy[7] * Uz[16];
        tile[167] += sc * Ux[23] * Uy[6] * Uz[17];
        tile[168] += sc * Ux[23] * Uy[5] * Uz[18];
        tile[169] += sc * Ux[23] * Uy[4] * Uz[19];
        tile[170] += sc * Ux[20] * Uy[0] * Uz[20];
        tile[171] += sc * Ux[21] * Uy[1] * Uz[20];
        tile[172] += sc * Ux[21] * Uy[0] * Uz[21];
        tile[173] += sc * Ux[22] * Uy[2] * Uz[20];
        tile[174] += sc * Ux[22] * Uy[1] * Uz[21];
        tile[175] += sc * Ux[22] * Uy[0] * Uz[22];
        tile[176] += sc * Ux[23] * Uy[3] * Uz[20];
  ...
  for (int ip = 0; ip < nPairAB; ++ip) {
    ...
    for (int jp = 0; jp < nPairCD; ++jp) {
      ...
      for (int u = 0; u < NROOTS; ++u) {
        ...
        compute_G_stride_fixed<kFlatStride, kNMax, kMMax>(Gz, Cz_, Cpz_, B0, B1, B1p);
        const double sc = base * w;
        Ux[0] = Gx[15] * xij + Gx[19];
        Ux[1] = Gx[14] * xij + Gx[18];
        Ux[2] = Gx[13] * xij + Gx[17];
        Ux[3] = Gx[12] * xij + Gx[16];
        Ux[4] = Gx[15];
        Ux[5] = Gx[14];
        Ux[6] = Gx[13];
        Ux[7] = Gx[12];
        Ux[8] = Gx[11] * xij + Gx[15];
        Ux[9] = Gx[10] * xij + Gx[14];
        Ux[10] = Gx[9] * xij + Gx[13];
        Ux[11] = Gx[8] * xij + Gx[12];
        Ux[12] = Gx[11];
        Ux[13] = Gx[10];
        Ux[14] = Gx[9];
        Ux[15] = Gx[8];
        Ux[16] = Gx[7] * xij + Gx[11];
        Ux[17] = Gx[6] * xij + Gx[10];
        Ux[18] = Gx[5] * xij + Gx[9];
        Ux[19] = Gx[4] * xij + Gx[8];
        Ux[20] = Gx[7];
        Ux[21] = Gx[6];
        ...
        Uy[26] = Gy[14];
        Uy[27] = Gy[15];
        Uy[28] = Gy[12] * yij + Gy[16];
        Uy[29] = Gy[13] * yij + Gy[17];
        Uy[30] = Gy[14] * yij + Gy[18];
        Uy[31] = Gy[15] * yij + Gy[19];
        Uz[0] = Gz[0];
        Uz[1] = Gz[1];
        Uz[2] = Gz[2];
        Uz[3] = Gz[3];
        ...
        Uz[26] = Gz[14];
        Uz[27] = Gz[15];
        Uz[28] = Gz[12] * zij + Gz[16];
        Uz[29] = Gz[13] * zij + Gz[17];
        Uz[30] = Gz[14] * zij + Gz[18];
        Uz[31] = Gz[15] * zij + Gz[19];
        tile[0] += sc * Ux[0] * Uy[0] * Uz[0];
        tile[1] += sc * Ux[1] * Uy[1] * Uz[0];
        tile[2] += sc * Ux[1] * Uy[0] * Uz[1];
        tile[3] += sc * Ux[2] * Uy[2] * Uz[0];
        ...
        tile[187] += sc * Ux[27] * Uy[26] * Uz[1];
        tile[188] += sc * Ux[27] * Uy[25] * Uz[2];
        tile[189] += sc * Ux[27] * Uy[24] * Uz[3];
        tile[190] += sc * Ux[28] * Uy[28] * Uz[0];
        tile[191] += sc * Ux[29] * Uy[29] * Uz[0];
        tile[192] += sc * Ux[29] * Uy[28] * Uz[1];
        tile[193] += sc * Ux[30] * Uy[30] * Uz[0];
        tile[194] += sc * Ux[30] * Uy[29] * Uz[1];
        tile[195] += sc * Ux[30] * Uy[28] * Uz[2];
        tile[196] += sc * Ux[31] * Uy[31] * Uz[0];
        tile[197] += sc * Ux[31] * Uy[30] * Uz[1];
        tile[198] += sc * Ux[31] * Uy[29] * Uz[2];
        tile[199] += sc * Ux[31] * Uy[28] * Uz[3];
        tile[200] += sc * Ux[28] * Uy[24] * Uz[4];
        tile[201] += sc * Ux[29] * Uy[25] * Uz[4];
        tile[202] += sc * Ux[29] * Uy[24] * Uz[5];
        tile[203] += sc * Ux[30] * Uy[26] * Uz[4];
        tile[204] += sc * Ux[30] * Uy[25] * Uz[5];
        tile[205] += sc * Ux[30] * Uy[24] * Uz[6];
        tile[206] += sc * Ux[31] * Uy[27] * Uz[4];
        tile[207] += sc * Ux[31] * Uy[26] * Uz[5];
        ...
        tile[214] += sc * Ux[26] * Uy[17] * Uz[9];
        tile[215] += sc * Ux[26] * Uy[16] * Uz[10];
        tile[216] += sc * Ux[27] * Uy[19] * Uz[8];
        tile[217] += sc * Ux[27] * Uy[18] * Uz[9];
        tile[218] += sc * Ux[27] * Uy[17] * Uz[10];
        tile[219] += sc * Ux[27] * Uy[16] * Uz[11];
        tile[220] += sc * Ux[28] * Uy[20] * Uz[8];
        tile[221] += sc * Ux[29] * Uy[21] * Uz[8];
        tile[222] += sc * Ux[29] * Uy[20] * Uz[9];
        tile[223] += sc * Ux[30] * Uy[22] * Uz[8];
        tile[224] += sc * Ux[30] * Uy[21] * Uz[9];
        tile[225] += sc * Ux[30] * Uy[20] * Uz[10];
        tile[226] += sc * Ux[31] * Uy[23] * Uz[8];
        tile[227] += sc * Ux[31] * Uy[22] * Uz[9];
        tile[228] += sc * Ux[31] * Uy[21] * Uz[10];
        tile[229] += sc * Ux[31] * Uy[20] * Uz[11];
        tile[230] += sc * Ux[28] * Uy[16] * Uz[12];
        tile[231] += sc * Ux[29] * Uy[17] * Uz[12];
        tile[232] += sc * Ux[29] * Uy[16] * Uz[13];
        tile[233] += sc * Ux[30] * Uy[18] * Uz[12];
        tile[234] += sc * Ux[30] * Uy[17] * Uz[13];
        tile[235] += sc * Ux[30] * Uy[16] * Uz[14];
        tile[236] += sc * Ux[31] * Uy[19] * Uz[12];
        tile[237] += sc * Ux[31] * Uy[18] * Uz[13];
        ...
        tile[244] += sc * Ux[26] * Uy[9] * Uz[17];
        tile[245] += sc * Ux[26] * Uy[8] * Uz[18];
        tile[246] += sc * Ux[27] * Uy[11] * Uz[16];
        tile[247] += sc * Ux[27] * Uy[10] * Uz[17];
        tile[248] += sc * Ux[27] * Uy[9] * Uz[18];
        tile[249] += sc * Ux[27] * Uy[8] * Uz[19];
        tile[250] += sc * Ux[28] * Uy[12] * Uz[16];
        tile[251] += sc * Ux[29] * Uy[13] * Uz[16];
        tile[252] += sc * Ux[29] * Uy[12] * Uz[17];
        tile[253] += sc * Ux[30] * Uy[14] * Uz[16];
        tile[254] += sc * Ux[30] * Uy[13] * Uz[17];
        tile[255] += sc * Ux[30] * Uy[12] * Uz[18];
        tile[256] += sc * Ux[31] * Uy[15] * Uz[16];
        tile[257] += sc * Ux[31] * Uy[14] * Uz[17];
        tile[258] += sc * Ux[31] * Uy[13] * Uz[18];
        tile[259] += sc * Ux[31] * Uy[12] * Uz[19];
        tile[260] += sc * Ux[28] * Uy[8] * Uz[20];
        tile[261] += sc * Ux[29] * Uy[9] * Uz[20];
        tile[262] += sc * Ux[29] * Uy[8] * Uz[21];
        tile[263] += sc * Ux[30] * Uy[10] * Uz[20];
        tile[264] += sc * Ux[30] * Uy[9] * Uz[21];
        tile[265] += sc * Ux[30] * Uy[8] * Uz[22];
        tile[266] += sc * Ux[31] * Uy[11] * Uz[20];
        tile[267] += sc * Ux[31] * Uy[10] * Uz[21];
        ...
        tile[274] += sc * Ux[26] * Uy[1] * Uz[25];
        tile[275] += sc * Ux[26] * Uy[0] * Uz[26];
        tile[276] += sc * Ux[27] * Uy[3] * Uz[24];
        tile[277] += sc * Ux[27] * Uy[2] * Uz[25];
        tile[278] += sc * Ux[27] * Uy[1] * Uz[26];
        tile[279] += sc * Ux[27] * Uy[0] * Uz[27];
