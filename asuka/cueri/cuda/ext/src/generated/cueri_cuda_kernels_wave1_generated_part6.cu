  ...
  for (int ip = 0; ip < nPairAB; ++ip) {
    ...
    for (int jp = 0; jp < nPairCD; ++jp) {
      ...
      for (int u = 0; u < NROOTS; ++u) {
        ...
        Ux[0] = Gx[11] * xij2 + 2.0 * (Gx[15] * xij) + Gx[19];
        Ux[1] = Gx[10] * xij2 + 2.0 * (Gx[14] * xij) + Gx[18];
        Ux[2] = Gx[9] * xij2 + 2.0 * (Gx[13] * xij) + Gx[17];
        Ux[3] = Gx[8] * xij2 + 2.0 * (Gx[12] * xij) + Gx[16];
        Ux[4] = Gx[11] * xij + Gx[15];
        Ux[5] = Gx[10] * xij + Gx[14];
        Ux[6] = Gx[9] * xij + Gx[13];
        Ux[7] = Gx[8] * xij + Gx[12];
        Ux[8] = Gx[11];
        Ux[9] = Gx[10];
        Ux[10] = Gx[9];
        Ux[11] = Gx[8];
        Ux[12] = Gx[7] * xij2 + 2.0 * (Gx[11] * xij) + Gx[15];
        Ux[13] = Gx[6] * xij2 + 2.0 * (Gx[10] * xij) + Gx[14];
        Ux[14] = Gx[5] * xij2 + 2.0 * (Gx[9] * xij) + Gx[13];
        Ux[15] = Gx[4] * xij2 + 2.0 * (Gx[8] * xij) + Gx[12];
        ...
        Ux[22] = Gx[5];
        Ux[23] = Gx[4];
        Ux[24] = Gx[3] * xij2 + 2.0 * (Gx[7] * xij) + Gx[11];
        Ux[25] = Gx[2] * xij2 + 2.0 * (Gx[6] * xij) + Gx[10];
        Ux[26] = Gx[1] * xij2 + 2.0 * (Gx[5] * xij) + Gx[9];
        Ux[27] = Gx[0] * xij2 + 2.0 * (Gx[4] * xij) + Gx[8];
        Ux[28] = Gx[3] * xij + Gx[7];
        Ux[29] = Gx[2] * xij + Gx[6];
        Ux[30] = Gx[1] * xij + Gx[5];
        Ux[31] = Gx[0] * xij + Gx[4];
        ...
        Uy[16] = Gy[4] * yij + Gy[8];
        Uy[17] = Gy[5] * yij + Gy[9];
        Uy[18] = Gy[6] * yij + Gy[10];
        Uy[19] = Gy[7] * yij + Gy[11];
        Uy[20] = Gy[4] * yij2 + 2.0 * (Gy[8] * yij) + Gy[12];
        Uy[21] = Gy[5] * yij2 + 2.0 * (Gy[9] * yij) + Gy[13];
        Uy[22] = Gy[6] * yij2 + 2.0 * (Gy[10] * yij) + Gy[14];
        Uy[23] = Gy[7] * yij2 + 2.0 * (Gy[11] * yij) + Gy[15];
        Uy[24] = Gy[8];
        Uy[25] = Gy[9];
        Uy[26] = Gy[10];
        Uy[27] = Gy[11];
        Uy[28] = Gy[8] * yij + Gy[12];
        Uy[29] = Gy[9] * yij + Gy[13];
        Uy[30] = Gy[10] * yij + Gy[14];
        Uy[31] = Gy[11] * yij + Gy[15];
        Uy[32] = Gy[8] * yij2 + 2.0 * (Gy[12] * yij) + Gy[16];
        Uy[33] = Gy[9] * yij2 + 2.0 * (Gy[13] * yij) + Gy[17];
        Uy[34] = Gy[10] * yij2 + 2.0 * (Gy[14] * yij) + Gy[18];
        Uy[35] = Gy[11] * yij2 + 2.0 * (Gy[15] * yij) + Gy[19];
        Uz[0] = Gz[0];
        Uz[1] = Gz[1];
        Uz[2] = Gz[2];
        Uz[3] = Gz[3];
        ...
        Uz[16] = Gz[4] * zij + Gz[8];
        Uz[17] = Gz[5] * zij + Gz[9];
        Uz[18] = Gz[6] * zij + Gz[10];
        Uz[19] = Gz[7] * zij + Gz[11];
        Uz[20] = Gz[4] * zij2 + 2.0 * (Gz[8] * zij) + Gz[12];
        Uz[21] = Gz[5] * zij2 + 2.0 * (Gz[9] * zij) + Gz[13];
        Uz[22] = Gz[6] * zij2 + 2.0 * (Gz[10] * zij) + Gz[14];
        Uz[23] = Gz[7] * zij2 + 2.0 * (Gz[11] * zij) + Gz[15];
        Uz[24] = Gz[8];
        Uz[25] = Gz[9];
        Uz[26] = Gz[10];
        Uz[27] = Gz[11];
        Uz[28] = Gz[8] * zij + Gz[12];
        Uz[29] = Gz[9] * zij + Gz[13];
        Uz[30] = Gz[10] * zij + Gz[14];
        Uz[31] = Gz[11] * zij + Gz[15];
        Uz[32] = Gz[8] * zij2 + 2.0 * (Gz[12] * zij) + Gz[16];
        Uz[33] = Gz[9] * zij2 + 2.0 * (Gz[13] * zij) + Gz[17];
        Uz[34] = Gz[10] * zij2 + 2.0 * (Gz[14] * zij) + Gz[18];
        Uz[35] = Gz[11] * zij2 + 2.0 * (Gz[15] * zij) + Gz[19];
        ...
        tile[70] += sc * Ux[16] * Uy[16] * Uz[0];
        tile[71] += sc * Ux[17] * Uy[17] * Uz[0];
        tile[72] += sc * Ux[17] * Uy[16] * Uz[1];
        tile[73] += sc * Ux[18] * Uy[18] * Uz[0];
        tile[74] += sc * Ux[18] * Uy[17] * Uz[1];
        tile[75] += sc * Ux[18] * Uy[16] * Uz[2];
        tile[76] += sc * Ux[19] * Uy[19] * Uz[0];
        tile[77] += sc * Ux[19] * Uy[18] * Uz[1];
        tile[78] += sc * Ux[19] * Uy[17] * Uz[2];
        tile[79] += sc * Ux[19] * Uy[16] * Uz[3];
        tile[80] += sc * Ux[16] * Uy[12] * Uz[4];
        tile[81] += sc * Ux[17] * Uy[13] * Uz[4];
        tile[82] += sc * Ux[17] * Uy[12] * Uz[5];
        tile[83] += sc * Ux[18] * Uy[14] * Uz[4];
        tile[84] += sc * Ux[18] * Uy[13] * Uz[5];
        tile[85] += sc * Ux[18] * Uy[12] * Uz[6];
        tile[86] += sc * Ux[19] * Uy[15] * Uz[4];
        tile[87] += sc * Ux[19] * Uy[14] * Uz[5];
        tile[88] += sc * Ux[19] * Uy[13] * Uz[6];
        tile[89] += sc * Ux[19] * Uy[12] * Uz[7];
        tile[90] += sc * Ux[20] * Uy[20] * Uz[0];
        tile[91] += sc * Ux[21] * Uy[21] * Uz[0];
        tile[92] += sc * Ux[21] * Uy[20] * Uz[1];
        tile[93] += sc * Ux[22] * Uy[22] * Uz[0];
        tile[94] += sc * Ux[22] * Uy[21] * Uz[1];
        tile[95] += sc * Ux[22] * Uy[20] * Uz[2];
        tile[96] += sc * Ux[23] * Uy[23] * Uz[0];
        tile[97] += sc * Ux[23] * Uy[22] * Uz[1];
        tile[98] += sc * Ux[23] * Uy[21] * Uz[2];
        tile[99] += sc * Ux[23] * Uy[20] * Uz[3];
        tile[100] += sc * Ux[20] * Uy[16] * Uz[4];
        tile[101] += sc * Ux[21] * Uy[17] * Uz[4];
        tile[102] += sc * Ux[21] * Uy[16] * Uz[5];
        tile[103] += sc * Ux[22] * Uy[18] * Uz[4];
        tile[104] += sc * Ux[22] * Uy[17] * Uz[5];
        tile[105] += sc * Ux[22] * Uy[16] * Uz[6];
        tile[106] += sc * Ux[23] * Uy[19] * Uz[4];
        tile[107] += sc * Ux[23] * Uy[18] * Uz[5];
        tile[108] += sc * Ux[23] * Uy[17] * Uz[6];
        tile[109] += sc * Ux[23] * Uy[16] * Uz[7];
        tile[110] += sc * Ux[20] * Uy[12] * Uz[8];
        tile[111] += sc * Ux[21] * Uy[13] * Uz[8];
        tile[112] += sc * Ux[21] * Uy[12] * Uz[9];
        tile[113] += sc * Ux[22] * Uy[14] * Uz[8];
        tile[114] += sc * Ux[22] * Uy[13] * Uz[9];
        tile[115] += sc * Ux[22] * Uy[12] * Uz[10];
        tile[116] += sc * Ux[23] * Uy[15] * Uz[8];
        ...
        tile[127] += sc * Ux[15] * Uy[2] * Uz[13];
        tile[128] += sc * Ux[15] * Uy[1] * Uz[14];
        tile[129] += sc * Ux[15] * Uy[0] * Uz[15];
        tile[130] += sc * Ux[16] * Uy[4] * Uz[12];
        tile[131] += sc * Ux[17] * Uy[5] * Uz[12];
        tile[132] += sc * Ux[17] * Uy[4] * Uz[13];
        tile[133] += sc * Ux[18] * Uy[6] * Uz[12];
        tile[134] += sc * Ux[18] * Uy[5] * Uz[13];
        tile[135] += sc * Ux[18] * Uy[4] * Uz[14];
        tile[136] += sc * Ux[19] * Uy[7] * Uz[12];
        tile[137] += sc * Ux[19] * Uy[6] * Uz[13];
        tile[138] += sc * Ux[19] * Uy[5] * Uz[14];
        tile[139] += sc * Ux[19] * Uy[4] * Uz[15];
        tile[140] += sc * Ux[16] * Uy[0] * Uz[16];
        tile[141] += sc * Ux[17] * Uy[1] * Uz[16];
        tile[142] += sc * Ux[17] * Uy[0] * Uz[17];
        tile[143] += sc * Ux[18] * Uy[2] * Uz[16];
        tile[144] += sc * Ux[18] * Uy[1] * Uz[17];
        tile[145] += sc * Ux[18] * Uy[0] * Uz[18];
        tile[146] += sc * Ux[19] * Uy[3] * Uz[16];
        tile[147] += sc * Ux[19] * Uy[2] * Uz[17];
        tile[148] += sc * Ux[19] * Uy[1] * Uz[18];
        tile[149] += sc * Ux[19] * Uy[0] * Uz[19];
        tile[150] += sc * Ux[20] * Uy[8] * Uz[12];
        tile[151] += sc * Ux[21] * Uy[9] * Uz[12];
        tile[152] += sc * Ux[21] * Uy[8] * Uz[13];
        tile[153] += sc * Ux[22] * Uy[10] * Uz[12];
        tile[154] += sc * Ux[22] * Uy[9] * Uz[13];
        tile[155] += sc * Ux[22] * Uy[8] * Uz[14];
        tile[156] += sc * Ux[23] * Uy[11] * Uz[12];
        tile[157] += sc * Ux[23] * Uy[10] * Uz[13];
        tile[158] += sc * Ux[23] * Uy[9] * Uz[14];
        ...
        tile[210] += sc * Ux[32] * Uy[32] * Uz[0];
        tile[211] += sc * Ux[33] * Uy[33] * Uz[0];
        tile[212] += sc * Ux[33] * Uy[32] * Uz[1];
        tile[213] += sc * Ux[34] * Uy[34] * Uz[0];
        tile[214] += sc * Ux[34] * Uy[33] * Uz[1];
        tile[215] += sc * Ux[34] * Uy[32] * Uz[2];
        tile[216] += sc * Ux[35] * Uy[35] * Uz[0];
        tile[217] += sc * Ux[35] * Uy[34] * Uz[1];
        tile[218] += sc * Ux[35] * Uy[33] * Uz[2];
        tile[219] += sc * Ux[35] * Uy[32] * Uz[3];
        tile[220] += sc * Ux[32] * Uy[28] * Uz[4];
        tile[221] += sc * Ux[33] * Uy[29] * Uz[4];
        tile[222] += sc * Ux[33] * Uy[28] * Uz[5];
        tile[223] += sc * Ux[34] * Uy[30] * Uz[4];
        tile[224] += sc * Ux[34] * Uy[29] * Uz[5];
        tile[225] += sc * Ux[34] * Uy[28] * Uz[6];
        tile[226] += sc * Ux[35] * Uy[31] * Uz[4];
        tile[227] += sc * Ux[35] * Uy[30] * Uz[5];
        tile[228] += sc * Ux[35] * Uy[29] * Uz[6];
        tile[229] += sc * Ux[35] * Uy[28] * Uz[7];
        tile[230] += sc * Ux[32] * Uy[24] * Uz[8];
        tile[231] += sc * Ux[33] * Uy[25] * Uz[8];
        tile[232] += sc * Ux[33] * Uy[24] * Uz[9];
        tile[233] += sc * Ux[34] * Uy[26] * Uz[8];
        tile[234] += sc * Ux[34] * Uy[25] * Uz[9];
        tile[235] += sc * Ux[34] * Uy[24] * Uz[10];
        tile[236] += sc * Ux[35] * Uy[27] * Uz[8];
        ...
        tile[247] += sc * Ux[27] * Uy[14] * Uz[13];
        tile[248] += sc * Ux[27] * Uy[13] * Uz[14];
        tile[249] += sc * Ux[27] * Uy[12] * Uz[15];
        tile[250] += sc * Ux[28] * Uy[16] * Uz[12];
        tile[251] += sc * Ux[29] * Uy[17] * Uz[12];
        tile[252] += sc * Ux[29] * Uy[16] * Uz[13];
        tile[253] += sc * Ux[30] * Uy[18] * Uz[12];
        tile[254] += sc * Ux[30] * Uy[17] * Uz[13];
        tile[255] += sc * Ux[30] * Uy[16] * Uz[14];
        tile[256] += sc * Ux[31] * Uy[19] * Uz[12];
        tile[257] += sc * Ux[31] * Uy[18] * Uz[13];
        tile[258] += sc * Ux[31] * Uy[17] * Uz[14];
        tile[259] += sc * Ux[31] * Uy[16] * Uz[15];
        ...
        tile[270] += sc * Ux[32] * Uy[20] * Uz[12];
        tile[271] += sc * Ux[33] * Uy[21] * Uz[12];
        tile[272] += sc * Ux[33] * Uy[20] * Uz[13];
        tile[273] += sc * Ux[34] * Uy[22] * Uz[12];
        tile[274] += sc * Ux[34] * Uy[21] * Uz[13];
        tile[275] += sc * Ux[34] * Uy[20] * Uz[14];
        tile[276] += sc * Ux[35] * Uy[23] * Uz[12];
        tile[277] += sc * Ux[35] * Uy[22] * Uz[13];
        tile[278] += sc * Ux[35] * Uy[21] * Uz[14];
        tile[279] += sc * Ux[35] * Uy[20] * Uz[15];
        tile[280] += sc * Ux[32] * Uy[16] * Uz[16];
        tile[281] += sc * Ux[33] * Uy[17] * Uz[16];
        tile[282] += sc * Ux[33] * Uy[16] * Uz[17];
        tile[283] += sc * Ux[34] * Uy[18] * Uz[16];
        tile[284] += sc * Ux[34] * Uy[17] * Uz[17];
        tile[285] += sc * Ux[34] * Uy[16] * Uz[18];
        tile[286] += sc * Ux[35] * Uy[19] * Uz[16];
        tile[287] += sc * Ux[35] * Uy[18] * Uz[17];
        tile[288] += sc * Ux[35] * Uy[17] * Uz[18];
        tile[289] += sc * Ux[35] * Uy[16] * Uz[19];
        tile[290] += sc * Ux[32] * Uy[12] * Uz[20];
        tile[291] += sc * Ux[33] * Uy[13] * Uz[20];
        tile[292] += sc * Ux[33] * Uy[12] * Uz[21];
        tile[293] += sc * Ux[34] * Uy[14] * Uz[20];
        tile[294] += sc * Ux[34] * Uy[13] * Uz[21];
        tile[295] += sc * Ux[34] * Uy[12] * Uz[22];
        tile[296] += sc * Ux[35] * Uy[15] * Uz[20];
        ...
        tile[307] += sc * Ux[27] * Uy[2] * Uz[25];
        tile[308] += sc * Ux[27] * Uy[1] * Uz[26];
        tile[309] += sc * Ux[27] * Uy[0] * Uz[27];
        tile[310] += sc * Ux[28] * Uy[4] * Uz[24];
        tile[311] += sc * Ux[29] * Uy[5] * Uz[24];
        tile[312] += sc * Ux[29] * Uy[4] * Uz[25];
        tile[313] += sc * Ux[30] * Uy[6] * Uz[24];
        tile[314] += sc * Ux[30] * Uy[5] * Uz[25];
        tile[315] += sc * Ux[30] * Uy[4] * Uz[26];
        tile[316] += sc * Ux[31] * Uy[7] * Uz[24];
        tile[317] += sc * Ux[31] * Uy[6] * Uz[25];
        tile[318] += sc * Ux[31] * Uy[5] * Uz[26];
        tile[319] += sc * Ux[31] * Uy[4] * Uz[27];
        tile[320] += sc * Ux[28] * Uy[0] * Uz[28];
        tile[321] += sc * Ux[29] * Uy[1] * Uz[28];
        tile[322] += sc * Ux[29] * Uy[0] * Uz[29];
        tile[323] += sc * Ux[30] * Uy[2] * Uz[28];
        tile[324] += sc * Ux[30] * Uy[1] * Uz[29];
        tile[325] += sc * Ux[30] * Uy[0] * Uz[30];
        tile[326] += sc * Ux[31] * Uy[3] * Uz[28];
        tile[327] += sc * Ux[31] * Uy[2] * Uz[29];
        tile[328] += sc * Ux[31] * Uy[1] * Uz[30];
        tile[329] += sc * Ux[31] * Uy[0] * Uz[31];
        tile[330] += sc * Ux[32] * Uy[8] * Uz[24];
        tile[331] += sc * Ux[33] * Uy[9] * Uz[24];
        tile[332] += sc * Ux[33] * Uy[8] * Uz[25];
        tile[333] += sc * Ux[34] * Uy[10] * Uz[24];
        tile[334] += sc * Ux[34] * Uy[9] * Uz[25];
        tile[335] += sc * Ux[34] * Uy[8] * Uz[26];
        tile[336] += sc * Ux[35] * Uy[11] * Uz[24];
        tile[337] += sc * Ux[35] * Uy[10] * Uz[25];
        tile[338] += sc * Ux[35] * Uy[9] * Uz[26];
        tile[339] += sc * Ux[35] * Uy[8] * Uz[27];
        tile[340] += sc * Ux[32] * Uy[4] * Uz[28];
        tile[341] += sc * Ux[33] * Uy[5] * Uz[28];
        tile[342] += sc * Ux[33] * Uy[4] * Uz[29];
        tile[343] += sc * Ux[34] * Uy[6] * Uz[28];
        tile[344] += sc * Ux[34] * Uy[5] * Uz[29];
        tile[345] += sc * Ux[34] * Uy[4] * Uz[30];
        tile[346] += sc * Ux[35] * Uy[7] * Uz[28];
        tile[347] += sc * Ux[35] * Uy[6] * Uz[29];
        tile[348] += sc * Ux[35] * Uy[5] * Uz[30];
        tile[349] += sc * Ux[35] * Uy[4] * Uz[31];
        tile[350] += sc * Ux[32] * Uy[0] * Uz[32];
        tile[351] += sc * Ux[33] * Uy[1] * Uz[32];
        tile[352] += sc * Ux[33] * Uy[0] * Uz[33];
        tile[353] += sc * Ux[34] * Uy[2] * Uz[32];
        tile[354] += sc * Ux[34] * Uy[1] * Uz[33];
        tile[355] += sc * Ux[34] * Uy[0] * Uz[34];
        tile[356] += sc * Ux[35] * Uy[3] * Uz[32];
  ...
  for (int ip = 0; ip < nPairAB; ++ip) {
    ...
    for (int jp = 0; jp < nPairCD; ++jp) {
      ...
      for (int u = 0; u < NROOTS; ++u) {
        ...
        compute_G_stride_fixed<kFlatStride, kNMax, kMMax>(Gz, Cz_, Cpz_, B0, B1, B1p);
        const double sc = base * w;
        Ux[0] = Gx[15] * xij2 + 2.0 * (Gx[19] * xij) + Gx[23];
        Ux[1] = Gx[14] * xij2 + 2.0 * (Gx[18] * xij) + Gx[22];
        Ux[2] = Gx[13] * xij2 + 2.0 * (Gx[17] * xij) + Gx[21];
        Ux[3] = Gx[12] * xij2 + 2.0 * (Gx[16] * xij) + Gx[20];
        Ux[4] = Gx[15] * xij + Gx[19];
        Ux[5] = Gx[14] * xij + Gx[18];
        Ux[6] = Gx[13] * xij + Gx[17];
        Ux[7] = Gx[12] * xij + Gx[16];
        Ux[8] = Gx[15];
        Ux[9] = Gx[14];
        Ux[10] = Gx[13];
        Ux[11] = Gx[12];
        Ux[12] = Gx[11] * xij2 + 2.0 * (Gx[15] * xij) + Gx[19];
        Ux[13] = Gx[10] * xij2 + 2.0 * (Gx[14] * xij) + Gx[18];
        Ux[14] = Gx[9] * xij2 + 2.0 * (Gx[13] * xij) + Gx[17];
        Ux[15] = Gx[8] * xij2 + 2.0 * (Gx[12] * xij) + Gx[16];
        Ux[16] = Gx[11] * xij + Gx[15];
        Ux[17] = Gx[10] * xij + Gx[14];
        Ux[18] = Gx[9] * xij + Gx[13];
        Ux[19] = Gx[8] * xij + Gx[12];
        Ux[20] = Gx[11];
        Ux[21] = Gx[10];
        Ux[22] = Gx[9];
        Ux[23] = Gx[8];
        Ux[24] = Gx[7] * xij2 + 2.0 * (Gx[11] * xij) + Gx[15];
        Ux[25] = Gx[6] * xij2 + 2.0 * (Gx[10] * xij) + Gx[14];
        Ux[26] = Gx[5] * xij2 + 2.0 * (Gx[9] * xij) + Gx[13];
        Ux[27] = Gx[4] * xij2 + 2.0 * (Gx[8] * xij) + Gx[12];
        Ux[28] = Gx[7] * xij + Gx[11];
        Ux[29] = Gx[6] * xij + Gx[10];
        Ux[30] = Gx[5] * xij + Gx[9];
        Ux[31] = Gx[4] * xij + Gx[8];
        Ux[32] = Gx[7];
        Ux[33] = Gx[6];
        Ux[34] = Gx[5];
        Ux[35] = Gx[4];
        Ux[36] = Gx[3] * xij2 + 2.0 * (Gx[7] * xij) + Gx[11];
        Ux[37] = Gx[2] * xij2 + 2.0 * (Gx[6] * xij) + Gx[10];
        Ux[38] = Gx[1] * xij2 + 2.0 * (Gx[5] * xij) + Gx[9];
        Ux[39] = Gx[0] * xij2 + 2.0 * (Gx[4] * xij) + Gx[8];
        Ux[40] = Gx[3] * xij + Gx[7];
        Ux[41] = Gx[2] * xij + Gx[6];
        Ux[42] = Gx[1] * xij + Gx[5];
        Ux[43] = Gx[0] * xij + Gx[4];
        ...
        Uy[38] = Gy[14];
        Uy[39] = Gy[15];
        Uy[40] = Gy[12] * yij + Gy[16];
        Uy[41] = Gy[13] * yij + Gy[17];
        Uy[42] = Gy[14] * yij + Gy[18];
        Uy[43] = Gy[15] * yij + Gy[19];
        Uy[44] = Gy[12] * yij2 + 2.0 * (Gy[16] * yij) + Gy[20];
        Uy[45] = Gy[13] * yij2 + 2.0 * (Gy[17] * yij) + Gy[21];
        Uy[46] = Gy[14] * yij2 + 2.0 * (Gy[18] * yij) + Gy[22];
        Uy[47] = Gy[15] * yij2 + 2.0 * (Gy[19] * yij) + Gy[23];
        Uz[0] = Gz[0];
        Uz[1] = Gz[1];
        Uz[2] = Gz[2];
        Uz[3] = Gz[3];
        ...
        Uz[38] = Gz[14];
        Uz[39] = Gz[15];
        Uz[40] = Gz[12] * zij + Gz[16];
        Uz[41] = Gz[13] * zij + Gz[17];
        Uz[42] = Gz[14] * zij + Gz[18];
        Uz[43] = Gz[15] * zij + Gz[19];
        Uz[44] = Gz[12] * zij2 + 2.0 * (Gz[16] * zij) + Gz[20];
        Uz[45] = Gz[13] * zij2 + 2.0 * (Gz[17] * zij) + Gz[21];
        Uz[46] = Gz[14] * zij2 + 2.0 * (Gz[18] * zij) + Gz[22];
        Uz[47] = Gz[15] * zij2 + 2.0 * (Gz[19] * zij) + Gz[23];
        tile[0] += sc * Ux[0] * Uy[0] * Uz[0];
        tile[1] += sc * Ux[1] * Uy[1] * Uz[0];
        tile[2] += sc * Ux[1] * Uy[0] * Uz[1];
        tile[3] += sc * Ux[2] * Uy[2] * Uz[0];
        ...
        tile[367] += sc * Ux[39] * Uy[38] * Uz[1];
        tile[368] += sc * Ux[39] * Uy[37] * Uz[2];
        tile[369] += sc * Ux[39] * Uy[36] * Uz[3];
        tile[370] += sc * Ux[40] * Uy[40] * Uz[0];
        tile[371] += sc * Ux[41] * Uy[41] * Uz[0];
        tile[372] += sc * Ux[41] * Uy[40] * Uz[1];
        tile[373] += sc * Ux[42] * Uy[42] * Uz[0];
        tile[374] += sc * Ux[42] * Uy[41] * Uz[1];
        tile[375] += sc * Ux[42] * Uy[40] * Uz[2];
        tile[376] += sc * Ux[43] * Uy[43] * Uz[0];
        tile[377] += sc * Ux[43] * Uy[42] * Uz[1];
        tile[378] += sc * Ux[43] * Uy[41] * Uz[2];
        tile[379] += sc * Ux[43] * Uy[40] * Uz[3];
        tile[380] += sc * Ux[40] * Uy[36] * Uz[4];
        tile[381] += sc * Ux[41] * Uy[37] * Uz[4];
        tile[382] += sc * Ux[41] * Uy[36] * Uz[5];
        tile[383] += sc * Ux[42] * Uy[38] * Uz[4];
        tile[384] += sc * Ux[42] * Uy[37] * Uz[5];
        tile[385] += sc * Ux[42] * Uy[36] * Uz[6];
        tile[386] += sc * Ux[43] * Uy[39] * Uz[4];
        tile[387] += sc * Ux[43] * Uy[38] * Uz[5];
        tile[388] += sc * Ux[43] * Uy[37] * Uz[6];
        tile[389] += sc * Ux[43] * Uy[36] * Uz[7];
        tile[390] += sc * Ux[44] * Uy[44] * Uz[0];
        tile[391] += sc * Ux[45] * Uy[45] * Uz[0];
        tile[392] += sc * Ux[45] * Uy[44] * Uz[1];
        tile[393] += sc * Ux[46] * Uy[46] * Uz[0];
        tile[394] += sc * Ux[46] * Uy[45] * Uz[1];
        tile[395] += sc * Ux[46] * Uy[44] * Uz[2];
        tile[396] += sc * Ux[47] * Uy[47] * Uz[0];
        tile[397] += sc * Ux[47] * Uy[46] * Uz[1];
        tile[398] += sc * Ux[47] * Uy[45] * Uz[2];
        tile[399] += sc * Ux[47] * Uy[44] * Uz[3];
        tile[400] += sc * Ux[44] * Uy[40] * Uz[4];
        tile[401] += sc * Ux[45] * Uy[41] * Uz[4];
        tile[402] += sc * Ux[45] * Uy[40] * Uz[5];
        tile[403] += sc * Ux[46] * Uy[42] * Uz[4];
        tile[404] += sc * Ux[46] * Uy[41] * Uz[5];
        tile[405] += sc * Ux[46] * Uy[40] * Uz[6];
        tile[406] += sc * Ux[47] * Uy[43] * Uz[4];
        tile[407] += sc * Ux[47] * Uy[42] * Uz[5];
        tile[408] += sc * Ux[47] * Uy[41] * Uz[6];
        tile[409] += sc * Ux[47] * Uy[40] * Uz[7];
        tile[410] += sc * Ux[44] * Uy[36] * Uz[8];
        tile[411] += sc * Ux[45] * Uy[37] * Uz[8];
        tile[412] += sc * Ux[45] * Uy[36] * Uz[9];
        tile[413] += sc * Ux[46] * Uy[38] * Uz[8];
        tile[414] += sc * Ux[46] * Uy[37] * Uz[9];
        tile[415] += sc * Ux[46] * Uy[36] * Uz[10];
        tile[416] += sc * Ux[47] * Uy[39] * Uz[8];
        ...
        tile[427] += sc * Ux[39] * Uy[26] * Uz[13];
        tile[428] += sc * Ux[39] * Uy[25] * Uz[14];
        tile[429] += sc * Ux[39] * Uy[24] * Uz[15];
        tile[430] += sc * Ux[40] * Uy[28] * Uz[12];
        tile[431] += sc * Ux[41] * Uy[29] * Uz[12];
        tile[432] += sc * Ux[41] * Uy[28] * Uz[13];
        tile[433] += sc * Ux[42] * Uy[30] * Uz[12];
        tile[434] += sc * Ux[42] * Uy[29] * Uz[13];
        tile[435] += sc * Ux[42] * Uy[28] * Uz[14];
        tile[436] += sc * Ux[43] * Uy[31] * Uz[12];
        tile[437] += sc * Ux[43] * Uy[30] * Uz[13];
        tile[438] += sc * Ux[43] * Uy[29] * Uz[14];
        tile[439] += sc * Ux[43] * Uy[28] * Uz[15];
        tile[440] += sc * Ux[40] * Uy[24] * Uz[16];
        tile[441] += sc * Ux[41] * Uy[25] * Uz[16];
        tile[442] += sc * Ux[41] * Uy[24] * Uz[17];
        tile[443] += sc * Ux[42] * Uy[26] * Uz[16];
        tile[444] += sc * Ux[42] * Uy[25] * Uz[17];
        tile[445] += sc * Ux[42] * Uy[24] * Uz[18];
        tile[446] += sc * Ux[43] * Uy[27] * Uz[16];
        tile[447] += sc * Ux[43] * Uy[26] * Uz[17];
        tile[448] += sc * Ux[43] * Uy[25] * Uz[18];
        tile[449] += sc * Ux[43] * Uy[24] * Uz[19];
        tile[450] += sc * Ux[44] * Uy[32] * Uz[12];
        tile[451] += sc * Ux[45] * Uy[33] * Uz[12];
        tile[452] += sc * Ux[45] * Uy[32] * Uz[13];
        tile[453] += sc * Ux[46] * Uy[34] * Uz[12];
        tile[454] += sc * Ux[46] * Uy[33] * Uz[13];
        tile[455] += sc * Ux[46] * Uy[32] * Uz[14];
        tile[456] += sc * Ux[47] * Uy[35] * Uz[12];
        tile[457] += sc * Ux[47] * Uy[34] * Uz[13];
        tile[458] += sc * Ux[47] * Uy[33] * Uz[14];
        tile[459] += sc * Ux[47] * Uy[32] * Uz[15];
        ...
        tile[487] += sc * Ux[39] * Uy[14] * Uz[25];
        tile[488] += sc * Ux[39] * Uy[13] * Uz[26];
        tile[489] += sc * Ux[39] * Uy[12] * Uz[27];
        tile[490] += sc * Ux[40] * Uy[16] * Uz[24];
        tile[491] += sc * Ux[41] * Uy[17] * Uz[24];
        tile[492] += sc * Ux[41] * Uy[16] * Uz[25];
        tile[493] += sc * Ux[42] * Uy[18] * Uz[24];
        tile[494] += sc * Ux[42] * Uy[17] * Uz[25];
        tile[495] += sc * Ux[42] * Uy[16] * Uz[26];
        tile[496] += sc * Ux[43] * Uy[19] * Uz[24];
        tile[497] += sc * Ux[43] * Uy[18] * Uz[25];
        tile[498] += sc * Ux[43] * Uy[17] * Uz[26];
        tile[499] += sc * Ux[43] * Uy[16] * Uz[27];
        tile[500] += sc * Ux[40] * Uy[12] * Uz[28];
        tile[501] += sc * Ux[41] * Uy[13] * Uz[28];
        tile[502] += sc * Ux[41] * Uy[12] * Uz[29];
        tile[503] += sc * Ux[42] * Uy[14] * Uz[28];
        tile[504] += sc * Ux[42] * Uy[13] * Uz[29];
        tile[505] += sc * Ux[42] * Uy[12] * Uz[30];
        tile[506] += sc * Ux[43] * Uy[15] * Uz[28];
        tile[507] += sc * Ux[43] * Uy[14] * Uz[29];
        tile[508] += sc * Ux[43] * Uy[13] * Uz[30];
        tile[509] += sc * Ux[43] * Uy[12] * Uz[31];
        tile[510] += sc * Ux[44] * Uy[20] * Uz[24];
        tile[511] += sc * Ux[45] * Uy[21] * Uz[24];
        tile[512] += sc * Ux[45] * Uy[20] * Uz[25];
        tile[513] += sc * Ux[46] * Uy[22] * Uz[24];
        tile[514] += sc * Ux[46] * Uy[21] * Uz[25];
        tile[515] += sc * Ux[46] * Uy[20] * Uz[26];
        tile[516] += sc * Ux[47] * Uy[23] * Uz[24];
        tile[517] += sc * Ux[47] * Uy[22] * Uz[25];
        tile[518] += sc * Ux[47] * Uy[21] * Uz[26];
        tile[519] += sc * Ux[47] * Uy[20] * Uz[27];
        tile[520] += sc * Ux[44] * Uy[16] * Uz[28];
        tile[521] += sc * Ux[45] * Uy[17] * Uz[28];
        tile[522] += sc * Ux[45] * Uy[16] * Uz[29];
        tile[523] += sc * Ux[46] * Uy[18] * Uz[28];
        tile[524] += sc * Ux[46] * Uy[17] * Uz[29];
        tile[525] += sc * Ux[46] * Uy[16] * Uz[30];
        tile[526] += sc * Ux[47] * Uy[19] * Uz[28];
        tile[527] += sc * Ux[47] * Uy[18] * Uz[29];
        tile[528] += sc * Ux[47] * Uy[17] * Uz[30];
        tile[529] += sc * Ux[47] * Uy[16] * Uz[31];
        tile[530] += sc * Ux[44] * Uy[12] * Uz[32];
        tile[531] += sc * Ux[45] * Uy[13] * Uz[32];
        tile[532] += sc * Ux[45] * Uy[12] * Uz[33];
        tile[533] += sc * Ux[46] * Uy[14] * Uz[32];
        tile[534] += sc * Ux[46] * Uy[13] * Uz[33];
        tile[535] += sc * Ux[46] * Uy[12] * Uz[34];
        tile[536] += sc * Ux[47] * Uy[15] * Uz[32];
        ...
        tile[547] += sc * Ux[39] * Uy[2] * Uz[37];
        tile[548] += sc * Ux[39] * Uy[1] * Uz[38];
        tile[549] += sc * Ux[39] * Uy[0] * Uz[39];
        tile[550] += sc * Ux[40] * Uy[4] * Uz[36];
        tile[551] += sc * Ux[41] * Uy[5] * Uz[36];
        tile[552] += sc * Ux[41] * Uy[4] * Uz[37];
        tile[553] += sc * Ux[42] * Uy[6] * Uz[36];
        tile[554] += sc * Ux[42] * Uy[5] * Uz[37];
        tile[555] += sc * Ux[42] * Uy[4] * Uz[38];
        tile[556] += sc * Ux[43] * Uy[7] * Uz[36];
        tile[557] += sc * Ux[43] * Uy[6] * Uz[37];
        tile[558] += sc * Ux[43] * Uy[5] * Uz[38];
        tile[559] += sc * Ux[43] * Uy[4] * Uz[39];
        tile[560] += sc * Ux[40] * Uy[0] * Uz[40];
        tile[561] += sc * Ux[41] * Uy[1] * Uz[40];
        tile[562] += sc * Ux[41] * Uy[0] * Uz[41];
        tile[563] += sc * Ux[42] * Uy[2] * Uz[40];
        tile[564] += sc * Ux[42] * Uy[1] * Uz[41];
        tile[565] += sc * Ux[42] * Uy[0] * Uz[42];
        tile[566] += sc * Ux[43] * Uy[3] * Uz[40];
        tile[567] += sc * Ux[43] * Uy[2] * Uz[41];
        tile[568] += sc * Ux[43] * Uy[1] * Uz[42];
        tile[569] += sc * Ux[43] * Uy[0] * Uz[43];
