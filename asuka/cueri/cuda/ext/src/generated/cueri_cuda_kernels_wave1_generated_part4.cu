// Auto-split from cueri_cuda_kernels_wave1_generated.cu (part 4/12: ffds..ssfs)
  ...
  for (int ip = 0; ip < nPairAB; ++ip) {
    ...
    for (int jp = 0; jp < nPairCD; ++jp) {
      ...
      for (int u = 0; u < NROOTS; ++u) {
        ...
        Ux[0] = Gx[11] * pow(xij, 3) + 3.0 * (Gx[14] * xij2) + 3.0 * (Gx[17] * xij) + Gx[20];
        Ux[1] = Gx[10] * pow(xij, 3) + 3.0 * (Gx[13] * xij2) + 3.0 * (Gx[16] * xij) + Gx[19];
        Ux[2] = Gx[9] * pow(xij, 3) + 3.0 * (Gx[12] * xij2) + 3.0 * (Gx[15] * xij) + Gx[18];
        Ux[3] = Gx[11] * xij2 + 2.0 * (Gx[14] * xij) + Gx[17];
        Ux[4] = Gx[10] * xij2 + 2.0 * (Gx[13] * xij) + Gx[16];
        Ux[5] = Gx[9] * xij2 + 2.0 * (Gx[12] * xij) + Gx[15];
        Ux[6] = Gx[11] * xij + Gx[14];
        Ux[7] = Gx[10] * xij + Gx[13];
        Ux[8] = Gx[9] * xij + Gx[12];
        Ux[9] = Gx[11];
        Ux[10] = Gx[10];
        Ux[11] = Gx[9];
        Ux[12] = Gx[8] * pow(xij, 3) + 3.0 * (Gx[11] * xij2) + 3.0 * (Gx[14] * xij) + Gx[17];
        Ux[13] = Gx[7] * pow(xij, 3) + 3.0 * (Gx[10] * xij2) + 3.0 * (Gx[13] * xij) + Gx[16];
        Ux[14] = Gx[6] * pow(xij, 3) + 3.0 * (Gx[9] * xij2) + 3.0 * (Gx[12] * xij) + Gx[15];
        Ux[15] = Gx[8] * xij2 + 2.0 * (Gx[11] * xij) + Gx[14];
        Ux[16] = Gx[7] * xij2 + 2.0 * (Gx[10] * xij) + Gx[13];
        Ux[17] = Gx[6] * xij2 + 2.0 * (Gx[9] * xij) + Gx[12];
        Ux[18] = Gx[8] * xij + Gx[11];
        Ux[19] = Gx[7] * xij + Gx[10];
        Ux[20] = Gx[6] * xij + Gx[9];
        Ux[21] = Gx[8];
        Ux[22] = Gx[7];
        Ux[23] = Gx[6];
        Ux[24] = Gx[5] * pow(xij, 3) + 3.0 * (Gx[8] * xij2) + 3.0 * (Gx[11] * xij) + Gx[14];
        Ux[25] = Gx[4] * pow(xij, 3) + 3.0 * (Gx[7] * xij2) + 3.0 * (Gx[10] * xij) + Gx[13];
        Ux[26] = Gx[3] * pow(xij, 3) + 3.0 * (Gx[6] * xij2) + 3.0 * (Gx[9] * xij) + Gx[12];
        Ux[27] = Gx[5] * xij2 + 2.0 * (Gx[8] * xij) + Gx[11];
        Ux[28] = Gx[4] * xij2 + 2.0 * (Gx[7] * xij) + Gx[10];
        Ux[29] = Gx[3] * xij2 + 2.0 * (Gx[6] * xij) + Gx[9];
        Ux[30] = Gx[5] * xij + Gx[8];
        Ux[31] = Gx[4] * xij + Gx[7];
        Ux[32] = Gx[3] * xij + Gx[6];
        Ux[33] = Gx[5];
        Ux[34] = Gx[4];
        Ux[35] = Gx[3];
        Ux[36] = Gx[2] * pow(xij, 3) + 3.0 * (Gx[5] * xij2) + 3.0 * (Gx[8] * xij) + Gx[11];
        Ux[37] = Gx[1] * pow(xij, 3) + 3.0 * (Gx[4] * xij2) + 3.0 * (Gx[7] * xij) + Gx[10];
        Ux[38] = Gx[0] * pow(xij, 3) + 3.0 * (Gx[3] * xij2) + 3.0 * (Gx[6] * xij) + Gx[9];
        Ux[39] = Gx[2] * xij2 + 2.0 * (Gx[5] * xij) + Gx[8];
        Ux[40] = Gx[1] * xij2 + 2.0 * (Gx[4] * xij) + Gx[7];
        Ux[41] = Gx[0] * xij2 + 2.0 * (Gx[3] * xij) + Gx[6];
        Ux[42] = Gx[2] * xij + Gx[5];
        Ux[43] = Gx[1] * xij + Gx[4];
        Ux[44] = Gx[0] * xij + Gx[3];
        Ux[45] = Gx[2];
        ...
        Uy[9] = Gy[0] * pow(yij, 3) + 3.0 * (Gy[3] * yij2) + 3.0 * (Gy[6] * yij) + Gy[9];
        Uy[10] = Gy[1] * pow(yij, 3) + 3.0 * (Gy[4] * yij2) + 3.0 * (Gy[7] * yij) + Gy[10];
        Uy[11] = Gy[2] * pow(yij, 3) + 3.0 * (Gy[5] * yij2) + 3.0 * (Gy[8] * yij) + Gy[11];
        Uy[12] = Gy[3];
        Uy[13] = Gy[4];
        Uy[14] = Gy[5];
        Uy[15] = Gy[3] * yij + Gy[6];
        Uy[16] = Gy[4] * yij + Gy[7];
        Uy[17] = Gy[5] * yij + Gy[8];
        Uy[18] = Gy[3] * yij2 + 2.0 * (Gy[6] * yij) + Gy[9];
        Uy[19] = Gy[4] * yij2 + 2.0 * (Gy[7] * yij) + Gy[10];
        Uy[20] = Gy[5] * yij2 + 2.0 * (Gy[8] * yij) + Gy[11];
        Uy[21] = Gy[3] * pow(yij, 3) + 3.0 * (Gy[6] * yij2) + 3.0 * (Gy[9] * yij) + Gy[12];
        Uy[22] = Gy[4] * pow(yij, 3) + 3.0 * (Gy[7] * yij2) + 3.0 * (Gy[10] * yij) + Gy[13];
        Uy[23] = Gy[5] * pow(yij, 3) + 3.0 * (Gy[8] * yij2) + 3.0 * (Gy[11] * yij) + Gy[14];
        Uy[24] = Gy[6];
        Uy[25] = Gy[7];
        Uy[26] = Gy[8];
        Uy[27] = Gy[6] * yij + Gy[9];
        Uy[28] = Gy[7] * yij + Gy[10];
        Uy[29] = Gy[8] * yij + Gy[11];
        Uy[30] = Gy[6] * yij2 + 2.0 * (Gy[9] * yij) + Gy[12];
        Uy[31] = Gy[7] * yij2 + 2.0 * (Gy[10] * yij) + Gy[13];
        Uy[32] = Gy[8] * yij2 + 2.0 * (Gy[11] * yij) + Gy[14];
        Uy[33] = Gy[6] * pow(yij, 3) + 3.0 * (Gy[9] * yij2) + 3.0 * (Gy[12] * yij) + Gy[15];
        Uy[34] = Gy[7] * pow(yij, 3) + 3.0 * (Gy[10] * yij2) + 3.0 * (Gy[13] * yij) + Gy[16];
        Uy[35] = Gy[8] * pow(yij, 3) + 3.0 * (Gy[11] * yij2) + 3.0 * (Gy[14] * yij) + Gy[17];
        Uy[36] = Gy[9];
        Uy[37] = Gy[10];
        Uy[38] = Gy[11];
        Uy[39] = Gy[9] * yij + Gy[12];
        Uy[40] = Gy[10] * yij + Gy[13];
        Uy[41] = Gy[11] * yij + Gy[14];
        Uy[42] = Gy[9] * yij2 + 2.0 * (Gy[12] * yij) + Gy[15];
        Uy[43] = Gy[10] * yij2 + 2.0 * (Gy[13] * yij) + Gy[16];
        Uy[44] = Gy[11] * yij2 + 2.0 * (Gy[14] * yij) + Gy[17];
        Uy[45] = Gy[9] * pow(yij, 3) + 3.0 * (Gy[12] * yij2) + 3.0 * (Gy[15] * yij) + Gy[18];
        Uy[46] = Gy[10] * pow(yij, 3) + 3.0 * (Gy[13] * yij2) + 3.0 * (Gy[16] * yij) + Gy[19];
        Uy[47] = Gy[11] * pow(yij, 3) + 3.0 * (Gy[14] * yij2) + 3.0 * (Gy[17] * yij) + Gy[20];
        Uz[0] = Gz[0];
        Uz[1] = Gz[1];
        Uz[2] = Gz[2];
        Uz[3] = Gz[0] * zij + Gz[3];
        ...
        Uz[9] = Gz[0] * pow(zij, 3) + 3.0 * (Gz[3] * zij2) + 3.0 * (Gz[6] * zij) + Gz[9];
        Uz[10] = Gz[1] * pow(zij, 3) + 3.0 * (Gz[4] * zij2) + 3.0 * (Gz[7] * zij) + Gz[10];
        Uz[11] = Gz[2] * pow(zij, 3) + 3.0 * (Gz[5] * zij2) + 3.0 * (Gz[8] * zij) + Gz[11];
        Uz[12] = Gz[3];
        Uz[13] = Gz[4];
        Uz[14] = Gz[5];
        Uz[15] = Gz[3] * zij + Gz[6];
        Uz[16] = Gz[4] * zij + Gz[7];
        Uz[17] = Gz[5] * zij + Gz[8];
        Uz[18] = Gz[3] * zij2 + 2.0 * (Gz[6] * zij) + Gz[9];
        Uz[19] = Gz[4] * zij2 + 2.0 * (Gz[7] * zij) + Gz[10];
        Uz[20] = Gz[5] * zij2 + 2.0 * (Gz[8] * zij) + Gz[11];
        Uz[21] = Gz[3] * pow(zij, 3) + 3.0 * (Gz[6] * zij2) + 3.0 * (Gz[9] * zij) + Gz[12];
        Uz[22] = Gz[4] * pow(zij, 3) + 3.0 * (Gz[7] * zij2) + 3.0 * (Gz[10] * zij) + Gz[13];
        Uz[23] = Gz[5] * pow(zij, 3) + 3.0 * (Gz[8] * zij2) + 3.0 * (Gz[11] * zij) + Gz[14];
        Uz[24] = Gz[6];
        Uz[25] = Gz[7];
        Uz[26] = Gz[8];
        Uz[27] = Gz[6] * zij + Gz[9];
        Uz[28] = Gz[7] * zij + Gz[10];
        Uz[29] = Gz[8] * zij + Gz[11];
        Uz[30] = Gz[6] * zij2 + 2.0 * (Gz[9] * zij) + Gz[12];
        Uz[31] = Gz[7] * zij2 + 2.0 * (Gz[10] * zij) + Gz[13];
        Uz[32] = Gz[8] * zij2 + 2.0 * (Gz[11] * zij) + Gz[14];
        Uz[33] = Gz[6] * pow(zij, 3) + 3.0 * (Gz[9] * zij2) + 3.0 * (Gz[12] * zij) + Gz[15];
        Uz[34] = Gz[7] * pow(zij, 3) + 3.0 * (Gz[10] * zij2) + 3.0 * (Gz[13] * zij) + Gz[16];
        Uz[35] = Gz[8] * pow(zij, 3) + 3.0 * (Gz[11] * zij2) + 3.0 * (Gz[14] * zij) + Gz[17];
        Uz[36] = Gz[9];
        Uz[37] = Gz[10];
        Uz[38] = Gz[11];
        Uz[39] = Gz[9] * zij + Gz[12];
        Uz[40] = Gz[10] * zij + Gz[13];
        Uz[41] = Gz[11] * zij + Gz[14];
        Uz[42] = Gz[9] * zij2 + 2.0 * (Gz[12] * zij) + Gz[15];
        Uz[43] = Gz[10] * zij2 + 2.0 * (Gz[13] * zij) + Gz[16];
        Uz[44] = Gz[11] * zij2 + 2.0 * (Gz[14] * zij) + Gz[17];
        Uz[45] = Gz[9] * pow(zij, 3) + 3.0 * (Gz[12] * zij2) + 3.0 * (Gz[15] * zij) + Gz[18];
        Uz[46] = Gz[10] * pow(zij, 3) + 3.0 * (Gz[13] * zij2) + 3.0 * (Gz[16] * zij) + Gz[19];
        Uz[47] = Gz[11] * pow(zij, 3) + 3.0 * (Gz[14] * zij2) + 3.0 * (Gz[17] * zij) + Gz[20];
        ...
        tile[67] += sc * Ux[16] * Uy[16] * Uz[0];
        tile[68] += sc * Ux[16] * Uy[15] * Uz[1];
        tile[69] += sc * Ux[17] * Uy[17] * Uz[0];
        tile[70] += sc * Ux[17] * Uy[16] * Uz[1];
        tile[71] += sc * Ux[17] * Uy[15] * Uz[2];
        tile[72] += sc * Ux[15] * Uy[12] * Uz[3];
        tile[73] += sc * Ux[16] * Uy[13] * Uz[3];
        tile[74] += sc * Ux[16] * Uy[12] * Uz[4];
        tile[75] += sc * Ux[17] * Uy[14] * Uz[3];
        tile[76] += sc * Ux[17] * Uy[13] * Uz[4];
        tile[77] += sc * Ux[17] * Uy[12] * Uz[5];
        tile[78] += sc * Ux[18] * Uy[18] * Uz[0];
        tile[79] += sc * Ux[19] * Uy[19] * Uz[0];
        tile[80] += sc * Ux[19] * Uy[18] * Uz[1];
        tile[81] += sc * Ux[20] * Uy[20] * Uz[0];
        tile[82] += sc * Ux[20] * Uy[19] * Uz[1];
        tile[83] += sc * Ux[20] * Uy[18] * Uz[2];
        tile[84] += sc * Ux[18] * Uy[15] * Uz[3];
        tile[85] += sc * Ux[19] * Uy[16] * Uz[3];
        tile[86] += sc * Ux[19] * Uy[15] * Uz[4];
        tile[87] += sc * Ux[20] * Uy[17] * Uz[3];
        tile[88] += sc * Ux[20] * Uy[16] * Uz[4];
        tile[89] += sc * Ux[20] * Uy[15] * Uz[5];
        tile[90] += sc * Ux[18] * Uy[12] * Uz[6];
        tile[91] += sc * Ux[19] * Uy[13] * Uz[6];
        tile[92] += sc * Ux[19] * Uy[12] * Uz[7];
        tile[93] += sc * Ux[20] * Uy[14] * Uz[6];
        tile[94] += sc * Ux[20] * Uy[13] * Uz[7];
        tile[95] += sc * Ux[20] * Uy[12] * Uz[8];
        tile[96] += sc * Ux[21] * Uy[21] * Uz[0];
        tile[97] += sc * Ux[22] * Uy[22] * Uz[0];
        tile[98] += sc * Ux[22] * Uy[21] * Uz[1];
        tile[99] += sc * Ux[23] * Uy[23] * Uz[0];
        tile[100] += sc * Ux[23] * Uy[22] * Uz[1];
        tile[101] += sc * Ux[23] * Uy[21] * Uz[2];
        tile[102] += sc * Ux[21] * Uy[18] * Uz[3];
        tile[103] += sc * Ux[22] * Uy[19] * Uz[3];
        tile[104] += sc * Ux[22] * Uy[18] * Uz[4];
        tile[105] += sc * Ux[23] * Uy[20] * Uz[3];
        tile[106] += sc * Ux[23] * Uy[19] * Uz[4];
        tile[107] += sc * Ux[23] * Uy[18] * Uz[5];
        tile[108] += sc * Ux[21] * Uy[15] * Uz[6];
        tile[109] += sc * Ux[22] * Uy[16] * Uz[6];
        tile[110] += sc * Ux[22] * Uy[15] * Uz[7];
        tile[111] += sc * Ux[23] * Uy[17] * Uz[6];
        tile[112] += sc * Ux[23] * Uy[16] * Uz[7];
        tile[113] += sc * Ux[23] * Uy[15] * Uz[8];
        tile[114] += sc * Ux[21] * Uy[12] * Uz[9];
        tile[115] += sc * Ux[22] * Uy[13] * Uz[9];
        tile[116] += sc * Ux[22] * Uy[12] * Uz[10];
        tile[117] += sc * Ux[23] * Uy[14] * Uz[9];
        tile[118] += sc * Ux[23] * Uy[13] * Uz[10];
        tile[119] += sc * Ux[23] * Uy[12] * Uz[11];
        tile[120] += sc * Ux[12] * Uy[0] * Uz[12];
        tile[121] += sc * Ux[13] * Uy[1] * Uz[12];
        tile[122] += sc * Ux[13] * Uy[0] * Uz[13];
        tile[123] += sc * Ux[14] * Uy[2] * Uz[12];
        tile[124] += sc * Ux[14] * Uy[1] * Uz[13];
        tile[125] += sc * Ux[14] * Uy[0] * Uz[14];
        tile[126] += sc * Ux[15] * Uy[3] * Uz[12];
        tile[127] += sc * Ux[16] * Uy[4] * Uz[12];
        tile[128] += sc * Ux[16] * Uy[3] * Uz[13];
        tile[129] += sc * Ux[17] * Uy[5] * Uz[12];
        tile[130] += sc * Ux[17] * Uy[4] * Uz[13];
        tile[131] += sc * Ux[17] * Uy[3] * Uz[14];
        tile[132] += sc * Ux[15] * Uy[0] * Uz[15];
        tile[133] += sc * Ux[16] * Uy[1] * Uz[15];
        tile[134] += sc * Ux[16] * Uy[0] * Uz[16];
        tile[135] += sc * Ux[17] * Uy[2] * Uz[15];
        tile[136] += sc * Ux[17] * Uy[1] * Uz[16];
        tile[137] += sc * Ux[17] * Uy[0] * Uz[17];
        tile[138] += sc * Ux[18] * Uy[6] * Uz[12];
        tile[139] += sc * Ux[19] * Uy[7] * Uz[12];
        tile[140] += sc * Ux[19] * Uy[6] * Uz[13];
        tile[141] += sc * Ux[20] * Uy[8] * Uz[12];
        tile[142] += sc * Ux[20] * Uy[7] * Uz[13];
        tile[143] += sc * Ux[20] * Uy[6] * Uz[14];
        tile[144] += sc * Ux[18] * Uy[3] * Uz[15];
        tile[145] += sc * Ux[19] * Uy[4] * Uz[15];
        tile[146] += sc * Ux[19] * Uy[3] * Uz[16];
        tile[147] += sc * Ux[20] * Uy[5] * Uz[15];
        tile[148] += sc * Ux[20] * Uy[4] * Uz[16];
        tile[149] += sc * Ux[20] * Uy[3] * Uz[17];
        tile[150] += sc * Ux[18] * Uy[0] * Uz[18];
        tile[151] += sc * Ux[19] * Uy[1] * Uz[18];
        tile[152] += sc * Ux[19] * Uy[0] * Uz[19];
        tile[153] += sc * Ux[20] * Uy[2] * Uz[18];
        tile[154] += sc * Ux[20] * Uy[1] * Uz[19];
        tile[155] += sc * Ux[20] * Uy[0] * Uz[20];
        ...
        tile[162] += sc * Ux[21] * Uy[6] * Uz[15];
        tile[163] += sc * Ux[22] * Uy[7] * Uz[15];
        tile[164] += sc * Ux[22] * Uy[6] * Uz[16];
        tile[165] += sc * Ux[23] * Uy[8] * Uz[15];
        tile[166] += sc * Ux[23] * Uy[7] * Uz[16];
        tile[167] += sc * Ux[23] * Uy[6] * Uz[17];
        ...
        tile[184] += sc * Ux[26] * Uy[25] * Uz[1];
        tile[185] += sc * Ux[26] * Uy[24] * Uz[2];
        tile[186] += sc * Ux[27] * Uy[27] * Uz[0];
        tile[187] += sc * Ux[28] * Uy[28] * Uz[0];
        tile[188] += sc * Ux[28] * Uy[27] * Uz[1];
        tile[189] += sc * Ux[29] * Uy[29] * Uz[0];
        tile[190] += sc * Ux[29] * Uy[28] * Uz[1];
        tile[191] += sc * Ux[29] * Uy[27] * Uz[2];
        tile[192] += sc * Ux[27] * Uy[24] * Uz[3];
        tile[193] += sc * Ux[28] * Uy[25] * Uz[3];
        tile[194] += sc * Ux[28] * Uy[24] * Uz[4];
        tile[195] += sc * Ux[29] * Uy[26] * Uz[3];
        ...
        tile[201] += sc * Ux[32] * Uy[32] * Uz[0];
        tile[202] += sc * Ux[32] * Uy[31] * Uz[1];
        tile[203] += sc * Ux[32] * Uy[30] * Uz[2];
        tile[204] += sc * Ux[30] * Uy[27] * Uz[3];
        tile[205] += sc * Ux[31] * Uy[28] * Uz[3];
        tile[206] += sc * Ux[31] * Uy[27] * Uz[4];
        tile[207] += sc * Ux[32] * Uy[29] * Uz[3];
        tile[208] += sc * Ux[32] * Uy[28] * Uz[4];
        tile[209] += sc * Ux[32] * Uy[27] * Uz[5];
        tile[210] += sc * Ux[30] * Uy[24] * Uz[6];
        tile[211] += sc * Ux[31] * Uy[25] * Uz[6];
        tile[212] += sc * Ux[31] * Uy[24] * Uz[7];
        tile[213] += sc * Ux[32] * Uy[26] * Uz[6];
        tile[214] += sc * Ux[32] * Uy[25] * Uz[7];
        tile[215] += sc * Ux[32] * Uy[24] * Uz[8];
        tile[216] += sc * Ux[33] * Uy[33] * Uz[0];
        tile[217] += sc * Ux[34] * Uy[34] * Uz[0];
        tile[218] += sc * Ux[34] * Uy[33] * Uz[1];
        tile[219] += sc * Ux[35] * Uy[35] * Uz[0];
        tile[220] += sc * Ux[35] * Uy[34] * Uz[1];
        tile[221] += sc * Ux[35] * Uy[33] * Uz[2];
        tile[222] += sc * Ux[33] * Uy[30] * Uz[3];
        tile[223] += sc * Ux[34] * Uy[31] * Uz[3];
        tile[224] += sc * Ux[34] * Uy[30] * Uz[4];
        tile[225] += sc * Ux[35] * Uy[32] * Uz[3];
        tile[226] += sc * Ux[35] * Uy[31] * Uz[4];
        tile[227] += sc * Ux[35] * Uy[30] * Uz[5];
        tile[228] += sc * Ux[33] * Uy[27] * Uz[6];
        tile[229] += sc * Ux[34] * Uy[28] * Uz[6];
        tile[230] += sc * Ux[34] * Uy[27] * Uz[7];
        tile[231] += sc * Ux[35] * Uy[29] * Uz[6];
        tile[232] += sc * Ux[35] * Uy[28] * Uz[7];
        tile[233] += sc * Ux[35] * Uy[27] * Uz[8];
        tile[234] += sc * Ux[33] * Uy[24] * Uz[9];
        tile[235] += sc * Ux[34] * Uy[25] * Uz[9];
        tile[236] += sc * Ux[34] * Uy[24] * Uz[10];
        tile[237] += sc * Ux[35] * Uy[26] * Uz[9];
        tile[238] += sc * Ux[35] * Uy[25] * Uz[10];
        tile[239] += sc * Ux[35] * Uy[24] * Uz[11];
        tile[240] += sc * Ux[24] * Uy[12] * Uz[12];
        tile[241] += sc * Ux[25] * Uy[13] * Uz[12];
        tile[242] += sc * Ux[25] * Uy[12] * Uz[13];
        tile[243] += sc * Ux[26] * Uy[14] * Uz[12];
        tile[244] += sc * Ux[26] * Uy[13] * Uz[13];
        tile[245] += sc * Ux[26] * Uy[12] * Uz[14];
        tile[246] += sc * Ux[27] * Uy[15] * Uz[12];
        tile[247] += sc * Ux[28] * Uy[16] * Uz[12];
        tile[248] += sc * Ux[28] * Uy[15] * Uz[13];
        tile[249] += sc * Ux[29] * Uy[17] * Uz[12];
        tile[250] += sc * Ux[29] * Uy[16] * Uz[13];
        tile[251] += sc * Ux[29] * Uy[15] * Uz[14];
        tile[252] += sc * Ux[27] * Uy[12] * Uz[15];
        tile[253] += sc * Ux[28] * Uy[13] * Uz[15];
        tile[254] += sc * Ux[28] * Uy[12] * Uz[16];
        tile[255] += sc * Ux[29] * Uy[14] * Uz[15];
        tile[256] += sc * Ux[29] * Uy[13] * Uz[16];
        tile[257] += sc * Ux[29] * Uy[12] * Uz[17];
        tile[258] += sc * Ux[30] * Uy[18] * Uz[12];
        tile[259] += sc * Ux[31] * Uy[19] * Uz[12];
        tile[260] += sc * Ux[31] * Uy[18] * Uz[13];
        tile[261] += sc * Ux[32] * Uy[20] * Uz[12];
        tile[262] += sc * Ux[32] * Uy[19] * Uz[13];
        tile[263] += sc * Ux[32] * Uy[18] * Uz[14];
        tile[264] += sc * Ux[30] * Uy[15] * Uz[15];
        tile[265] += sc * Ux[31] * Uy[16] * Uz[15];
        tile[266] += sc * Ux[31] * Uy[15] * Uz[16];
        tile[267] += sc * Ux[32] * Uy[17] * Uz[15];
        tile[268] += sc * Ux[32] * Uy[16] * Uz[16];
        tile[269] += sc * Ux[32] * Uy[15] * Uz[17];
        tile[270] += sc * Ux[30] * Uy[12] * Uz[18];
        tile[271] += sc * Ux[31] * Uy[13] * Uz[18];
        tile[272] += sc * Ux[31] * Uy[12] * Uz[19];
        tile[273] += sc * Ux[32] * Uy[14] * Uz[18];
        tile[274] += sc * Ux[32] * Uy[13] * Uz[19];
        tile[275] += sc * Ux[32] * Uy[12] * Uz[20];
        ...
        tile[288] += sc * Ux[33] * Uy[15] * Uz[18];
        tile[289] += sc * Ux[34] * Uy[16] * Uz[18];
        tile[290] += sc * Ux[34] * Uy[15] * Uz[19];
        tile[291] += sc * Ux[35] * Uy[17] * Uz[18];
        tile[292] += sc * Ux[35] * Uy[16] * Uz[19];
        tile[293] += sc * Ux[35] * Uy[15] * Uz[20];
        tile[294] += sc * Ux[33] * Uy[12] * Uz[21];
        tile[295] += sc * Ux[34] * Uy[13] * Uz[21];
        tile[296] += sc * Ux[34] * Uy[12] * Uz[22];
        tile[297] += sc * Ux[35] * Uy[14] * Uz[21];
        tile[298] += sc * Ux[35] * Uy[13] * Uz[22];
        tile[299] += sc * Ux[35] * Uy[12] * Uz[23];
        tile[300] += sc * Ux[24] * Uy[0] * Uz[24];
        tile[301] += sc * Ux[25] * Uy[1] * Uz[24];
        tile[302] += sc * Ux[25] * Uy[0] * Uz[25];
        tile[303] += sc * Ux[26] * Uy[2] * Uz[24];
        tile[304] += sc * Ux[26] * Uy[1] * Uz[25];
        tile[305] += sc * Ux[26] * Uy[0] * Uz[26];
        tile[306] += sc * Ux[27] * Uy[3] * Uz[24];
        tile[307] += sc * Ux[28] * Uy[4] * Uz[24];
        tile[308] += sc * Ux[28] * Uy[3] * Uz[25];
        tile[309] += sc * Ux[29] * Uy[5] * Uz[24];
        tile[310] += sc * Ux[29] * Uy[4] * Uz[25];
        tile[311] += sc * Ux[29] * Uy[3] * Uz[26];
        tile[312] += sc * Ux[27] * Uy[0] * Uz[27];
        tile[313] += sc * Ux[28] * Uy[1] * Uz[27];
        tile[314] += sc * Ux[28] * Uy[0] * Uz[28];
        tile[315] += sc * Ux[29] * Uy[2] * Uz[27];
        tile[316] += sc * Ux[29] * Uy[1] * Uz[28];
        tile[317] += sc * Ux[29] * Uy[0] * Uz[29];
        tile[318] += sc * Ux[30] * Uy[6] * Uz[24];
        tile[319] += sc * Ux[31] * Uy[7] * Uz[24];
        tile[320] += sc * Ux[31] * Uy[6] * Uz[25];
        tile[321] += sc * Ux[32] * Uy[8] * Uz[24];
        tile[322] += sc * Ux[32] * Uy[7] * Uz[25];
        tile[323] += sc * Ux[32] * Uy[6] * Uz[26];
        tile[324] += sc * Ux[30] * Uy[3] * Uz[27];
        tile[325] += sc * Ux[31] * Uy[4] * Uz[27];
        tile[326] += sc * Ux[31] * Uy[3] * Uz[28];
        tile[327] += sc * Ux[32] * Uy[5] * Uz[27];
        tile[328] += sc * Ux[32] * Uy[4] * Uz[28];
        tile[329] += sc * Ux[32] * Uy[3] * Uz[29];
        tile[330] += sc * Ux[30] * Uy[0] * Uz[30];
        tile[331] += sc * Ux[31] * Uy[1] * Uz[30];
        tile[332] += sc * Ux[31] * Uy[0] * Uz[31];
        tile[333] += sc * Ux[32] * Uy[2] * Uz[30];
        tile[334] += sc * Ux[32] * Uy[1] * Uz[31];
        tile[335] += sc * Ux[32] * Uy[0] * Uz[32];
        tile[336] += sc * Ux[33] * Uy[9] * Uz[24];
        tile[337] += sc * Ux[34] * Uy[10] * Uz[24];
        tile[338] += sc * Ux[34] * Uy[9] * Uz[25];
        tile[339] += sc * Ux[35] * Uy[11] * Uz[24];
        tile[340] += sc * Ux[35] * Uy[10] * Uz[25];
        tile[341] += sc * Ux[35] * Uy[9] * Uz[26];
        ...
        tile[360] += sc * Ux[36] * Uy[36] * Uz[0];
        tile[361] += sc * Ux[37] * Uy[37] * Uz[0];
        tile[362] += sc * Ux[37] * Uy[36] * Uz[1];
        tile[363] += sc * Ux[38] * Uy[38] * Uz[0];
        tile[364] += sc * Ux[38] * Uy[37] * Uz[1];
        tile[365] += sc * Ux[38] * Uy[36] * Uz[2];
        tile[366] += sc * Ux[39] * Uy[39] * Uz[0];
        tile[367] += sc * Ux[40] * Uy[40] * Uz[0];
        tile[368] += sc * Ux[40] * Uy[39] * Uz[1];
        tile[369] += sc * Ux[41] * Uy[41] * Uz[0];
        tile[370] += sc * Ux[41] * Uy[40] * Uz[1];
        tile[371] += sc * Ux[41] * Uy[39] * Uz[2];
        tile[372] += sc * Ux[39] * Uy[36] * Uz[3];
        tile[373] += sc * Ux[40] * Uy[37] * Uz[3];
        tile[374] += sc * Ux[40] * Uy[36] * Uz[4];
        tile[375] += sc * Ux[41] * Uy[38] * Uz[3];
        tile[376] += sc * Ux[41] * Uy[37] * Uz[4];
        tile[377] += sc * Ux[41] * Uy[36] * Uz[5];
        tile[378] += sc * Ux[42] * Uy[42] * Uz[0];
        tile[379] += sc * Ux[43] * Uy[43] * Uz[0];
        tile[380] += sc * Ux[43] * Uy[42] * Uz[1];
        tile[381] += sc * Ux[44] * Uy[44] * Uz[0];
        tile[382] += sc * Ux[44] * Uy[43] * Uz[1];
        tile[383] += sc * Ux[44] * Uy[42] * Uz[2];
        tile[384] += sc * Ux[42] * Uy[39] * Uz[3];
        tile[385] += sc * Ux[43] * Uy[40] * Uz[3];
        tile[386] += sc * Ux[43] * Uy[39] * Uz[4];
        tile[387] += sc * Ux[44] * Uy[41] * Uz[3];
        tile[388] += sc * Ux[44] * Uy[40] * Uz[4];
        tile[389] += sc * Ux[44] * Uy[39] * Uz[5];
        tile[390] += sc * Ux[42] * Uy[36] * Uz[6];
        tile[391] += sc * Ux[43] * Uy[37] * Uz[6];
        tile[392] += sc * Ux[43] * Uy[36] * Uz[7];
        tile[393] += sc * Ux[44] * Uy[38] * Uz[6];
        tile[394] += sc * Ux[44] * Uy[37] * Uz[7];
        tile[395] += sc * Ux[44] * Uy[36] * Uz[8];
        tile[396] += sc * Ux[45] * Uy[45] * Uz[0];
        tile[397] += sc * Ux[46] * Uy[46] * Uz[0];
        tile[398] += sc * Ux[46] * Uy[45] * Uz[1];
        tile[399] += sc * Ux[47] * Uy[47] * Uz[0];
        tile[400] += sc * Ux[47] * Uy[46] * Uz[1];
        tile[401] += sc * Ux[47] * Uy[45] * Uz[2];
        tile[402] += sc * Ux[45] * Uy[42] * Uz[3];
        tile[403] += sc * Ux[46] * Uy[43] * Uz[3];
        tile[404] += sc * Ux[46] * Uy[42] * Uz[4];
        tile[405] += sc * Ux[47] * Uy[44] * Uz[3];
        tile[406] += sc * Ux[47] * Uy[43] * Uz[4];
        tile[407] += sc * Ux[47] * Uy[42] * Uz[5];
        tile[408] += sc * Ux[45] * Uy[39] * Uz[6];
        tile[409] += sc * Ux[46] * Uy[40] * Uz[6];
        tile[410] += sc * Ux[46] * Uy[39] * Uz[7];
        tile[411] += sc * Ux[47] * Uy[41] * Uz[6];
        tile[412] += sc * Ux[47] * Uy[40] * Uz[7];
        tile[413] += sc * Ux[47] * Uy[39] * Uz[8];
        tile[414] += sc * Ux[45] * Uy[36] * Uz[9];
        tile[415] += sc * Ux[46] * Uy[37] * Uz[9];
        tile[416] += sc * Ux[46] * Uy[36] * Uz[10];
        tile[417] += sc * Ux[47] * Uy[38] * Uz[9];
        tile[418] += sc * Ux[47] * Uy[37] * Uz[10];
        tile[419] += sc * Ux[47] * Uy[36] * Uz[11];
        tile[420] += sc * Ux[36] * Uy[24] * Uz[12];
        tile[421] += sc * Ux[37] * Uy[25] * Uz[12];
        tile[422] += sc * Ux[37] * Uy[24] * Uz[13];
        tile[423] += sc * Ux[38] * Uy[26] * Uz[12];
        tile[424] += sc * Ux[38] * Uy[25] * Uz[13];
        tile[425] += sc * Ux[38] * Uy[24] * Uz[14];
        tile[426] += sc * Ux[39] * Uy[27] * Uz[12];
        tile[427] += sc * Ux[40] * Uy[28] * Uz[12];
        tile[428] += sc * Ux[40] * Uy[27] * Uz[13];
        tile[429] += sc * Ux[41] * Uy[29] * Uz[12];
        tile[430] += sc * Ux[41] * Uy[28] * Uz[13];
        tile[431] += sc * Ux[41] * Uy[27] * Uz[14];
        tile[432] += sc * Ux[39] * Uy[24] * Uz[15];
        tile[433] += sc * Ux[40] * Uy[25] * Uz[15];
        tile[434] += sc * Ux[40] * Uy[24] * Uz[16];
        tile[435] += sc * Ux[41] * Uy[26] * Uz[15];
        tile[436] += sc * Ux[41] * Uy[25] * Uz[16];
        tile[437] += sc * Ux[41] * Uy[24] * Uz[17];
        tile[438] += sc * Ux[42] * Uy[30] * Uz[12];
        tile[439] += sc * Ux[43] * Uy[31] * Uz[12];
        tile[440] += sc * Ux[43] * Uy[30] * Uz[13];
        tile[441] += sc * Ux[44] * Uy[32] * Uz[12];
        tile[442] += sc * Ux[44] * Uy[31] * Uz[13];
        tile[443] += sc * Ux[44] * Uy[30] * Uz[14];
        tile[444] += sc * Ux[42] * Uy[27] * Uz[15];
        tile[445] += sc * Ux[43] * Uy[28] * Uz[15];
        tile[446] += sc * Ux[43] * Uy[27] * Uz[16];
        tile[447] += sc * Ux[44] * Uy[29] * Uz[15];
        tile[448] += sc * Ux[44] * Uy[28] * Uz[16];
        tile[449] += sc * Ux[44] * Uy[27] * Uz[17];
        ...
        tile[456] += sc * Ux[45] * Uy[33] * Uz[12];
        tile[457] += sc * Ux[46] * Uy[34] * Uz[12];
        tile[458] += sc * Ux[46] * Uy[33] * Uz[13];
        tile[459] += sc * Ux[47] * Uy[35] * Uz[12];
        tile[460] += sc * Ux[47] * Uy[34] * Uz[13];
        tile[461] += sc * Ux[47] * Uy[33] * Uz[14];
        tile[462] += sc * Ux[45] * Uy[30] * Uz[15];
        tile[463] += sc * Ux[46] * Uy[31] * Uz[15];
        tile[464] += sc * Ux[46] * Uy[30] * Uz[16];
        tile[465] += sc * Ux[47] * Uy[32] * Uz[15];
        ...
        tile[474] += sc * Ux[45] * Uy[24] * Uz[21];
        tile[475] += sc * Ux[46] * Uy[25] * Uz[21];
        tile[476] += sc * Ux[46] * Uy[24] * Uz[22];
        tile[477] += sc * Ux[47] * Uy[26] * Uz[21];
        tile[478] += sc * Ux[47] * Uy[25] * Uz[22];
        tile[479] += sc * Ux[47] * Uy[24] * Uz[23];
        tile[480] += sc * Ux[36] * Uy[12] * Uz[24];
        tile[481] += sc * Ux[37] * Uy[13] * Uz[24];
        tile[482] += sc * Ux[37] * Uy[12] * Uz[25];
        tile[483] += sc * Ux[38] * Uy[14] * Uz[24];
        tile[484] += sc * Ux[38] * Uy[13] * Uz[25];
        tile[485] += sc * Ux[38] * Uy[12] * Uz[26];
        tile[486] += sc * Ux[39] * Uy[15] * Uz[24];
        tile[487] += sc * Ux[40] * Uy[16] * Uz[24];
        tile[488] += sc * Ux[40] * Uy[15] * Uz[25];
        tile[489] += sc * Ux[41] * Uy[17] * Uz[24];
        tile[490] += sc * Ux[41] * Uy[16] * Uz[25];
        tile[491] += sc * Ux[41] * Uy[15] * Uz[26];
        tile[492] += sc * Ux[39] * Uy[12] * Uz[27];
        tile[493] += sc * Ux[40] * Uy[13] * Uz[27];
        tile[494] += sc * Ux[40] * Uy[12] * Uz[28];
        tile[495] += sc * Ux[41] * Uy[14] * Uz[27];
        tile[496] += sc * Ux[41] * Uy[13] * Uz[28];
        tile[497] += sc * Ux[41] * Uy[12] * Uz[29];
        tile[498] += sc * Ux[42] * Uy[18] * Uz[24];
        tile[499] += sc * Ux[43] * Uy[19] * Uz[24];
        tile[500] += sc * Ux[43] * Uy[18] * Uz[25];
        tile[501] += sc * Ux[44] * Uy[20] * Uz[24];
        tile[502] += sc * Ux[44] * Uy[19] * Uz[25];
        tile[503] += sc * Ux[44] * Uy[18] * Uz[26];
        tile[504] += sc * Ux[42] * Uy[15] * Uz[27];
        tile[505] += sc * Ux[43] * Uy[16] * Uz[27];
        tile[506] += sc * Ux[43] * Uy[15] * Uz[28];
        tile[507] += sc * Ux[44] * Uy[17] * Uz[27];
        tile[508] += sc * Ux[44] * Uy[16] * Uz[28];
        tile[509] += sc * Ux[44] * Uy[15] * Uz[29];
        tile[510] += sc * Ux[42] * Uy[12] * Uz[30];
        tile[511] += sc * Ux[43] * Uy[13] * Uz[30];
        tile[512] += sc * Ux[43] * Uy[12] * Uz[31];
        tile[513] += sc * Ux[44] * Uy[14] * Uz[30];
        tile[514] += sc * Ux[44] * Uy[13] * Uz[31];
        tile[515] += sc * Ux[44] * Uy[12] * Uz[32];
        tile[516] += sc * Ux[45] * Uy[21] * Uz[24];
        tile[517] += sc * Ux[46] * Uy[22] * Uz[24];
        tile[518] += sc * Ux[46] * Uy[21] * Uz[25];
        tile[519] += sc * Ux[47] * Uy[23] * Uz[24];
        tile[520] += sc * Ux[47] * Uy[22] * Uz[25];
        tile[521] += sc * Ux[47] * Uy[21] * Uz[26];
        tile[522] += sc * Ux[45] * Uy[18] * Uz[27];
        tile[523] += sc * Ux[46] * Uy[19] * Uz[27];
        tile[524] += sc * Ux[46] * Uy[18] * Uz[28];
        tile[525] += sc * Ux[47] * Uy[20] * Uz[27];
        tile[526] += sc * Ux[47] * Uy[19] * Uz[28];
        tile[527] += sc * Ux[47] * Uy[18] * Uz[29];
        tile[528] += sc * Ux[45] * Uy[15] * Uz[30];
        tile[529] += sc * Ux[46] * Uy[16] * Uz[30];
        tile[530] += sc * Ux[46] * Uy[15] * Uz[31];
        tile[531] += sc * Ux[47] * Uy[17] * Uz[30];
        tile[532] += sc * Ux[47] * Uy[16] * Uz[31];
        tile[533] += sc * Ux[47] * Uy[15] * Uz[32];
        tile[534] += sc * Ux[45] * Uy[12] * Uz[33];
        tile[535] += sc * Ux[46] * Uy[13] * Uz[33];
        tile[536] += sc * Ux[46] * Uy[12] * Uz[34];
        tile[537] += sc * Ux[47] * Uy[14] * Uz[33];
        tile[538] += sc * Ux[47] * Uy[13] * Uz[34];
        tile[539] += sc * Ux[47] * Uy[12] * Uz[35];
        ...
        tile[582] += sc * Ux[45] * Uy[6] * Uz[39];
        tile[583] += sc * Ux[46] * Uy[7] * Uz[39];
        tile[584] += sc * Ux[46] * Uy[6] * Uz[40];
        tile[585] += sc * Ux[47] * Uy[8] * Uz[39];
        tile[586] += sc * Ux[47] * Uy[7] * Uz[40];
        tile[587] += sc * Ux[47] * Uy[6] * Uz[41];
        tile[588] += sc * Ux[45] * Uy[3] * Uz[42];
        tile[589] += sc * Ux[46] * Uy[4] * Uz[42];
        tile[590] += sc * Ux[46] * Uy[3] * Uz[43];
        tile[591] += sc * Ux[47] * Uy[5] * Uz[42];
        tile[592] += sc * Ux[47] * Uy[4] * Uz[43];
        tile[593] += sc * Ux[47] * Uy[3] * Uz[44];
        tile[594] += sc * Ux[45] * Uy[0] * Uz[45];
        tile[595] += sc * Ux[46] * Uy[1] * Uz[45];
        tile[596] += sc * Ux[46] * Uy[0] * Uz[46];
