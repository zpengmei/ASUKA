...
gradient driver is implemented (see :func:`asuka.mrpt2.nevpt2_sc_df_grad_from_mc`).
...
def nevpt2_sc_total_energy_df_adjoint(*args: Any, **kwargs: Any) -> NEVPT2SCDFAdjointTotalResult:
    ...
    Use :func:`asuka.mrpt2.nevpt2_sc_df_grad_from_mc` with
    ...
    raise NotImplementedError(
        ...
        "Use finite-difference gradients: nevpt2_sc_df_grad_from_mc(grad_backend='fd')."
    )
