...
def rhf_direct_df(
    ...
    *,
    ...
    """RHF direct-SCF via streamed DF J/K (no materialized DF tensor)."""

    from .df_scf import rhf_df  # noqa: PLC0415
    ...
    return rhf_df(
        ...
        dm0=dm0,
        mo_coeff0=mo_coeff0,
        init_fock_cycles=int(init_fock_cycles),
        profile=profile,
    )
...
def uhf_direct_df(
    ...
    *,
    ...
    """UHF direct-SCF via streamed DF J/K (no materialized DF tensor)."""

    from .df_scf import uhf_df  # noqa: PLC0415
...
def rohf_direct_df(
    ...
    *,
    ...
    """ROHF direct-SCF via streamed DF J/K (no materialized DF tensor)."""

    from .df_scf import rohf_df  # noqa: PLC0415
