...
def main() -> None:
    ...
    try:
        ...
        raise SystemExit("pybind11 is required to build the HF THC CUDA extension") from e
    ...
    src_dir = os.path.join(repo_root, "asuka", "hf", "thc", "cuda", "ext")
    cmake_build_dir = os.path.join(repo_root, "build", "hf_thc_cuda_ext")
