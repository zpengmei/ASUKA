...
def main() -> None:
    ...
    try:
        ...
        raise SystemExit("pybind11 is required to build the CUDA linalg extension") from e
    ...
    src_dir = os.path.join(repo_root, "asuka", "cuda", "linalg_ext")
    build_dir = os.path.join(repo_root, "build", "guga_cuda_linalg_ext")
