...
def main() -> None:
    ...
    try:
        ...
        raise SystemExit("pybind11 is required to build the HF DF-JK CUDA extension") from e
    ...
    src_dir = os.path.join(repo_root, "asuka", "hf", "cuda", "ext")
    cmake_build_dir = os.path.join(repo_root, "build", "hf_df_jk_cuda_ext")
