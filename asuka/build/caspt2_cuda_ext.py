...
def main() -> None:
    ...
    try:
        ...
        raise SystemExit("pybind11 is required to build the CASPT2 CUDA extension") from e
    ...
    src_dir = os.path.join(repo_root, "asuka", "caspt2", "cuda", "ext")
    cmake_build_dir = os.path.join(repo_root, "build", "caspt2_cuda_ext")
